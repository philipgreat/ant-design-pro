...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/taskBestAnswerSetting/${text}/dashboard`}>{text}</Link>) },
...
class TaskBestAnswerSettingTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default TaskBestAnswerSettingTable
