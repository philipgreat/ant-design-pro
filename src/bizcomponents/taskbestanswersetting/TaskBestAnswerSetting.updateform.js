    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters={...values, ...imagesValues};
         ...
         payload: {id:owner.id,type:'taskBestAnswerSetting', parameters: parameters},
      }); 
      });
    };
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
             ...
             <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.setTime}>
                  {getFieldDecorator('setTime', {
                    rules: [{ required: true, message: '请输入设置时间' }],
                  })(
                    <Input placeholder="请输入请输入设置时间date_time_now" />
                  )}
                </Form.Item>
              </Col>			
