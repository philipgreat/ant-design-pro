...
export default class TaskBestAnswerSettingSearch extends PureComponent {
  ...
  render() {
    ...
    const {TaskBestAnswerSettingTable} = GlobalComponents;
    const {TaskBestAnswerSettingConfirmationTable} = GlobalComponents;
    const {TaskBestAnswerSettingSearchForm} = GlobalComponents;
