...
class TaskBestAnswerSettingSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCloseAlert = () => {
      ...
      dispatch({ type: `${owner.type}/view`, payload: { id: owner.id,pathname,displayName:'任务最佳答案设置列表' } })
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title={`${displayName}: 任务最佳答案设置列表`}>
        <Card bordered={false}>
...
export default Form.create()(TaskBestAnswerSettingSearch)
