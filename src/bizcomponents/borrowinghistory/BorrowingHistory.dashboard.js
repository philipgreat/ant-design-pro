...
const imageListOf = (borrowingHistory) =>{
...
const settingListOf = (borrowingHistory) =>{

	return(<Card title='状态集合' className={styles.card}>
<BooleanOption type={borrowingHistory.freeLendingExpired?"success":"error"} title="免费贷款到期"/>
</Card> )
...
const largeTextOf = (borrowingHistory) =>{
