...
const columns = [
  ...
  { title: '借款人会员级别', debugtype: 'string', dataIndex: 'borrowerMemberLevel', width: '23' },
  { title: '借方成员服务过期日期。', dataIndex: 'borrowerMemberServiceExpiredDatetime', render: (text, record) => moment(record.borrowerMemberServiceExpiredDatetime).format('YYYY-MM-DD') },
  ...
  { title: '免费贷款到期日期时间', dataIndex: 'freeLendingExpiredDatetime', render: (text, record) => moment(record.freeLendingExpiredDatetime).format('YYYY-MM-DD') },
  ...
  { title: '借贷状态', debugtype: 'string', dataIndex: 'borrowingStatus', width: '7' },
]

class BorrowingHistoryConfirmationTable extends PureComponent {
  render() {
...
export default BorrowingHistoryConfirmationTable
