...
const fieldLabels = {
  ...
  borrowingStatus: '借贷状态',
}
const testValues = {};
/*
const testValues = {
  borrowerMemberLevel: '普通会员',
  borrowerMemberServiceExpiredDatetime: '2997-08-15 07:54:25',
  bookCopySharingType: '共享',
  bookName: '飘',
  lendingStoreType: '社区',
  lendingDatetime: '2996-01-04 19:03:56',
  freeLendingDays: '7',
  freeLendingExpiredDatetime: '2995-01-30 20:26:01',
  expiredLendingRate: '0.76',
  expiredLendingComputeFrequency: '1',
  returnDatetime: '2995-08-22 04:24:35',
  lendingDays: '15',
  borrowingStatus: '借阅中',
  borrowerId: 'C000001',
  bookId: 'B000001',
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.borrowingStatus} {...formItemLayout}>
                  {getFieldDecorator('borrowingStatus', {
                    rules: [{ required: true, message: '请输入借贷状态' }],
                  })(
                    <Input placeholder="请输入借贷状态" />
                  )}
                </Form.Item>
              </Col>
