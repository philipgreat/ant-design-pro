...
const displayColumns = [
  {
    ...
    width: '20',
    render: (text, record) => (
      <Link to={`/serviceFileMovementC2m/${text}/dashboard`}>{text}</Link>
    ),
  },
  {
    title: '服务状态',
...
const ServiceFileMovementC2mBase = { menuData, displayColumns, fieldLabels }
export default ServiceFileMovementC2mBase
