...
class ServiceFileMovementC2mBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceFileMovementC2m/${objectId}/list/serviceFileMovementC2mChecklistResultList`}
          >
            收件服务检查结果
          </Link>
        </Menu.Item>
  ...
  getServiceFileMovementC2mChecklistResultSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data:
        state._serviceFileMovementC2m.serviceFileMovementC2mChecklistResultList,
      count:
        state._serviceFileMovementC2m
          .serviceFileMovementC2mChecklistResultCount,
      currentPage:
        state._serviceFileMovementC2m
          .serviceFileMovementC2mChecklistResultCurrentPageNumber,
      searchFormParameters:
        state._serviceFileMovementC2m
          .serviceFileMovementC2mChecklistResultSearchFormParameters,
      loading: state._serviceFileMovementC2m.loading,
      owner: {
        type: '_serviceFileMovementC2m',
        id: state._serviceFileMovementC2m.id,
        listName: 'serviceFileMovementC2mChecklistResultList',
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/serviceFileMovementC2m/:id/list/serviceFileMovementC2mChecklistResultList"
                component={this.getServiceFileMovementC2mChecklistResultSearch()}
              />
              <Route
                path="/serviceFileMovementC2m/:id/list/serviceFileMovementC2mChecklistResultCreateForm"
                component={this.getServiceFileMovementC2mChecklistResultCreateForm()}
              />
              <Route
                path="/serviceFileMovementC2m/:id/list/serviceFileMovementC2mChecklistResultUpdateForm"
                component={this.getServiceFileMovementC2mChecklistResultUpdateForm()}
              />
            </Switch>
          </Content>
        </Layout>
