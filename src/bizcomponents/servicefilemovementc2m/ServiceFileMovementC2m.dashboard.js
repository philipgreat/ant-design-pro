  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="拒收原因">
        {serviceFileMovementC2m.rejectComments}
      </Description>
      <Description term="拒收凭证1">
        {serviceFileMovementC2m.rejectEvidence1}
      </Description>
      <Description term="拒收凭证2">
        {serviceFileMovementC2m.rejectEvidence2}
      </Description>
      <Description term="拒收凭证3">
        {serviceFileMovementC2m.rejectEvidence3}
      </Description>
      <Description term="拒收凭证4">
        {serviceFileMovementC2m.rejectEvidence4}
      </Description>
      <Description term="拒收凭证5">
        {serviceFileMovementC2m.rejectEvidence5}
      </Description>
      <Description term="开始时间">
        {moment(serviceFileMovementC2m.startTime).format('YYYY-MM-DD')}
      </Description>
      <Description term="最后的位置">
        {serviceFileMovementC2m.lastLocation}
      </Description>
        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceFileMovementC2m/${id}/list/serviceFileMovementC2mChecklistResultList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/serviceFileMovementC2m/${id}/list/serviceFileMovementC2mChecklistResultCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
