...
@Form.create()
export default class ServiceFileMovementC2mSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      ...
      'serviceFileMovementC2mList.searchField': fieldName,
      'serviceFileMovementC2mList.searchVerb': 'startsWith',
      'serviceFileMovementC2mList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, serviceFileMovementC2mSearchFormParameters: fieldsValue },
      })
    })
  }
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="通知的评论">
              {getFieldDecorator('notifyComment')(
                <Input placeholder="请输入通知的评论" />
              )}
            </FormItem>
          </Col>
