...
export default {
    ...
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        const match = pathToRegexp(
          '/serviceFileMovementC2m/:id/list/:listName/:listDisplayName'
        ).exec(pathname)
        if (!match) {
          return
  ...
  effects: {
    ...
    *addHandOverChecklistResult({ payload }, { call, put }) {
      ...
      const data = yield call(
        ServiceFileMovementC2mService.addHandOverChecklistResult,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateHandOverChecklistResult({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        ServiceFileMovementC2mService.updateHandOverChecklistResult,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeHandOverChecklistResultList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        ServiceFileMovementC2mService.removeHandOverChecklistResultList,
        id,
        parameters
      )
      if (hasError(data)) {
