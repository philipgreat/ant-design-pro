...
import styles from './ServiceFileMovementC2m.search.less'
...
@Form.create()
export default class ServiceFileMovementC2mSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      serviceFileMovementC2mList: 1,
      serviceFileMovementC2mListCurrentPage: pagination.current,
      serviceFileMovementC2mListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
  ...
  handleDelete = () => {
    ...
    const serviceFileMovementC2mIds = selectedRows.map((item) => { return item.id })
    console.log('serviceFileMovementC2mIds', serviceFileMovementC2mIds)
  ...
  handleCreate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'serviceFileMovementC2m' },
    })
  }
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'serviceFileMovementC2m', selectedRows, currentUpdateIndex },
    })
  }
  ...
  render() {
    ...
    const {ServiceFileMovementC2mTable} = GlobalComponents;
    const {ServiceFileMovementC2mConfirmationTable} = GlobalComponents;
    const {ServiceFileMovementC2mSearchForm} = GlobalComponents;
    ...
    const modalContent = (data, owner) => {
      ...
      return (
        <Modal
          ...
          style={{ top: 40 }}
        >
          <ServiceFileMovementC2mConfirmationTable data={selectedRows} owner={owner} />
        </Modal>)
    }
    
    return (
      <PageHeaderLayout title="收件服务列表">
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ServiceFileMovementC2mSearchForm {...this.props} />
            </div>
