...
const testValues = {
  serviceStatus: '待验收',
  serviceSummary: '请在 {日期} {时间} 前到 {地点} 联系 {姓名+电话}取件。{备注}',
  startTime: '2996-01-29 20:04:10',
  longitude: '103.26716643672324',
  latitude: '31.031763710585984',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_C2M_RECEIVE_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2996-11-07 17:09:25',
  notifyAddress: '',
  handoverResult: '',
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'serviceFileMovementC2m',listName:'收件服务列表' },
      })
    }
