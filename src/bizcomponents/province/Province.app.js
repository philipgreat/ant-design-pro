    ...
    const layout = (
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link to={`/province/${this.props.province.id}/dashboard`}>
                <Icon type="dashboard" />
                <span>仪表板</span>
              </Link>
            </Menu.Item>
            <Menu.Item>
              <Link to={`/province/${this.props.province.id}/editDetail`}>
                <Icon type="edit" />
                <span>详情编辑</span>
              </Link>
            </Menu.Item>
            <Menu.Item>
              <Link to={`/province/${this.props.province.id}/viewDetail`}>
                <Icon type="eye-o" />
                <span>详情查看</span>
              </Link>
            </Menu.Item>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/province/:id/dashboard"
                component={ProvinceDashboard}
              />
              <Route
                path="/province/:id/editDetail"
                component={ProvinceEditDetail}
              />
              <Route
                path="/province/:id/viewDetail"
                component={ProvinceViewDetail}
              />

              <Route
                path="/province/:id/list/cityList"
                component={this.getCitySearch()}
              />
              <Route
                path="/province/:id/list/cityCreateForm"
                component={this.getCityCreateForm()}
              />
              <Route
                path="/province/:id/list/cityUpdateForm"
                component={this.getCityUpdateForm()}
              />
            </Switch>
          </Content>
        </Layout>
