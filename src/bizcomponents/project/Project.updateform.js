...
import styles from './Project.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, projectId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextProjectUpdateRow`,
        payload: {
          id: owner.id,
          type: 'project',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新项目"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新项目"
