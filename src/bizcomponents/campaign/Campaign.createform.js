...
const testValues = {
  campaignName: '活动名称',
  campaignStartDatetime: '2014-06-01 14:44:47',
  campaignEndDatetime: '2017-02-01 10:44:50',
  campaignContent: '欢迎大家来到XXXXXXX',
  storeId: 'S000001',
}
*/
...
class CampaignCreateForm extends Component {
  ...
  executeCandidateStoreSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = CampaignService.requestCandidateStore("store", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'campaign',listName:'运动列表' },
      })
    }
