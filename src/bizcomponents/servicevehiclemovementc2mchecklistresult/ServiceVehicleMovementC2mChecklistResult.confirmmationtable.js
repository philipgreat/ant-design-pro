...
class ServiceVehicleMovementC2mChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceVehicleMovementC2mChecklistResultConfirmationTable
