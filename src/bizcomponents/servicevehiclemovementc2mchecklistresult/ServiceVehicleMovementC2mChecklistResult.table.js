...
import styles from './ServiceVehicleMovementC2mChecklistResult.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20' },
  { title: '服务', dataIndex: 'service', render: (text, record) => (record.service ? (<Link to={`/serviceVehicleMovementC2m/${record.service.id}/dashboard`}>{record.service.id}</Link>) : '暂无') },
...
class ServiceVehicleMovementC2mChecklistResultTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default ServiceVehicleMovementC2mChecklistResultTable
