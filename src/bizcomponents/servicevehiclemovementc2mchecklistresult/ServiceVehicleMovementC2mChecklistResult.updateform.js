...
import styles from './ServiceVehicleMovementC2mChecklistResult.updateform.less'
...
class ServiceVehicleMovementC2mChecklistResultUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const serviceVehicleMovementC2mChecklistResultId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, serviceVehicleMovementC2mChecklistResultId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextServiceVehicleMovementC2mChecklistResultUpdateRow`,
        payload: {
          id: owner.id,
          type: 'serviceVehicleMovementC2mChecklistResult',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新收车检车结果"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新收车检车结果"
...
}))(Form.create()(ServiceVehicleMovementC2mChecklistResultUpdateForm))
