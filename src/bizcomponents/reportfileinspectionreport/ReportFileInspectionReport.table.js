...
const columns = [
  ...
  { title: '年检服务单', dataIndex: 'inspectionServiceOrder', render: (text, record) => (record.inspectionServiceOrder ? (<Link to={`/serviceFileInspection/${record.inspectionServiceOrder.id}/dashboard`}>{record.inspectionServiceOrder.id}</Link>) : '暂无') },
