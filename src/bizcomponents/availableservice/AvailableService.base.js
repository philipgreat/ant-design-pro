...
const displayColumns = [
  {
    ...
    width: '20',
    render: (text, record) => (
      <Link to={`/availableService/${text}/dashboard`}>{text}</Link>
    ),
  },
  {
    title: '服务名称',
  ...
  },
  {
    ...
    render: (text, record) =>
      record.availableProduct ? record.availableProduct.displayName : '暂无',
  },
]
...
const AvailableServiceBase = { menuData, displayColumns, fieldLabels }
