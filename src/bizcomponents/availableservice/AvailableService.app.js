...
class AvailableServiceBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link
            to={`/availableService/${objectId}/list/companyEmployeeMessageList`}
          >
            消息管理
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/availableService/${objectId}/list/vehicleInspectionOrderServiceLogList`}
          >
            车辆检测服务订单日志
          </Link>
        </Menu.Item>
  ...
  getCompanyEmployeeMessageSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._availableService.companyEmployeeMessageCurrentPageNumber,
      searchFormParameters:
        state._availableService.companyEmployeeMessageSearchFormParameters,
      loading: state._availableService.loading,
      owner: {
        type: '_availableService',
        id: state._availableService.id,
        listName: 'companyEmployeeMessageList',
      }, // this is for model namespace and
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/availableService/:id/list/companyEmployeeMessageList"
                component={this.getCompanyEmployeeMessageSearch()}
              />
              <Route
                path="/availableService/:id/list/companyEmployeeMessageCreateForm"
                component={this.getCompanyEmployeeMessageCreateForm()}
              />
              <Route
                path="/availableService/:id/list/companyEmployeeMessageUpdateForm"
                component={this.getCompanyEmployeeMessageUpdateForm()}
              />

              <Route
                path="/availableService/:id/list/vehicleInspectionOrderServiceLogList"
                component={this.getVehicleInspectionOrderServiceLogSearch()}
              />
              <Route
                path="/availableService/:id/list/vehicleInspectionOrderServiceLogCreateForm"
                component={this.getVehicleInspectionOrderServiceLogCreateForm()}
              />
              <Route
                path="/availableService/:id/list/vehicleInspectionOrderServiceLogUpdateForm"
