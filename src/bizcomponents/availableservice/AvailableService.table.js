...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/availableService/${text}/dashboard`}>{text}</Link>) },
  { title: '服务名称', debugtype: 'string', dataIndex: 'serviceName', width: '8' },
  { title: '服务代码', debugtype: 'string', dataIndex: 'serviceKey', width: '19' },
