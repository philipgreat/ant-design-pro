...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/availableService/${text}/dashboard`}>{text}</Link>) },
  { title: '服务名称', debugtype: 'string', dataIndex: 'serviceName',},
