          ...
          <Row gutter={24}>
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                bordered={false}
                title="汽车修理平台补贴"
                action={<Tooltip title="汽车修理平台补贴"><Icon type="info-circle-o" /></Tooltip>}
                total={numeral(vehicleRepairingAllowanceCount).format('0,0')}
                footer={<Field label="状态" value="良好" />}
                contentHeight={46}
              >
                <Link to={`/availableService/${id}/list/vehicleRepairingAllowanceList`}><Icon type="profile" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/availableService/${id}/list/vehicleRepairingAllowanceCreateForm`}><Icon type="plus-circle-o" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/availableService/${id}/list/vehicleRepairingAllowanceList`}><Icon type="line-chart" style={{ fontSize: 20, color: '#08c' }} /></Link>
              </ChartCard>
            </Col>
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/availableService/${id}/list/vehicleServiceCompanyBusinessScopeList`}><Icon type="profile" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/availableService/${id}/list/companyEmployeeMessageList`}><Icon type="profile" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/availableService/${id}/list/companyEmployeeMessageCreateForm`}><Icon type="plus-circle-o" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/availableService/${id}/list/companyEmployeeMessageList`}><Icon type="line-chart" style={{ fontSize: 20, color: '#08c' }} /></Link>
              </ChartCard>
            </Col>
