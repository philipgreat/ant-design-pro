...
const imageListOf = (availableService) =>{
...
const settingListOf = (availableService) =>{
...
const largeTextOf = (availableService) =>{
...
class AvailableServiceDashboard extends Component {
  ...
  render() {
    ...
    const { id,displayName, servicePriceCount, vehicleRepairingAllowanceCount, vehicleServiceCompanyBusinessScopeCount } = this.props.availableService
    const cardsData = {cardsName:"服务范围",cardsFor: "availableService",cardsSource: this.props.availableService,
  		subItems: [
{name: 'servicePriceList', displayName:'合同价格',type:'servicePrice',count:servicePriceCount},
{name: 'vehicleRepairingAllowanceList', displayName:'汽车修理平台补贴',type:'vehicleRepairingAllowance',count:vehicleRepairingAllowanceCount},
