...
const imageListOf = (vehicleServiceCompanyDispatcher) =>{
...
const settingListOf = (vehicleServiceCompanyDispatcher) =>{
...
const largeTextOf = (vehicleServiceCompanyDispatcher) =>{
...
class VehicleServiceCompanyDispatcherDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, vehicleServiceCompanyDispatcher } = this.props;
    
    if(!vehicleServiceCompanyDispatcher){
    	return;
    }
    const {displayName} = vehicleServiceCompanyDispatcher;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.vehicleServiceCompanyDispatcher
    const cardsData = {cardsName:"商户派单",cardsFor: "vehicleServiceCompanyDispatcher",cardsSource: this.props.vehicleServiceCompanyDispatcher,
  		subItems: [
