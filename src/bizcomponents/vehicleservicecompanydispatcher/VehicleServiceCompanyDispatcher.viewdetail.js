...
import styles from './VehicleServiceCompanyDispatcher.viewdetail.less'
...
<Description term="序号">{vehicleServiceCompanyDispatcher.id}</Description> 
<Description term="描述">{vehicleServiceCompanyDispatcher.description}</Description> 
...
export default class VehicleServiceCompanyDispatcherViewDetail extends Component {
