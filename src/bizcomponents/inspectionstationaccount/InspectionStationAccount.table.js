...
const columns = [
  ...
  { title: '年检类型', debugtype: 'string', dataIndex: 'inspectionType',},
  { title: '车辆信息', debugtype: 'string', dataIndex: 'inspectionVehicleInfo',},
  { title: '检测结果', debugtype: 'string', dataIndex: 'inspectionFinalResult',},
  { title: '检测日期', dataIndex: 'inspectionDatetime', render: (text, record) => moment(record.inspectionDatetime).format('YYYY-MM-DD HH:mm:ss') },
  { title: '检测站', debugtype: 'string', dataIndex: 'inspectionStationName',},
  { title: '年检订单ID', debugtype: 'string', dataIndex: 'mainOrderNumber',},
