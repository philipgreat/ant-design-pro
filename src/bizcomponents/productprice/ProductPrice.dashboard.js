...
const imageListOf = (productPrice) =>{
...
const settingListOf = (productPrice) =>{

	const optionList = [ 
	  {"title":'新能源车',"value":productPrice.greenVehicle},
]
...
const largeTextOf = (productPrice) =>{
...
<Description term="到店服务代办价格">{productPrice.toStoreServicePrice}</Description> 
<Description term="优惠代办价格">{productPrice.discountAgentServicePrice}</Description> 
...
class ProductPriceDashboard extends Component {
