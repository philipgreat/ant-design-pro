...
<Description term="营业执照Img">{serviceCompanyAuthenticationInfo.businessLicenseImg}</Description> 
...
export default class ServiceCompanyAuthenticationInfoViewDetail extends Component {
  ...
  render() {
    ...
    const serviceCompanyAuthenticationInfo = this.props.serviceCompanyAuthenticationInfo
