  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="营业执照照片">
        <ImagePreview
          imageTitle="营业执照照片"
          imageLocation={serviceCompanyAuthenticationInfo.businessLicenseImg}
        />
      </Description>
...
export default class ServiceCompanyAuthenticationInfoDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '商户认证信息',
      cardsFor: 'serviceCompanyAuthenticationInfo',
      cardsSource: this.props.serviceCompanyAuthenticationInfo,
      subItems: [],
    }
