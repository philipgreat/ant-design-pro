...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/companyEmployeeServing/${text}/dashboard`}>{text}</Link>) },
...
class CompanyEmployeeServingTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default CompanyEmployeeServingTable
