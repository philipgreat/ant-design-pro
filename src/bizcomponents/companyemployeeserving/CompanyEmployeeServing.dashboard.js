...
const imageListOf = (companyEmployeeServing) =>{
...
const settingListOf = (companyEmployeeServing) =>{
...
const largeTextOf = (companyEmployeeServing) =>{
...
class CompanyEmployeeServingDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, companyEmployeeServing } = this.props;
    
    if(!companyEmployeeServing){
    	return;
    }
    const {displayName} = companyEmployeeServing;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName, vehicleServiceCompanyEmployeeCount } = this.props.companyEmployeeServing
    const cardsData = {cardsName:"商户员工服务状态变更",cardsFor: "companyEmployeeServing",cardsSource: this.props.companyEmployeeServing,
  		subItems: [
