...
<Description term="图1"><ImagePreview imageTitle="图1" imageLocation={employeeDrivingLicense.image1}/></Description> 
<Description term="图2"><ImagePreview imageTitle="图2" imageLocation={employeeDrivingLicense.image2}/></Description> 
<Description term="图3"><ImagePreview imageTitle="图3" imageLocation={employeeDrivingLicense.image3}/></Description> 
<Description term="图4"><ImagePreview imageTitle="图4" imageLocation={employeeDrivingLicense.image4}/></Description> 
<Description term="图5"><ImagePreview imageTitle="图5" imageLocation={employeeDrivingLicense.image5}/></Description> 
...
export default class EmployeeDrivingLicenseDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"员工驾驶证",cardsFor: "employeeDrivingLicense",cardsSource: this.props.employeeDrivingLicense,
  		subItems: [
