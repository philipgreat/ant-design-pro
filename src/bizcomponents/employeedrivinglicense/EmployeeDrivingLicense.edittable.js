...
class EmployeeDrivingLicenseEditTable extends PureComponent {
  ...
  { title: '姓名', debugtype: 'string', dataIndex: 'holderName', width: '57', render: (text, record) => renderStringEdit('holderName',text, record)  },
  { title: '准驾车型', debugtype: 'string', dataIndex: 'licenseType', width: '6', render: (text, record) => renderStringEdit('licenseType',text, record)  },
  { title: '驾驶证号码', debugtype: 'string', dataIndex: 'licenseNumber', width: '22', render: (text, record) => renderStringEdit('licenseNumber',text, record)  },
