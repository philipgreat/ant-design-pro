...
const menuData = {
  menuName: '员工驾驶证',
  menuFor: 'employeeDrivingLicense',
  subItems: [],
}
        ...
        <Layout>
          ...
          >
            ...
            >
              <Menu.Item key="dashboard">
                <Link
                  to={`/employeeDrivingLicense/${
                    this.props.employeeDrivingLicense.id
                  }/dashboard`}
                >
                  <Icon type="dashboard" />
                  <span>仪表板</span>
          ...
          <Layout>
            <Content style={{ margin: '24px 24px 0', height: '100%' }}>
              <Switch>
                <Route
                  path="/employeeDrivingLicense/:id/dashboard"
                  component={EmployeeDrivingLicenseDashboard}
                />

                <Route
                  path="/employeeDrivingLicense/:id/editDetail"
                  component={EmployeeDrivingLicenseEditDetail}
                />
                <Route
                  path="/employeeDrivingLicense/:id/viewDetail"
                  component={EmployeeDrivingLicenseViewDetail}
                />
              </Switch>
            </Content>
          </Layout>
