...
import styles from './ExperiencePoint.viewdetail.less'
...
class ExperiencePointViewDetail extends Component {
  ...
  render() {
    ...
    const experiencePoint = this.props.experiencePoint
    const { id,  } = experiencePoint
    const {  } = experiencePoint
    
    const owner = { type: '_experiencePoint', id }
