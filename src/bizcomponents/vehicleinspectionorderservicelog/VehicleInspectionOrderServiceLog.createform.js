...
const testValues = {
  ...
  longitude: '105.97449007671308',
  latitude: '31.633292361762845',
...
class VehicleInspectionOrderServiceLogCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = VehicleInspectionOrderServiceLogService.requestCandidateResponsibleWorker(
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = VehicleInspectionOrderServiceLogService.requestCandidateMainOrder(
