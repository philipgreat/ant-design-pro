...
const summaryOf = vehicleInspectionOrderServiceLog => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      <Description term="序号">
        {vehicleInspectionOrderServiceLog.id}
      </Description>
      <Description term="概览">
      ...
      <Description term="位置">
        {vehicleInspectionOrderServiceLog.location}
      </Description>
...
export default class VehicleInspectionOrderServiceLogViewDetail extends Component {
  ...
  render() {
    ...
    const vehicleInspectionOrderServiceLog = this.props
      .vehicleInspectionOrderServiceLog
