...
const imageListOf = (vehicleInspectionOrderServiceLog) =>{
...
const settingListOf = (vehicleInspectionOrderServiceLog) =>{
...
const largeTextOf = (vehicleInspectionOrderServiceLog) =>{
...
class VehicleInspectionOrderServiceLogDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, vehicleInspectionOrderServiceLog } = this.props;
    
    if(!vehicleInspectionOrderServiceLog){
    	return;
    }
    const {displayName} = vehicleInspectionOrderServiceLog;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.vehicleInspectionOrderServiceLog
    const cardsData = {cardsName:"年检订单执行日志",cardsFor: "vehicleInspectionOrderServiceLog",cardsSource: this.props.vehicleInspectionOrderServiceLog,
  		subItems: [
