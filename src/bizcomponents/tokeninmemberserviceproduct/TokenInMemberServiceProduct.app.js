...
import styles from './TokenInMemberServiceProduct.app.less'
...
class TokenInMemberServiceProductBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getDefaultCollapsedSubMenus = (props) => {
    ...
    if (currentMenuSelectedKeys.length === 0) {
      return ['/tokenInMemberServiceProduct/']
    }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {TokenInMemberServiceProductEditDetail} = GlobalComponents
     //const {TokenInMemberServiceProductViewDetail} = GlobalComponents
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.tokenInMemberServiceProduct.id)}
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/tokenInMemberServiceProduct/:id/dashboard" component={TokenInMemberServiceProductDashboard} />
