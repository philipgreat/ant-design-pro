...
const columns = [
  ...
  { title: '使用令牌', dataIndex: 'availableToken', render: (text, record) => (record.availableToken ? record.availableToken.displayName : '暂无') },
...
class TokenInMemberServiceProductTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default TokenInMemberServiceProductTable
