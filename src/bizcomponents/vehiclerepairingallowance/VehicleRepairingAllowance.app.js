  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/vehicleRepairingAllowance/${objectId}/list/repairingQuotationItemList`}>维修报价项目</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           <div className={styles.logo}>
             ...
             <Link to="/home"> <h1>汽车修理平台补贴</h1></Link>
           </div>
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/vehicleRepairingAllowance/${this.props.vehicleRepairingAllowance.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/vehicleRepairingAllowance/:id/list/repairingQuotationItemUpdateForm" component={this.getRepairingQuotationItemUpdateForm()} />
