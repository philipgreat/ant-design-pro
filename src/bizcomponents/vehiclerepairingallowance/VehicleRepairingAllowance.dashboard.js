...
const imageListOf = (vehicleRepairingAllowance) =>{
...
const settingListOf = (vehicleRepairingAllowance) =>{
...
const largeTextOf = (vehicleRepairingAllowance) =>{
...
<Description term="补贴项名称">{vehicleRepairingAllowance.allowanceTitle}</Description> 
...
class VehicleRepairingAllowanceDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"汽车修理平台补贴",cardsFor: "vehicleRepairingAllowance",cardsSource: this.props.vehicleRepairingAllowance,
  		subItems: [
