...
class VehicleRepairingAllowanceCreateForm extends Component {
  ...
  executeCandidateServiceSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = VehicleRepairingAllowanceService.requestCandidateService("availableService", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'vehicleRepairingAllowance',listName:'汽车修理平台补贴列表' },
      })
    }
