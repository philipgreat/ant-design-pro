...
import styles from './CarReceiveReturning.updateform.less';
...
class CarReceiveReturningUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carReceiveReturningId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carReceiveReturningId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarReceiveReturning',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarReceiveReturningUpdateRow',
            payload: {
              id:owner.id,type:'carReceiveReturning', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新收车返还"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新收车返还"
...
}))(Form.create()(CarReceiveReturningUpdateForm));
