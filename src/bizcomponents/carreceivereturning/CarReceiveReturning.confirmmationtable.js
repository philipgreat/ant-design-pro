...
import styles from './CarReceiveReturning.table.less';
...
class CarReceiveReturningConfirmationTable extends PureComponent {
  render() {
...
export default CarReceiveReturningConfirmationTable;
