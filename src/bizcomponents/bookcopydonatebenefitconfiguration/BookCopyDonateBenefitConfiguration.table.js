...
const columns = [
  ...
  { title: '供应商的利益', debugtype: 'string', dataIndex: 'vendorBenefit',},
  { title: '贷款商店受益', debugtype: 'string', dataIndex: 'lendingStoreBenefit',},
  { title: '平台的好处', debugtype: 'string', dataIndex: 'platformBenefit',},
  { title: '公共服务基金受益', debugtype: 'string', dataIndex: 'publicServiceFundBenefit',},
  { title: '图书管理', dataIndex: 'bookManagement', render: (text, record) => (record.bookManagement ? record.bookManagement.displayName : '暂无') },


]

class BookCopyDonateBenefitConfigurationTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopyDonateBenefitConfigurationTable
