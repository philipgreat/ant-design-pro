...
class CommunityBizApp extends React.PureComponent {
  ...
  getInvitationCodeSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_community', id: state._community.id, listName: 'invitationCodeList' }, // this is for model namespace and
  ...
  getHomePageSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'homePageList' }, // this is for model namespace and
    }))(HomePageSearch)
  }
  ...
  getEncyclopediaItemSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'encyclopediaItemList' }, // this is for model namespace and
  ...
  getTaskPageSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'taskPageList' }, // this is for model namespace and
    }))(TaskPageSearch)
  }
  ...
  getCommunityUserSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'communityUserList' }, // this is for model namespace and
    }))(CommunityUserSearch)
  }
  ...
  getTaskSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'taskList' }, // this is for model namespace and
    }))(TaskSearch)
  }
  getTaskCreateForm = () => {
  ...
  getGroupPageSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'groupPageList' }, // this is for model namespace and
    }))(GroupPageSearch)
  }
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._community.loading,
      owner: { type: '_community', id: state._community.id, listName: 'threadList' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
