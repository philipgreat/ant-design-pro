...
import styles from './Community.edittable.less'
...
{ title: '操作',
   render: (text, record) => renderActions(text, record)}]
    ...
    const newRecord =()=>{
      ...
      newData.push(newCommunityToAppend);
...
export default Form.create()(CommunityEditTable)
