...
import styles from './Coupon.updateform.less'
...
class CouponUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, couponId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateCoupon`,
          payload: {
            id: owner.id,
            type: 'coupon',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextCouponUpdateRow`,
        payload: {
          id: owner.id,
          type: 'coupon',
          selectedRows,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.couponName} {...formItemLayout}>
                  {getFieldDecorator('couponName', {
                    initialValue: selectedRow.couponName,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.couponDiscount} {...formItemLayout}>
                  {getFieldDecorator('couponDiscount', {
                    initialValue: selectedRow.couponDiscount,
