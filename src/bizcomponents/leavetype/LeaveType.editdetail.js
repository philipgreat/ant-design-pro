...
import styles from './LeaveType.editdetail.less'
...
export default class LeaveTypeEditDetail extends Component {
  render() {
    const {EmployeeLeaveEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, employeeLeaveCount } = this.props.leaveType
    const { employeeLeaveList } = this.props.leaveType
