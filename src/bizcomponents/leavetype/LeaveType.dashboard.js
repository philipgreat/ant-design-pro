...
export default class LeaveTypeDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, leaveType } = this.props;
        ...
        <div>
          <Row gutter={24}>
            ...
            <Card title={`请假记录(${numeral(employeeLeaveCount).format('请假记录0,0')})`}  style={{ width: 180 }}>
              ...
              <p><Link to={`/leaveType/${id}/list/employeeLeaveList/请假记录列表`}><FontAwesome name="gear"  />&nbsp;管理</Link></p>
              <p><Link to={`/leaveType/${id}/list/employeeLeaveCreateForm`}><FontAwesome name="plus"  />&nbsp;新增</Link></p>
