  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/leaveType/${objectId}/list/employeeLeaveList`}>请假记录</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.leaveType.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/leaveType/:id/dashboard" component={LeaveTypeDashboard} />
               
               <Route path="/leaveType/:id/editDetail" component={LeaveTypeEditDetail} />
               <Route path="/leaveType/:id/viewDetail" component={LeaveTypeViewDetail} /> 
               

               <Route path="/leaveType/:id/list/employeeLeaveList" component={this.getEmployeeLeaveSearch()} />
               <Route path="/leaveType/:id/list/employeeLeaveCreateForm" component={this.getEmployeeLeaveCreateForm()} />
               <Route path="/leaveType/:id/list/employeeLeaveUpdateForm" component={this.getEmployeeLeaveUpdateForm()} />
