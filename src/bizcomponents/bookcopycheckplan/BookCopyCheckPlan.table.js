...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/bookCopyCheckPlan/${text}/dashboard`}>{text}</Link>) },
  { title: '检查计划的名字', debugtype: 'string', dataIndex: 'checkPlanName',},
  ...
  { title: '检查计划状态', debugtype: 'string', dataIndex: 'checkPlanStatus',},
