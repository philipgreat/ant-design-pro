...
import styles from './BookCopyCheckPlan.editdetail.less'
...
class BookCopyCheckPlanEditDetail extends Component {
  render() {
    const {BookCopyCheckRecordEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, bookCopyCheckRecordCount } = this.props.bookCopyCheckPlan
    const { bookCopyCheckRecordList } = this.props.bookCopyCheckPlan
