...
import styles from './BookCopySharingBenefitConfiguration.table.less'
...
class BookCopySharingBenefitConfigurationTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopySharingBenefitConfigurationTable
