...
import TaskHidingDashboard from './TaskHiding.dashboard'
import TaskHidingEditDetail from './TaskHiding.editdetail'
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/taskHiding/${this.props.taskHiding.id}/editDetail`}><Icon type="edit" /><span>详情编辑</span></Link>
             </Menu.Item>
