...
import {TaskHidingTable} from '../../custcomponents';
import {TaskHidingConfirmationTable} from '../../custcomponents';

import {TaskHidingSearchForm} from '../../custcomponents';
...
export default class TaskHidingSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskHidingList: 1,
      taskHidingListCurrentPage: pagination.current,
      taskHidingListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
