...
import styles from './TaskHiding.updateform.less';
...
class TaskHidingUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const taskHidingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,taskHidingId, ...imagesValues };
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextTaskHidingUpdateRow',
            payload: {
              id:owner.id,type:'taskHiding', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新任务屏蔽"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新任务屏蔽"
...
}))(Form.create()(TaskHidingUpdateForm));
