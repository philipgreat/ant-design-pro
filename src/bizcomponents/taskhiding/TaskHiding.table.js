...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/taskHiding/${text}/dashboard`}>{text}</Link>) },
...
class TaskHidingTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default TaskHidingTable
