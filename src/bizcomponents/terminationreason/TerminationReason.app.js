  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/terminationReason/${objectId}/list/terminationList`}>雇佣终止</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.terminationReason.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/terminationReason/:id/dashboard" component={TerminationReasonDashboard} />
               
               <Route path="/terminationReason/:id/editDetail" component={TerminationReasonEditDetail} />
               <Route path="/terminationReason/:id/viewDetail" component={TerminationReasonViewDetail} /> 
               

               <Route path="/terminationReason/:id/list/terminationList" component={this.getTerminationSearch()} />
               <Route path="/terminationReason/:id/list/terminationCreateForm" component={this.getTerminationCreateForm()} />
               <Route path="/terminationReason/:id/list/terminationUpdateForm" component={this.getTerminationUpdateForm()} />
