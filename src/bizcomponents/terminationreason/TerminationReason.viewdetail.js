...
import styles from './TerminationReason.viewdetail.less'
...
export default class TerminationReasonViewDetail extends Component {
  ...
  render() {
    ...
    const { id, terminationCount } = terminationReason
    const { terminationList } = terminationReason
