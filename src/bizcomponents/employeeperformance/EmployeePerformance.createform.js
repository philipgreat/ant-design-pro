...
class EmployeePerformanceCreateForm extends Component {
  ...
  executeCandidateEmployeeSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = EmployeePerformanceService.requestCandidateEmployee("employee", id, filterKey, pageNo);
    console.log(future);
          ...
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.performanceComment}>
                  {getFieldDecorator('performanceComment', {
                    rules: [{ required: true, message: '请输入绩效评价' }],
                  })(
                    <Input placeholder="请输入请输入绩效评价string" />
                  )}
                </Form.Item>
              </Col>
