...
const columns = [
  ...
  { title: '总结', debugtype: 'string', dataIndex: 'summary',},
  { title: '变化量', debugtype: 'string', dataIndex: 'changeAmount',},
...
class FundationAccountDetailsTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default FundationAccountDetailsTable
