...
const columns = [
  ...
  { title: '结果', debugtype: 'string', dataIndex: 'result',},
  ...
  { title: '游戏场次运行记录', debugtype: 'string', dataIndex: 'gameSessionComment',},
...
class GameSessionRecordTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default GameSessionRecordTable
