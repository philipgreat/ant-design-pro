...
const columns = [
  ...
  { title: '微信主要订单Id', debugtype: 'string', dataIndex: 'wechatMainOrderId',},
  { title: 'Wechat提前支付Id', debugtype: 'string', dataIndex: 'wechatPrepayId',},
...
class MainOrderPaymentTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default MainOrderPaymentTable
