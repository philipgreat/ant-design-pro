...
const testValues = {
  paymentMethod: '微信',
  originalAmount: '698.84',
  actualAmount: '943.64',
  paymentStatus: '未支付',
  wechatMainOrderId: '',
  wechatPrepayId: '',
  createTime: '2999-08-19 17:31:54',
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'mainOrderPayment',listName:'主要订单付款列表' },
      })
    }
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.wechatMainOrderId} {...formItemLayout}>
                  {getFieldDecorator('wechatMainOrderId', {
                    rules: [{ required: true, message: '请输入微信主要订单Id' }],
                  })(
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.wechatPrepayId} {...formItemLayout}>
                  {getFieldDecorator('wechatPrepayId', {
                    rules: [{ required: true, message: '请输入Wechat提前支付Id' }],
                  })(
