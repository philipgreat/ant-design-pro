  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'appIcon',
        width: '13',
        render: (text, record) => renderStringEdit('appIcon', text, record),
      },
      {
        title: '完全访问',
        dataIndex: 'fullAccess',
        render: (text, record) => (record.fullAccess ? '是' : '否'),
      },
      {
        title: '许可',
        debugtype: 'string',
        ...
        width: '8',
        render: (text, record) => renderStringEdit('permission', text, record),
      },
      {
        title: '访问对象类型',
        debugtype: 'string',
      ...
      },
      {
        ...
        dataIndex: 'objectId',
        width: '14',
        render: (text, record) => renderStringEdit('objectId', text, record),
      },
      {
        title: '位置',
        debugtype: 'string',
        dataIndex: 'location',
        width: '16',
        render: (text, record) => renderStringEdit('location', text, record),
      },
      {
        title: '操作',
