...
import UserDomainTable from './UserDomain.table';
import UserDomainConfirmationTable from './UserDomain.confirmmationtable';

import UserDomainSearchForm from './UserDomain.searchform';
...
export default class UserDomainSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      userDomainList: 1,
      userDomainListCurrentPage: pagination.current,
      userDomainListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
  ...
  handleDelete = () => {
    ...
    const userDomainIds = selectedRows.map((item) => { return item.id; });
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'userDomain', selectedRows, currentUpdateIndex },
    });
  }
