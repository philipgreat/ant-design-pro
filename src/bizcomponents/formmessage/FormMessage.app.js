       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/formMessage/${this.props.formMessage.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/formMessage/${this.props.formMessage.id}/editDetail`}><Icon type="edit" /><span>详情编辑</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/formMessage/${this.props.formMessage.id}/viewDetail`}><Icon type="eye-o" /><span>详情查看</span></Link>
             </Menu.Item>
