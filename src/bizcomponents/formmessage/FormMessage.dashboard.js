...
const settingListOf = (formMessage) =>{
...
class FormMessageDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, formMessage } = this.props;
    
    if(!formMessage){
    	return;
    }
    const {displayName} = formMessage;
    if(!displayName){
    	return;
    }
