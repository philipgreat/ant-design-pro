...
class ServiceFileInspectionSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCloseAlert = () => {
      ...
      dispatch({ type: `${owner.type}/view`, payload: { id: owner.id,pathname,displayName:'6年免检服务列表' } })
...
<Menu.Item key="mainOrder">关联年检订单</Menu.Item>
    ...
    return (
      <PageHeaderLayout title={`${displayName}: 6年免检服务列表`}>
        <Card bordered={false}>
...
export default Form.create()(ServiceFileInspectionSearch)
