...
const testValues = {
  ...
  inspectionResult: '通过',
  startTime: '2994-02-07 01:05:56',
  longitude: '105.19971721722699',
  latitude: '30.23984891292065',
  inspectionDatetime: '2998-07-20 02:58:34',
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'serviceFileInspection',listName:'6年免检服务列表' },
      })
    }
