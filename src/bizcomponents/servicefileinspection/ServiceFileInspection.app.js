...
class ServiceFileInspectionBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceFileInspection/${objectId}/list/reportFileInspectionReportList`}
          >
            报告文件检验报告
          </Link>
        </Menu.Item>
  ...
  getReportFileInspectionReportSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_serviceFileInspection',
        id: state._serviceFileInspection.id,
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/serviceFileInspection/:id/list/reportFileInspectionReportList"
                component={this.getReportFileInspectionReportSearch()}
              />
              <Route
                path="/serviceFileInspection/:id/list/reportFileInspectionReportCreateForm"
                component={this.getReportFileInspectionReportCreateForm()}
              />
              <Route
                path="/serviceFileInspection/:id/list/reportFileInspectionReportUpdateForm"
