...
import ThreadRegistrationTable from './ThreadRegistration.table';
import ThreadRegistrationConfirmationTable from './ThreadRegistration.confirmmationtable';

import ThreadRegistrationSearchForm from './ThreadRegistration.searchform';
...
@Form.create()
export default class ThreadRegistrationSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      threadRegistrationList: 1,
      threadRegistrationListCurrentPage: pagination.current,
      threadRegistrationListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
