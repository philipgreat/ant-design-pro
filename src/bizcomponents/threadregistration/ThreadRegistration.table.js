...
const columns = [
  ...
  { title: '参与者', dataIndex: 'participant', render: (text, record) => (record.participant ? (<Link to={`/communityUser/${record.participant.id}/dashboard`}>{record.participant.displayName}</Link>) : '暂无') },
