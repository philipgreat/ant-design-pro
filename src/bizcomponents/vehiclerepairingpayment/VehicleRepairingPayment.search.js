...
export default class VehicleRepairingPaymentSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      vehicleRepairingPaymentList: 1,
      vehicleRepairingPaymentListCurrentPage: pagination.current,
      vehicleRepairingPaymentListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
