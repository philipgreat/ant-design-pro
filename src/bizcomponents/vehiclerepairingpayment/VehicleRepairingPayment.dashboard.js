...
const imageListOf = (vehicleRepairingPayment) =>{
...
const settingListOf = (vehicleRepairingPayment) =>{
...
const largeTextOf = (vehicleRepairingPayment) =>{
...
class VehicleRepairingPaymentDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"支付维修订单",cardsFor: "vehicleRepairingPayment",cardsSource: this.props.vehicleRepairingPayment,
  		subItems: [
