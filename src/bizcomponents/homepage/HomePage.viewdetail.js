...
class HomePageViewDetail extends Component {
  ...
  render() {
    ...
    const { id, slideCount, encyclopediaItemCount, taskFilterCount, taskCount, threadCount } = homePage
    const { slideList, encyclopediaItemList, taskFilterList, taskList, threadList } = homePage
    ...
    const contentList = {
      ...
      taskFilterList:  
        <TaskFilterViewTable data={taskFilterList} owner={owner} {...this.props} />,
