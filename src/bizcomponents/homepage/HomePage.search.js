...
class HomePageSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCloseAlert = () => {
      ...
      dispatch({ type: `${owner.type}/view`, payload: { id: owner.id,pathname,displayName:'主页列表' } })
...
<Menu.Item key="community">关联社区</Menu.Item>
    ...
    return (
      <PageHeaderLayout title={`${displayName}: 主页列表`}>
        <Card bordered={false}>
