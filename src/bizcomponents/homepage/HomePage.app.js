...
class HomePageBizApp extends React.PureComponent {
  ...
  getSlideSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_homePage', id: state._homePage.id, listName: 'slideList' }, // this is for model namespace and
    }))(SlideSearch)
  }
  getSlideCreateForm = () => {
  ...
  getEncyclopediaItemSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._homePage.loading,
      owner: { type: '_homePage', id: state._homePage.id, listName: 'encyclopediaItemList' }, // this is for model namespace and
  ...
  getTaskFilterSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._homePage.loading,
      owner: { type: '_homePage', id: state._homePage.id, listName: 'taskFilterList' }, // this is for model namespace and
    }))(TaskFilterSearch)
  }
  ...
  getTaskSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._homePage.loading,
      owner: { type: '_homePage', id: state._homePage.id, listName: 'taskList' }, // this is for model namespace and
    }))(TaskSearch)
  }
  getTaskCreateForm = () => {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._homePage.loading,
      owner: { type: '_homePage', id: state._homePage.id, listName: 'threadList' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
