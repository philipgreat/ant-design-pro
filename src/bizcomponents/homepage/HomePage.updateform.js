...
import styles from './HomePage.updateform.less';
...
class HomePageUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const homePageId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,homePageId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateHomePage',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextHomePageUpdateRow',
            payload: {
              id:owner.id,type:'homePage', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新主页"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新主页"
...
}))(Form.create()(HomePageUpdateForm));
