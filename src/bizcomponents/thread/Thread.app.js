...
class ThreadBizApp extends React.PureComponent {
  ...
  getThreadReplySearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_thread', id: state._thread.id, listName: 'threadReplyList' }, // this is for model namespace and
    }))(ThreadReplySearch)
  }
  ...
  getThreadRegistrationSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._thread.loading,
      owner: { type: '_thread', id: state._thread.id, listName: 'threadRegistrationList' }, // this is for model namespace and
  ...
  getThreadLikeSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._thread.loading,
      owner: { type: '_thread', id: state._thread.id, listName: 'threadLikeList' }, // this is for model namespace and
    }))(ThreadLikeSearch)
  }
