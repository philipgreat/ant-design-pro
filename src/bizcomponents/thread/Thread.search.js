...
import {ThreadTable} from '../../custcomponents';
import {ThreadConfirmationTable} from '../../custcomponents';

import {ThreadSearchForm} from '../../custcomponents';
...
export default class ThreadSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      threadList: 1,
      threadListCurrentPage: pagination.current,
      threadListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
