...
class ThreadEditTable extends PureComponent {
  ...
  { title: '显示顺序', debugtype: 'int', dataIndex: 'displayOrder', width: '10', render: (text, record) => renderStringEdit('name',text, record)  },
  ...
  { title: '事件的位置', debugtype: 'string', dataIndex: 'eventLocation', width: '13', render: (text, record) => renderStringEdit('name',text, record)  },
  { title: '城市', debugtype: 'string', dataIndex: 'city', width: '6', render: (text, record) => renderStringEdit('name',text, record)  },
  { title: '社区组', debugtype: 'string', dataIndex: 'communityGroup', width: '8', render: (text, record) => renderStringEdit('name',text, record)  },
  { title: '帖子类型', debugtype: 'string', dataIndex: 'threadType', width: '9', render: (text, record) => renderStringEdit('name',text, record)  },
  ...
  { title: '当前状态', debugtype: 'string', dataIndex: 'currentStatus', width: '13', render: (text, record) => renderStringEdit('name',text, record)  },
{ title: '操作',
