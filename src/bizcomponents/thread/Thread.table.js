...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/thread/${text}/dashboard`}>{text}</Link>) },
  { title: '标题', debugtype: 'string', dataIndex: 'title',},
  { title: '显示顺序', debugtype: 'int', dataIndex: 'displayOrder',},
  ...
  { title: '事件的位置', debugtype: 'string', dataIndex: 'eventLocation',},
  { title: '城市', debugtype: 'string', dataIndex: 'city',},
  { title: '社区组', debugtype: 'string', dataIndex: 'communityGroup',},
  { title: '帖子类型', debugtype: 'string', dataIndex: 'threadType',},
