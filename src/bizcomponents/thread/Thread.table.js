...
const columns = [
  ...
  { title: '创建者', dataIndex: 'creator', render: (text, record) => (record.creator ? (<Link to={`/communityUser/${record.creator.id}/dashboard`}>{record.creator.displayName}</Link>) : '暂无') },
  ...
  { title: '群组页面', dataIndex: 'groupPage', render: (text, record) => (record.groupPage ? (<Link to={`/groupPage/${record.groupPage.id}/dashboard`}>{record.groupPage.displayName}</Link>) : '暂无') },
  ...
  { title: '验收', dataIndex: 'approval', render: (text, record) => (record.approval ? (<Link to={`/threadApproval/${record.approval.id}/dashboard`}>{record.approval.displayName}</Link>) : '暂无') },
  { title: '取消', dataIndex: 'canceling', render: (text, record) => (record.canceling ? (<Link to={`/threadCanceling/${record.canceling.id}/dashboard`}>{record.canceling.displayName}</Link>) : '暂无') },
  { title: '完成', dataIndex: 'completion', render: (text, record) => (record.completion ? (<Link to={`/threadCompletion/${record.completion.id}/dashboard`}>{record.completion.displayName}</Link>) : '暂无') },
  { title: '躲藏', dataIndex: 'hiding', render: (text, record) => (record.hiding ? (<Link to={`/threadHiding/${record.hiding.id}/dashboard`}>{record.hiding.displayName}</Link>) : '暂无') },
