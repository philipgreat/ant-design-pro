  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="创建时间">
        {moment(thread.createTime).format('YYYY-MM-DD')}
      </Description>
      <Description term="事件时间">
        {moment(thread.eventTime).format('YYYY-MM-DD')}
      </Description>
      <Description term="注册时间停止">
        {moment(thread.registrationStopTime).format('YYYY-MM-DD')}
      </Description>
      ...
      <Description term="当前用户已点赞">
        {thread.likeByCurrentUser ? '是' : '否'}
      </Description>
      <Description term="当前用户已回复">
        {thread.repliedByCurrentUser ? '是' : '否'}
      </Description>
      <Description term="由当前用户注册">
        {thread.registeredByCurrentUser ? '是' : '否'}
      </Description>
          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/thread/${id}/list/threadReplyList`}>
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link to={`/thread/${id}/list/threadReplyCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/thread/${id}/list/threadRegistrationList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/thread/${id}/list/threadRegistrationCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/thread/${id}/list/threadLikeList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/thread/${id}/list/threadLikeCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
