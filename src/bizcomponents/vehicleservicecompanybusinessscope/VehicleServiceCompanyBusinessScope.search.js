...
export default class VehicleServiceCompanyBusinessScopeSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      ...
      vehicleServiceCompanyBusinessScopeListCurrentPage: pagination.current,
      vehicleServiceCompanyBusinessScopeListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="服务提供商服务范围管理列表">
        <Card bordered={false}>
