...
const summaryOf = vehicleServiceCompanyBusinessScope => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="可用状态">
        {vehicleServiceCompanyBusinessScope.serviceAvailability ? '是' : '否'}
      </Description>
    </DescriptionList>
  )
}
...
export default class VehicleServiceCompanyBusinessScopeDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '商户服务范围',
      cardsFor: 'vehicleServiceCompanyBusinessScope',
      cardsSource: this.props.vehicleServiceCompanyBusinessScope,
      subItems: [],
    }
