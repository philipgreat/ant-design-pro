...
class VehicleServiceCompanyBusinessScopeCreateForm extends Component {
  ...
  executeCandidateCompanySearch = filterKey => {
    ...
    const pageNo = 1
    const future = VehicleServiceCompanyBusinessScopeService.requestCandidateCompany(
  ...
  executeCandidateAvailableServiceSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = VehicleServiceCompanyBusinessScopeService.requestCandidateAvailableService(
      'availableService',
      id,
      filterKey,
      pageNo
