...
const columns = [
  ...
  { title: '选定的任务', debugtype: 'string', dataIndex: 'selectedTask', width: '5',render: (text, record) => (<Input value={text} placeHolder={"选定的任务"}/>)  },
  ...
  { title: '发布人的奖金', debugtype: 'int', dataIndex: 'creatorBonus', width: '7',render: (text, record) => (<Input value={text} placeHolder={"发布人的奖金"}/>)  },
  { title: '额外的奖金', debugtype: 'int', dataIndex: 'additionalBonus', width: '7',render: (text, record) => (<Input value={text} placeHolder={"额外的奖金"}/>)  },
  ...
  { title: '当前状态', debugtype: 'string', dataIndex: 'currentStatus', width: '12',render: (text, record) => (<Input value={text} placeHolder={"当前状态"}/>)  },
];
