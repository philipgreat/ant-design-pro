  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: '5',
        render: (text, record) =>
          renderStringEdit('selectedTask', text, record),
      },
      {
        title: '创建时间',
      ...
      },
      {
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('creatorBonus', text, record),
      },
      {
        title: '额外的奖金',
        debugtype: 'int',
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('additionalBonus', text, record),
      },
      {
        title: '躲藏',
        dataIndex: 'hiding',
      ...
      },
      {
        ...
        dataIndex: 'resolving',
        render: (text, record) =>
          record.resolving ? record.resolving.displayName : '暂无',
      },
      {
        title: '悬赏',
        dataIndex: 'reward',
        render: (text, record) =>
          record.reward ? record.reward.displayName : '暂无',
      },
      {
        title: '当前用户已点赞',
