  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="当前用户已点赞">
        {task.likeByCurrentUser ? '是' : '否'}
      </Description>
      <Description term="当前用户已回复">
        {task.repliedByCurrentUser ? '是' : '否'}
      </Description>
          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/task/${id}/list/taskAssigmentList`}>
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link to={`/task/${id}/list/taskAssigmentCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/task/${id}/list/taskLikeList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/task/${id}/list/taskLikeCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/task/${id}/list/taskReplyList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/task/${id}/list/taskReplyCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
