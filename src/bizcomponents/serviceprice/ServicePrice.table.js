...
const columns = [
  ...
  { title: '服务代码', debugtype: 'string', dataIndex: 'serviceKey',},
  { title: '服务描述', debugtype: 'string', dataIndex: 'serviceDescription',},
  { title: '合同价格类型', debugtype: 'string', dataIndex: 'servicePriceType',},
  { title: '服务价格', debugtype: 'double', dataIndex: 'basePriceValue',},
  { title: '后续服务价格', debugtype: 'double', dataIndex: 'otherPriceValue',},
