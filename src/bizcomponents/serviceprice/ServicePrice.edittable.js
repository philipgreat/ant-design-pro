...
class ServicePriceEditTable extends PureComponent {
  ...
  { title: '服务描述', debugtype: 'string', dataIndex: 'serviceDescription', width: '35', render: (text, record) => renderStringEdit('serviceDescription',text, record)  },
  { title: '合同价格类型', debugtype: 'string', dataIndex: 'servicePriceType', width: '11', render: (text, record) => renderStringEdit('servicePriceType',text, record)  },
