  ...
  render() {
    ...
    const columns = [
      { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        dataIndex: 'contract',
        render: (text, record) =>
          record.contract ? record.contract.displayName : '暂无',
      },
      {
        title: '服务范围',
      ...
      },
      {
        ...
        width: '11',
        render: (text, record) =>
          renderStringEdit('servicePriceType', text, record),
      },
      {
        title: '服务价格',
        debugtype: 'double',
        ...
        width: '9',
        render: (text, record) =>
          renderStringEdit('basePriceValue', text, record),
      },
      {
        title: '后续服务价格',
        debugtype: 'double',
        ...
        width: '9',
        render: (text, record) =>
          renderStringEdit('otherPriceValue', text, record),
      },
      {
        title: '是否提供服务',
