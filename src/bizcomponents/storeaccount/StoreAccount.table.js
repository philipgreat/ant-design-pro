...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/storeAccount/${text}/dashboard`}>{text}</Link>) },
...
class StoreAccountTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default StoreAccountTable
