...
import styles from './StoreAccount.dashboard.less'
...
const imageListOf = (storeAccount) =>{
...
const settingListOf = (storeAccount) =>{
...
const largeTextOf = (storeAccount) =>{
...
class StoreAccountDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, storeAccount } = this.props;
    
    if(!storeAccount){
    	return;
    }
    const {displayName} = storeAccount;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const cardsData = {cardsName:"存储账户",cardsFor: "storeAccount",cardsSource: this.props.storeAccount,
  		subItems: [
