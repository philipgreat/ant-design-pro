...
import styles from './StoreAccount.editdetail.less'
...
class StoreAccountEditDetail extends Component {
  render() {
    const {StoreAccountDetailsEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, storeAccountDetailsCount } = this.props.storeAccount
    const { storeAccountDetailsList } = this.props.storeAccount
