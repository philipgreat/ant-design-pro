         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/accountManagement/:id/editDetail" component={AccountManagementEditDetail} />
               <Route path="/accountManagement/:id/viewDetail" component={AccountManagementViewDetail} /> 
