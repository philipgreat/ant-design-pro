  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/availableInsurance/${objectId}/list/vehicleInspectionInsuranceOrderList`}>车辆检测保险服务订单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/availableInsurance/${objectId}/list/serviceInsuranceForInspectionList`}>保险增值服务</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
