  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="保险产品名称">
        {availableInsurance.insuranceName}
      </Description>
      <Description term="保险承保方">
        {availableInsurance.insuranceVendor}
      </Description>
      <Description term="保险价格">
        {availableInsurance.insurancePrice}
      </Description>
        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/availableInsurance/${id}/list/vehicleInspectionInsuranceOrderList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/availableInsurance/${id}/list/vehicleInspectionInsuranceOrderCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/availableInsurance/${id}/list/serviceInsuranceForInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/availableInsurance/${id}/list/serviceInsuranceForInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
