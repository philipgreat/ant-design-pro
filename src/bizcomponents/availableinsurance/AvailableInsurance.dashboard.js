...
const imageListOf = (availableInsurance) =>{
...
const settingListOf = (availableInsurance) =>{
...
const largeTextOf = (availableInsurance) =>{
...
class AvailableInsuranceDashboard extends Component {
