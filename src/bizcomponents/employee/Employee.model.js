...
export default {
  ...
  effects: {
    ...
    *addOnlineOrderRedeemHistory({ payload }, { call, put }) {
      ...
      const data = yield call(EmployeeService.addOnlineOrderRedeemHistory, id, parameters)
      if (hasError(data)) {
      ...
      const location = { pathname: `/employee/${id}/list/${type}List/线上订单兑换记录列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateOnlineOrderRedeemHistory({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.updateOnlineOrderRedeemHistory, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
      ...
      const location = { pathname: `/employee/${id}/list/${type}List/线上订单兑换记录列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *removeOnlineOrderRedeemHistoryList({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.removeOnlineOrderRedeemHistoryList, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *addTicketPrintingHistory({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.addTicketPrintingHistory, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/employee/${id}/list/${type}List/门票打印记录列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateTicketPrintingHistory({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext, selectedRows, currentUpdateIndex } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.updateTicketPrintingHistory, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
      ...
      const location = { pathname: `/employee/${id}/list/${type}List/门票打印记录列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *removeTicketPrintingHistoryList({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.removeTicketPrintingHistoryList, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
    ...
    *addOfflineStoreOrder({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.addOfflineStoreOrder, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/employee/${id}/list/${type}List/线下门店订单列表`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateOfflineStoreOrder({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext, selectedRows, currentUpdateIndex } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.updateOfflineStoreOrder, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
      ...
      const location = { pathname: `/employee/${id}/list/${type}List/线下门店订单列表`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *removeOfflineStoreOrderList({ payload }, { call, put }) {
      ...
      const { id, type, parameters, continueNext } = payload
      console.log('get form parameters', parameters)
      const data = yield call(EmployeeService.removeOfflineStoreOrderList, id, parameters)
      if (hasError(data)) {
        handleServerError(data)
        return
      }
