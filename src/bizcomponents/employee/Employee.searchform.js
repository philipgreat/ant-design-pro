...
@Form.create()
export default class EmployeeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const params = {
        ...
        ...this.buildStringSearchParameters(fieldsValue, 'salaryAccount'),
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, employeeSearchFormParameters: fieldsValue },
      })
    })
  }
