...
import MessageFilterTable from './MessageFilter.table';
import MessageFilterConfirmationTable from './MessageFilter.confirmmationtable';

import MessageFilterSearchForm from './MessageFilter.searchform';
...
@Form.create()
export default class MessageFilterSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      messageFilterList: 1,
      messageFilterListCurrentPage: pagination.current,
      messageFilterListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
