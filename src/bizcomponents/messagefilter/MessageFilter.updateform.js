...
class MessageFilterUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const messageFilterId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, messageFilterId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextMessageFilterUpdateRow`,
        payload: {
          id: owner.id,
          type: 'messageFilter',
          selectedRows,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.messageCount} {...formItemLayout}>
                  {getFieldDecorator('messageCount', {
                    initialValue: selectedRow.messageCount,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.filterKey} {...formItemLayout}>
                  {getFieldDecorator('filterKey', {
                    initialValue: selectedRow.filterKey,
