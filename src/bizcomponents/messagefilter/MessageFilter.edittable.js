...
class MessageFilterEditTable extends PureComponent {
  ...
  { title: '消息计数', debugtype: 'int', dataIndex: 'messageCount', width: '9', render: (text, record) => renderStringEdit('messageCount',text, record)  },
  { title: '过滤器健值', debugtype: 'string', dataIndex: 'filterKey', width: '18', render: (text, record) => renderStringEdit('filterKey',text, record)  },
