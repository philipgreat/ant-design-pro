...
const columns = [
  ...
  { title: '保险订单号', debugtype: 'string', dataIndex: 'insuranceOrderNumber', width: '13' },
  { title: '员工的名字', debugtype: 'string', dataIndex: 'employeeName', width: '6' },
  ...
  { title: '保险价格', debugtype: 'money', dataIndex: 'insurancePrice', width: '9' },
