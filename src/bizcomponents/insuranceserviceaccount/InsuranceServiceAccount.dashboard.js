...
const imageListOf = (insuranceServiceAccount) =>{
...
const settingListOf = (insuranceServiceAccount) =>{
...
const largeTextOf = (insuranceServiceAccount) =>{
...
class InsuranceServiceAccountDashboard extends Component {
