...
class InsuranceServiceAccountEditTable extends PureComponent {
  ...
  { title: '保险订单号', debugtype: 'string', dataIndex: 'insuranceOrderNumber', width: '13', render: (text, record) => renderStringEdit('insuranceOrderNumber',text, record)  },
  { title: '员工的名字', debugtype: 'string', dataIndex: 'employeeName', width: '6', render: (text, record) => renderStringEdit('employeeName',text, record)  },
  ...
  { title: '保险秩序Datetime', dataIndex: 'insuranceOrderDatetime', render: (text, record) => moment(record.insuranceOrderDatetime).format('YYYY-MM-DD HH:mm:ss') },
