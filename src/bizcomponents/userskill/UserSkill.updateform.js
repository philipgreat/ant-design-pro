...
import styles from './UserSkill.updateform.less';
...
class UserSkillUpdateForm extends Component {
 ...
 mapBackToImageValues(convertedImagesValues) {
  ...
  render() {
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextUserSkillUpdateRow',
            payload: {
              id:owner.id,type:'userSkill', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新用户技能"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新用户技能"
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
             ...
             <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.skillName}>
                  {getFieldDecorator('skillName', {
                    rules: [{ required: true, message: '请输入技能名称' }],
                  })(
                    <Input placeholder="请输入请输入技能名称string" />
                  )}
                </Form.Item>
              </Col>			
...
}))(Form.create()(UserSkillUpdateForm));
