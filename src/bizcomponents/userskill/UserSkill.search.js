...
import UserSkillTable from './UserSkill.table';
import UserSkillConfirmationTable from './UserSkill.confirmmationtable';

import UserSkillSearchForm from './UserSkill.searchform';
...
@Form.create()
export default class UserSkillSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      userSkillList: 1,
      userSkillListCurrentPage: pagination.current,
      userSkillListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
