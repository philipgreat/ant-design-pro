...
import styles from './UserSkill.createform.less'
...
class UserSkillCreateForm extends Component {
  state = {
  ...
  executeCandidateUserSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = UserSkillService.requestCandidateUser("communityUser", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addUserSkill`,
          payload: { id: owner.id, type: 'userSkill', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'userSkill',listName:'用户技能列表' },
      })
    }
          ...
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.skillName} {...formItemLayout}>
