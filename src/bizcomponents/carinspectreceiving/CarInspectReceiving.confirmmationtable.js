...
import styles from './CarInspectReceiving.table.less';
...
class CarInspectReceivingConfirmationTable extends PureComponent {
  render() {
...
export default CarInspectReceivingConfirmationTable;
