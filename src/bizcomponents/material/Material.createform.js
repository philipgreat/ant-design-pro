...
import styles from './Material.createform.less'
...
class MaterialCreateForm extends Component {
  ...
  executeCandidatePlatformSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = MaterialService.requestCandidatePlatform("productPlatform", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addMaterial`,
          payload: { id: owner.id, type: 'material', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(MaterialCreateForm))
