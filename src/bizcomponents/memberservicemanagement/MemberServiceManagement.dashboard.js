...
class MemberServiceManagementDashboard extends Component {
  ...
  render() {
    ...
    const { id,displayName, memberServiceProductCount, memberServicePeriodCount } = this.props.memberServiceManagement
...
{name: 'memberServicePeriodList', displayName:'会员服务时间',type:'memberServicePeriod',count:memberServicePeriodCount},
