...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/memberServiceManagement/${text}/dashboard`}>{text}</Link>) },
...
class MemberServiceManagementTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default MemberServiceManagementTable
