...
const columns = [
  ...
  { title: '面试类型', dataIndex: 'interviewType', render: (text, record) => (record.interviewType ? (<Link to={`/interviewType/${record.interviewType.id}/dashboard`}>{record.interviewType.displayName}</Link>) : '暂无') },
