...
export default class EmployeeInterviewDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, employeeInterview } = this.props;
    
    if(!employeeInterview){
    	return;
    }
    const {displayName} = employeeInterview;
    if(!displayName){
    	return;
    }
