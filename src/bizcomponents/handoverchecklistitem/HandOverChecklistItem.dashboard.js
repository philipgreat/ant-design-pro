...
const imageListOf = (handOverChecklistItem) =>{
...
const settingListOf = (handOverChecklistItem) =>{
...
const largeTextOf = (handOverChecklistItem) =>{
...
class HandOverChecklistItemDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, handOverChecklistItem } = this.props;
    
    if(!handOverChecklistItem){
    	return;
    }
    const {displayName} = handOverChecklistItem;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.handOverChecklistItem
    const cardsData = {cardsName:"交接检查项",cardsFor: "handOverChecklistItem",cardsSource: this.props.handOverChecklistItem,
  		subItems: [
