...
const columns = [
  ...
  { title: '保险图1', dataIndex: 'insuranceImage1', render: (text, record) => <ImagePreview imageTitle="保险图1" imageLocation={record.insuranceImage1} /> },
  { title: '保险图2', dataIndex: 'insuranceImage2', render: (text, record) => <ImagePreview imageTitle="保险图2" imageLocation={record.insuranceImage2} /> },
  { title: '保险图片3', dataIndex: 'insuranceImage3', render: (text, record) => <ImagePreview imageTitle="保险图片3" imageLocation={record.insuranceImage3} /> },
  { title: '保险形象4', dataIndex: 'insuranceImage4', render: (text, record) => <ImagePreview imageTitle="保险形象4" imageLocation={record.insuranceImage4} /> },
  { title: '保险图片5', dataIndex: 'insuranceImage5', render: (text, record) => <ImagePreview imageTitle="保险图片5" imageLocation={record.insuranceImage5} /> },
