...
<Description term="保单凭证1">{serviceInsuranceForInspection.insuranceImage1}</Description> 
<Description term="保单凭证2">{serviceInsuranceForInspection.insuranceImage2}</Description> 
<Description term="保单凭证3">{serviceInsuranceForInspection.insuranceImage3}</Description> 
<Description term="保单凭证4">{serviceInsuranceForInspection.insuranceImage4}</Description> 
<Description term="保单凭证5">{serviceInsuranceForInspection.insuranceImage5}</Description> 
