...
<Description term="保险图1">{serviceInsuranceForInspection.insuranceImage1}</Description> 
<Description term="保险图2">{serviceInsuranceForInspection.insuranceImage2}</Description> 
<Description term="保险图片3">{serviceInsuranceForInspection.insuranceImage3}</Description> 
<Description term="保险形象4">{serviceInsuranceForInspection.insuranceImage4}</Description> 
<Description term="保险图片5">{serviceInsuranceForInspection.insuranceImage5}</Description> 
