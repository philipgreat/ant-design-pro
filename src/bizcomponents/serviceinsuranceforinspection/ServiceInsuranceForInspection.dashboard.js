...
const imageListOf = (serviceInsuranceForInspection) =>{

  const imageList = [
	   {"title":'保单凭证1',"imageLocation":serviceInsuranceForInspection.insuranceImage1},
  {"title":'保单凭证2',"imageLocation":serviceInsuranceForInspection.insuranceImage2},
  {"title":'保单凭证3',"imageLocation":serviceInsuranceForInspection.insuranceImage3},
  {"title":'保单凭证4',"imageLocation":serviceInsuranceForInspection.insuranceImage4},
  {"title":'保单凭证5',"imageLocation":serviceInsuranceForInspection.insuranceImage5},
]
...
const settingListOf = (serviceInsuranceForInspection) =>{
...
const largeTextOf = (serviceInsuranceForInspection) =>{
...
class ServiceInsuranceForInspectionDashboard extends Component {
