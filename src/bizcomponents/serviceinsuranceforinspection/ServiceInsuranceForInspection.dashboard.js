  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="保单凭证1">
        <ImagePreview
          imageTitle="保单凭证1"
          imageLocation={serviceInsuranceForInspection.insuranceImage1}
        />
      </Description>
      <Description term="保单凭证2">
        <ImagePreview
          imageTitle="保单凭证2"
          imageLocation={serviceInsuranceForInspection.insuranceImage2}
        />
      </Description>
      <Description term="保单凭证3">
        <ImagePreview
          imageTitle="保单凭证3"
          imageLocation={serviceInsuranceForInspection.insuranceImage3}
        />
      </Description>
      <Description term="保单凭证4">
        <ImagePreview
          imageTitle="保单凭证4"
          imageLocation={serviceInsuranceForInspection.insuranceImage4}
        />
      </Description>
      <Description term="保单凭证5">
        <ImagePreview
          imageTitle="保单凭证5"
          imageLocation={serviceInsuranceForInspection.insuranceImage5}
        />
      </Description>
    </DescriptionList>
  )
...
export default class ServiceInsuranceForInspectionDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '保险服务',
      cardsFor: 'serviceInsuranceForInspection',
      cardsSource: this.props.serviceInsuranceForInspection,
      subItems: [],
    }
