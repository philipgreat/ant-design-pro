...
class ServiceInsuranceForInspectionEditTable extends PureComponent {
  ...
  { title: '保险图1', dataIndex: 'insuranceImage1', render: (text, record) => <ImagePreview imageLocation={record.保险图1} /> },
  { title: '保险图2', dataIndex: 'insuranceImage2', render: (text, record) => <ImagePreview imageLocation={record.保险图2} /> },
  { title: '保险图片3', dataIndex: 'insuranceImage3', render: (text, record) => <ImagePreview imageLocation={record.保险图片3} /> },
  { title: '保险形象4', dataIndex: 'insuranceImage4', render: (text, record) => <ImagePreview imageLocation={record.保险形象4} /> },
  { title: '保险图片5', dataIndex: 'insuranceImage5', render: (text, record) => <ImagePreview imageLocation={record.保险图片5} /> },
