  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.保险图1} />
        ),
      },
      {
        title: '保险图2',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.保险图2} />
        ),
      },
      {
        title: '保险图片3',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.保险图片3} />
        ),
      },
      {
        title: '保险形象4',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.保险形象4} />
        ),
      },
      {
        title: '保险图片5',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.保险图片5} />
        ),
      },
      {
        title: '主订单',
