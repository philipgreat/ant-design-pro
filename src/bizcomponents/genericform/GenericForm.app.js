  ...
  getFormMessageSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._genericForm,
        listDisplayName: '表单信息列表',
          ...
          >
            ...
            >
              <Menu.Item key="dashboard">
                <Link
                  to={`/genericForm/${this.props.genericForm.id}/dashboard`}
                >
                  <Icon type="dashboard" />
                  <span>仪表板</span>
                </Link>
