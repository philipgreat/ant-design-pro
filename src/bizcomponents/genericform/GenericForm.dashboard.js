...
export default class GenericFormDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '通用的形式',
      cardsFor: 'genericForm',
      cardsSource: this.props.genericForm,
      subItems: [
        {
          name: 'formMessageList',
          displayName: '表单信息',
          type: 'formMessage',
          count: formMessageCount,
        },
        {
          name: 'formFieldMessageList',
          displayName: '表单字段的信息',
          type: 'formFieldMessage',
          count: formFieldMessageCount,
        },
        {
          name: 'formFieldList',
          displayName: '表单字段',
