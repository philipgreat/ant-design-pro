...
export default class GenericFormDashboard extends Component {
  render() {
    ...
    const {
      id,
      formMessageCount,
      formFieldMessageCount,
      formFieldCount,
      formActionCount,
    } = this.props.genericForm
          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/genericForm/${id}/list/formMessageList`}>
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link to={`/genericForm/${id}/list/formMessageCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/genericForm/${id}/list/formFieldMessageList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/genericForm/${id}/list/formFieldMessageCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/genericForm/${id}/list/formFieldList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/genericForm/${id}/list/formFieldCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/genericForm/${id}/list/formActionList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/genericForm/${id}/list/formActionCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
