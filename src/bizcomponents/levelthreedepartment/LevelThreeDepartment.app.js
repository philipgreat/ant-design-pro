  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/levelThreeDepartment/${objectId}/list/employeeList`}>员工</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.levelThreeDepartment.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/levelThreeDepartment/:id/dashboard" component={LevelThreeDepartmentDashboard} />
               
               <Route path="/levelThreeDepartment/:id/editDetail" component={LevelThreeDepartmentEditDetail} />
               <Route path="/levelThreeDepartment/:id/viewDetail" component={LevelThreeDepartmentViewDetail} /> 
               

               <Route path="/levelThreeDepartment/:id/list/employeeList" component={this.getEmployeeSearch()} />
               <Route path="/levelThreeDepartment/:id/list/employeeCreateForm" component={this.getEmployeeCreateForm()} />
               <Route path="/levelThreeDepartment/:id/list/employeeUpdateForm" component={this.getEmployeeUpdateForm()} />
