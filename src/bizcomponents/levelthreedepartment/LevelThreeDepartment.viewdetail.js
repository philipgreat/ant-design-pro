...
import styles from './LevelThreeDepartment.viewdetail.less'
...
export default class LevelThreeDepartmentViewDetail extends Component {
  ...
  render() {
    ...
    const { id, employeeCount } = levelThreeDepartment
    const { employeeList } = levelThreeDepartment
