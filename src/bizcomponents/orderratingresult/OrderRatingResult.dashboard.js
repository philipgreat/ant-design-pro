...
const imageListOf = (orderRatingResult) =>{
...
const settingListOf = (orderRatingResult) =>{
...
const largeTextOf = (orderRatingResult) =>{
...
class OrderRatingResultDashboard extends Component {
