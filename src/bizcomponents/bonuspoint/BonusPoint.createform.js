...
class BonusPointCreateForm extends Component {
  ...
  executeCandidateUserSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = BonusPointService.requestCandidateUser("communityUser", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBonusPoint`,
          payload: { id: owner.id, type: 'bonusPoint', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'bonusPoint',listName:'积分列表' },
      })
    }
