...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/memberServiceProduct/${text}/dashboard`}>{text}</Link>) },
  { title: '产品名称', debugtype: 'string', dataIndex: 'productName',},
  { title: '产品描述', debugtype: 'string', dataIndex: 'productDescription',},
