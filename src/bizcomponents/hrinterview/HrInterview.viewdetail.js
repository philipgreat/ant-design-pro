...
import styles from './HrInterview.viewdetail.less'
...
export default class HrInterviewViewDetail extends Component {
  ...
  render() {
    ...
    const { id, employeeCount } = hrInterview
    const { employeeList } = hrInterview
