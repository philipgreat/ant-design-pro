...
import styles from './TaskResolving.updateform.less';
...
class TaskResolvingUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const taskResolvingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,taskResolvingId, ...imagesValues };
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextTaskResolvingUpdateRow',
            payload: {
              id:owner.id,type:'taskResolving', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新任务分解"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新任务分解"
...
}))(Form.create()(TaskResolvingUpdateForm));
