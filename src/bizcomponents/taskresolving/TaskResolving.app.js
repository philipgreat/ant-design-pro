      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/taskResolving/${this.props.taskResolving.id}/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
              </Link>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/taskResolving/:id/dashboard"
                component={TaskResolvingDashboard}
              />

              <Route
                path="/taskResolving/:id/editDetail"
                component={TaskResolvingEditDetail}
              />
              <Route
                path="/taskResolving/:id/viewDetail"
                component={TaskResolvingViewDetail}
              />

              <Route
                path="/taskResolving/:id/list/taskList"
                component={this.getTaskSearch()}
              />
              <Route
                path="/taskResolving/:id/list/taskCreateForm"
                component={this.getTaskCreateForm()}
              />
              <Route
                path="/taskResolving/:id/list/taskUpdateForm"
