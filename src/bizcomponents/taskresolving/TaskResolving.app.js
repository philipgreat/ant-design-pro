...
const menuData = {menuName:"任务分解", menuFor: "taskResolving",
  		subItems: [
...
class TaskResolvingBizApp extends React.PureComponent {
  ...
  getTaskSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._taskResolving.partialList,
      owner: { type: '_taskResolving', id: state._taskResolving.id, referenceName: 'resolving', listName: 'taskList', ref:state._taskResolving, listDisplayName: '任务列表' }, // this is for model namespace and
    }))(TaskSearch)
  }
  getTaskCreateForm = () => {
  ...
  getTaskUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_taskResolving', id: state._taskResolving.id, listName: 'taskList', ref:state._taskResolving, listDisplayName: '任务列表' }, // this is for model namespace and
    }))(TaskUpdateForm)
  }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {TaskResolvingDashboard} = GlobalComponents
     const {TaskResolvingEditDetail} = GlobalComponents
     const {TaskResolvingViewDetail} = GlobalComponents
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/taskResolving/:id/viewDetail" component={TaskResolvingViewDetail} /> 
