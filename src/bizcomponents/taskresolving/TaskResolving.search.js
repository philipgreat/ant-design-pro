...
import TaskResolvingTable from './TaskResolving.table';
import TaskResolvingConfirmationTable from './TaskResolving.confirmmationtable';

import TaskResolvingSearchForm from './TaskResolving.searchform';
...
@Form.create()
export default class TaskResolvingSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskResolvingList: 1,
      taskResolvingListCurrentPage: pagination.current,
      taskResolvingListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
