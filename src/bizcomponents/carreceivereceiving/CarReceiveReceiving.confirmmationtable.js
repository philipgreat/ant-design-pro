...
import styles from './CarReceiveReceiving.table.less';
...
class CarReceiveReceivingConfirmationTable extends PureComponent {
  render() {
...
export default CarReceiveReceivingConfirmationTable;
