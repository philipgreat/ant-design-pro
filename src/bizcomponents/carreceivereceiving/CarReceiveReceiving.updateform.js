...
import styles from './CarReceiveReceiving.updateform.less';
...
class CarReceiveReceivingUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carReceiveReceivingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carReceiveReceivingId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarReceiveReceiving',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarReceiveReceivingUpdateRow',
            payload: {
              id:owner.id,type:'carReceiveReceiving', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新已收到车"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新已收到车"
...
}))(Form.create()(CarReceiveReceivingUpdateForm));
