...
const imageListOf = (companyQrcodePromotionRecord) =>{
...
const settingListOf = (companyQrcodePromotionRecord) =>{
...
const largeTextOf = (companyQrcodePromotionRecord) =>{
...
class CompanyQrcodePromotionRecordDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, companyQrcodePromotionRecord } = this.props;
    
    if(!companyQrcodePromotionRecord){
    	return;
    }
    const {displayName} = companyQrcodePromotionRecord;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.companyQrcodePromotionRecord
    const cardsData = {cardsName:"公司二维码推广记录",cardsFor: "companyQrcodePromotionRecord",cardsSource: this.props.companyQrcodePromotionRecord,
  		subItems: [
