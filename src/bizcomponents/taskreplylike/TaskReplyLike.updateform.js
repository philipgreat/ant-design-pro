...
import styles from './TaskReplyLike.updateform.less';
...
class TaskReplyLikeUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const taskReplyLikeId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,taskReplyLikeId, ...imagesValues };
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextTaskReplyLikeUpdateRow',
            payload: {
              id:owner.id,type:'taskReplyLike', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新任务回复点赞"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新任务回复点赞"
...
}))(Form.create()(TaskReplyLikeUpdateForm));
