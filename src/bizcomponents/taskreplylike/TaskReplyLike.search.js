...
import TaskReplyLikeTable from './TaskReplyLike.table';
import TaskReplyLikeConfirmationTable from './TaskReplyLike.confirmmationtable';

import TaskReplyLikeSearchForm from './TaskReplyLike.searchform';
...
@Form.create()
export default class TaskReplyLikeSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskReplyLikeList: 1,
      taskReplyLikeListCurrentPage: pagination.current,
      taskReplyLikeListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
