...
export default {
  ...
  subscriptions: {
    ...
    setup({ dispatch, history }) { 
      history.listen((location) => {
        ...
        const match = pathToRegexp('/taskReplyLike/:id/list/:listName/:listDisplayName').exec(pathname)
        if (!match) {
          return
  ...
  effects: {
    ...
    *gotoCreateForm({ payload }, { put }) {
      ...
      yield put(routerRedux.push(`/taskReplyLike/${id}/list/${type}CreateForm`))
    },
    ...
    *goback({ payload }, { put }) {
      ...
      yield put(routerRedux.push(`/taskReplyLike/${id}/list/${type}List/${listName}`))
    },
