...
class ServiceFileMovementM2mChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceFileMovementM2mChecklistResultConfirmationTable
