...
import styles from './ServiceFileMovementM2mChecklistResult.createform.less'
...
class ServiceFileMovementM2mChecklistResultCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addServiceFileMovementM2mChecklistResult`,
          payload: { id: owner.id, type: 'serviceFileMovementM2mChecklistResult', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ServiceFileMovementM2mChecklistResultCreateForm))
