...
export default class ServiceFileMovementM2mChecklistResultViewDetail extends Component {
  ...
  render() {
    ...
    const serviceFileMovementM2mChecklistResult = this.props.serviceFileMovementM2mChecklistResult
    const { id,  } = serviceFileMovementM2mChecklistResult
    const {  } = serviceFileMovementM2mChecklistResult
