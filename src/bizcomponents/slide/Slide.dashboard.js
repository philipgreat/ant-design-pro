...
const imageListOf = (slide) =>{

	 return(<Card title='图片列表' className={styles.card}><Row type="flex" justify="space-between" align="bottom">
<Col span={4}><ImagePreview imageTitle ={'图像网址'} imageLocation={slide.imageUrl} >图像网址</ImagePreview></Col>
</Row></Card> )
