...
import styles from './Role.app.less'
...
class RoleBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {RoleEditDetail} = GlobalComponents
     const {RoleViewDetail} = GlobalComponents
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.role.id)}
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/role/:id/dashboard" component={RoleDashboard} />
               
               <Route path="/role/:id/editDetail" component={RoleEditDetail} />
               <Route path="/role/:id/viewDetail" component={RoleViewDetail} /> 
               

               <Route path="/role/:id/list/employeeList" component={this.getEmployeeSearch()} />
               <Route path="/role/:id/list/employeeCreateForm" component={this.getEmployeeCreateForm()} />
               <Route path="/role/:id/list/employeeUpdateForm" component={this.getEmployeeUpdateForm()} />
