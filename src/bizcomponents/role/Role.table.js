...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/role/${text}/dashboard`}>{text}</Link>) },
  { title: '角色名', debugtype: 'string', dataIndex: 'roleName',},
  ...
  { title: '角色Property3', debugtype: 'int', dataIndex: 'roleProperty3',},
