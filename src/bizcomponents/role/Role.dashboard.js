...
const settingListOf = (role) =>{

	return(<Card title='状态集合' className={styles.card}>
<BooleanOption type={role.roleProperty1?"success":"error"} title="角色Property1"/>
<BooleanOption type={role.roleProperty2?"success":"error"} title="角色Property2"/>
</Card> )
