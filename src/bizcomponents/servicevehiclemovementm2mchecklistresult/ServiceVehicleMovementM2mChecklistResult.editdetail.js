...
import styles from './ServiceVehicleMovementM2mChecklistResult.editdetail.less'
...
export default class ServiceVehicleMovementM2mChecklistResultEditDetail extends Component {
  render() {
