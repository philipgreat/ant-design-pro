...
import styles from './ServiceVehicleMovementM2mChecklistResult.updateform.less'
...
class ServiceVehicleMovementM2mChecklistResultUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const serviceVehicleMovementM2mChecklistResultId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, serviceVehicleMovementM2mChecklistResultId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextServiceVehicleMovementM2mChecklistResultUpdateRow`,
        payload: {
          id: owner.id,
          type: 'serviceVehicleMovementM2mChecklistResult',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新送审服务检查结果"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新送审服务检查结果"
...
}))(Form.create()(ServiceVehicleMovementM2mChecklistResultUpdateForm))
