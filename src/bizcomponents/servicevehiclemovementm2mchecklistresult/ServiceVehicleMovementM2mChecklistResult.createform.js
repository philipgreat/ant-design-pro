...
import styles from './ServiceVehicleMovementM2mChecklistResult.createform.less'
...
class ServiceVehicleMovementM2mChecklistResultCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addServiceVehicleMovementM2mChecklistResult`,
          payload: { id: owner.id, type: 'serviceVehicleMovementM2mChecklistResult', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ServiceVehicleMovementM2mChecklistResultCreateForm))
