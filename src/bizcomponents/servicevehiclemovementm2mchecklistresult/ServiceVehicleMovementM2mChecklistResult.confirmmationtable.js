...
class ServiceVehicleMovementM2mChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceVehicleMovementM2mChecklistResultConfirmationTable
