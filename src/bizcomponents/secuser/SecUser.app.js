      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            <Menu.Item>
              <Link to={`/secUser/${this.props.secUser.id}/editDetail`}>
                <Icon type="edit" />
                <span>详情编辑</span>
              </Link>
            </Menu.Item>
            <Menu.Item>
              <Link to={`/secUser/${this.props.secUser.id}/viewDetail`}>
                <Icon type="eye-o" />
                <span>详情查看</span>
              </Link>
            </Menu.Item>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/secUser/:id/list/customerList"
                component={this.getCustomerSearch()}
              />
              <Route
                path="/secUser/:id/list/customerCreateForm"
                component={this.getCustomerCreateForm()}
              />
              <Route
                path="/secUser/:id/list/customerUpdateForm"
