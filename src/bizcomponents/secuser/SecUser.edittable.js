...
const columns = [
  ...
  { title: '登录', debugtype: 'string', dataIndex: 'login', width: '9',render: (text, record) => (<Input value={text} placeholder={"登录"}/>)  },
  ...
  { title: '电子邮件', debugtype: 'string_email', dataIndex: 'email', width: '23',render: (text, record) => (<Input value={text} placeholder={"电子邮件"}/>)  },
  { title: 'PWD', debugtype: 'string_password', dataIndex: 'pwd', width: '11',render: (text, record) => (<Input value={text} placeholder={"PWD"}/>)  },
