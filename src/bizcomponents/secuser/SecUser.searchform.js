...
@Form.create()
export default class SecUserSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          secUserSearchFormParameters: fieldsValue,
        },
      })
    })
  }
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="登录">
              {getFieldDecorator('login')(<Input placeholder="请输入登录" />)}
            </FormItem>
          </Col>
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label="手机">
              {getFieldDecorator('mobile')(<Input placeholder="请输入手机" />)}
            </FormItem>
          </Col>
          ...
          <Col md={8} sm={24}>
            <FormItem label="PWD">
              {getFieldDecorator('pwd')(<Input placeholder="请输入PWD" />)}
            </FormItem>
          </Col>
