...
const columns = [
  ...
  { title: '屏蔽', dataIndex: 'blocking', render: (text, record) => (record.blocking ? (<Link to={`/secUserBlocking/${record.blocking.id}/dashboard`}>{record.blocking.displayName}</Link>) : '暂无') },
