...
import styles from './CustomerAccount.editdetail.less'
...
class CustomerAccountEditDetail extends Component {
  render() {
    const {CustomerAccountDetailsEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, customerAccountDetailsCount } = this.props.customerAccount
    const { customerAccountDetailsList } = this.props.customerAccount
