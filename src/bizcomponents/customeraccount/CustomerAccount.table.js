...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/customerAccount/${text}/dashboard`}>{text}</Link>) },
...
class CustomerAccountTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
