...
import styles from './ProductComponent.createform.less'
...
class ProductComponentCreateForm extends Component {
  state = {
  ...
  executeCandidateProductSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ProductComponentService.requestCandidateProduct("product", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addProductComponent`,
          payload: { id: owner.id, type: 'productComponent', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ProductComponentCreateForm))
