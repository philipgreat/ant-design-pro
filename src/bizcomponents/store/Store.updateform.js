...
class StoreUpdateForm extends Component {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout
        title={"更新门店"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新门店"
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.openningHours} {...formItemLayout}>
                  {getFieldDecorator('openningHours', {
                    initialValue: selectedRow.openningHours,
