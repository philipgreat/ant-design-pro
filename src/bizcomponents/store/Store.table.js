...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/store/${text}/dashboard`}>{text}</Link>) },
  { title: '门店名字', debugtype: 'string', dataIndex: 'storeName',},
  { title: '地址', debugtype: 'string', dataIndex: 'address',},
  { title: '纬度', debugtype: 'double', dataIndex: 'latitude',},
  { title: '经度', debugtype: 'double', dataIndex: 'longitude',},
  { title: '开放时间', debugtype: 'string', dataIndex: 'openningHours',},
...
class StoreTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
