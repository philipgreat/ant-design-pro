...
import PatientInfoTable from './PatientInfo.table'
import PatientInfoConfirmationTable from './PatientInfo.confirmmationtable'

import PatientInfoSearchForm from './PatientInfo.searchform'
...
@Form.create()
export default class PatientInfoSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      patientInfoList: 1,
      patientInfoListCurrentPage: pagination.current,
      patientInfoListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
  ...
  handleDelete = () => {
    ...
    const patientInfoIds = selectedRows.map(item => {
      return item.id
    })
