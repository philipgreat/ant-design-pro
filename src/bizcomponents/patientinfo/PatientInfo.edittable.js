  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        title: '佩戴设备类型',
        debugtype: 'string',
        dataIndex: 'wearDeviceType',
        width: '8',
        render: (text, record) =>
          renderStringEdit('wearDeviceType', text, record),
      },
      {
        title: '磨损的开始时间',
        dataIndex: 'wearStartTime',
        render: (text, record) =>
          moment(record.wearStartTime).format('YYYY-MM-DD'),
      },
      {
        title: '康复计划',
        debugtype: 'string',
        dataIndex: 'recoverPlan',
        width: '15',
        render: (text, record) => renderStringEdit('recoverPlan', text, record),
      },
      {
        title: '复苏开始时间',
        dataIndex: 'recoverStartTime',
        render: (text, record) =>
          moment(record.recoverStartTime).format('YYYY-MM-DD'),
      },
      {
        title: '用户',
        dataIndex: 'user',
    ...
    const newRecord = () => {
      ...
      newData.push(newPatientInfoToAppend)
