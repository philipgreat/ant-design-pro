  ...
  render() {
    ...
    const remapReference = record => {
      ...
      return {
        ...
        serviceTypeVehicleC2mId,
        serviceTypeVehicleM2mId,
        serviceTypeVehicleM2cId,
        serviceTypeFileC2mId,
        serviceTypeFileM2mId,
        serviceTypeFileM2cId,
      }
    }
    ...
    const columns = [
      { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        width: '11',
        render: (text, record) =>
          renderStringEdit('handOverCheckItemName', text, record),
      },
      {
        title: '检查项目描述',
        ...
        width: '10',
        render: (text, record) =>
          renderStringEdit('checkItemDescription', text, record),
      },
      {
        title: '检车项结果',
        debugtype: 'string',
        ...
        width: '6',
        render: (text, record) =>
          renderStringEdit('handOverCheckResult', text, record),
      },
      {
        title: '检查项意见',
        debugtype: 'string_longtext',
        ...
        width: '10',
        render: (text, record) =>
          renderStringEdit('handOverCheckComment', text, record),
      },
      {
        title: '凭证图片1',
      ...
      },
      {
        ...
        render: (text, record) =>
          record.availableHandOverItem
            ? record.availableHandOverItem.displayName
            : '暂无',
      },
      {
        title: '收车服务',
        ...
        render: (text, record) =>
          record.serviceTypeVehicleC2m
            ? record.serviceTypeVehicleC2m.displayName
            : '暂无',
      },
      {
        title: '移车服务',
        ...
        render: (text, record) =>
          record.serviceTypeVehicleM2m
            ? record.serviceTypeVehicleM2m.displayName
            : '暂无',
      },
      {
        title: '还车服务',
        ...
        render: (text, record) =>
          record.serviceTypeVehicleM2c
            ? record.serviceTypeVehicleM2c.displayName
            : '暂无',
      },
      {
        title: '收件服务',
        ...
        render: (text, record) =>
          record.serviceTypeFileC2m
            ? record.serviceTypeFileC2m.displayName
            : '暂无',
      },
      {
        title: '移件服务',
        ...
        render: (text, record) =>
          record.serviceTypeFileM2m
            ? record.serviceTypeFileM2m.displayName
            : '暂无',
      },
      {
        title: '还件服务',
        ...
        render: (text, record) =>
          record.serviceTypeFileM2c
            ? record.serviceTypeFileM2c.displayName
            : '暂无',
      },
      {
        title: '操作',
