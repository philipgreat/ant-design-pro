        ...
        <Layout>
          ...
          >
            ...
            >
              <Menu.Item key="dashboard">
                <Link
                  to={`/handOverChecklistResult/${
                    this.props.handOverChecklistResult.id
                  }/dashboard`}
                >
                  <Icon type="dashboard" />
                  <span>仪表板</span>
          ...
          <Layout>
            <Content style={{ margin: '24px 24px 0', height: '100%' }}>
              <Switch>
                <Route
                  path="/handOverChecklistResult/:id/dashboard"
                  component={HandOverChecklistResultDashboard}
                />

                <Route
                  path="/handOverChecklistResult/:id/editDetail"
                  component={HandOverChecklistResultEditDetail}
                />
                <Route
                  path="/handOverChecklistResult/:id/viewDetail"
                  component={HandOverChecklistResultViewDetail}
                />
              </Switch>
            </Content>
          </Layout>
