...
const columns = [
  ...
  { title: '移交检查项目名称。', debugtype: 'string', dataIndex: 'handOverCheckItemName', width: '11' },
  { title: '移交检查结果', debugtype: 'string', dataIndex: 'handOverCheckResult', width: '6' },
  { title: '移交检查评论', debugtype: 'string', dataIndex: 'handOverCheckComment', width: '10' },
  { title: '移交检查证据图片1。', dataIndex: 'handOverCheckEvidenceImage1', render: (text, record) => <ImagePreview imageTitle="移交检查证据图片1。" imageLocation={record.handOverCheckEvidenceImage1} /> },
  { title: '移交检查证据图2。', dataIndex: 'handOverCheckEvidenceImage2', render: (text, record) => <ImagePreview imageTitle="移交检查证据图2。" imageLocation={record.handOverCheckEvidenceImage2} /> },
  { title: '移交检查证据图3。', dataIndex: 'handOverCheckEvidenceImage3', render: (text, record) => <ImagePreview imageTitle="移交检查证据图3。" imageLocation={record.handOverCheckEvidenceImage3} /> },
  { title: '移交检查证据图片4。', dataIndex: 'handOverCheckEvidenceImage4', render: (text, record) => <ImagePreview imageTitle="移交检查证据图片4。" imageLocation={record.handOverCheckEvidenceImage4} /> },
  { title: '移交检查证据图片5。', dataIndex: 'handOverCheckEvidenceImage5', render: (text, record) => <ImagePreview imageTitle="移交检查证据图片5。" imageLocation={record.handOverCheckEvidenceImage5} /> },
  { title: '可用移交项目', dataIndex: 'availableHandOverItem', render: (text, record) => (record.availableHandOverItem ? (<Link to={`/availableHandOverItem/${record.availableHandOverItem.id}/dashboard`}>{record.availableHandOverItem.id}</Link>) : '暂无') },
