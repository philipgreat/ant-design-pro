...
class ServiceCompanyAccountEditTable extends PureComponent {
  ...
  { title: '服务订单号', debugtype: 'string', dataIndex: 'serviceOrderNumber', width: '14', render: (text, record) => renderStringEdit('serviceOrderNumber',text, record)  },
  { title: '服务订单代码', debugtype: 'string', dataIndex: 'serviceOrderCode', width: '9', render: (text, record) => renderStringEdit('serviceOrderCode',text, record)  },
  { title: '服务订单名称', debugtype: 'string', dataIndex: 'serviceOrderName', width: '8', render: (text, record) => renderStringEdit('serviceOrderName',text, record)  },
  { title: '服务完成日期时间', dataIndex: 'serviceFulfilledDatetime', render: (text, record) => moment(record.serviceFulfilledDatetime).format('YYYY-MM-DD HH:mm:ss') },
  { title: '合同标识', debugtype: 'string', dataIndex: 'contractId', width: '13', render: (text, record) => renderStringEdit('contractId',text, record)  },
  { title: '合同价格的价值', dataIndex: 'contractPriceValue', className:'money', render: (text, record) => ('￥'+text.toFixed(2)) },
  { title: '合同价格类型', debugtype: 'string', dataIndex: 'contractPriceType', width: '8', render: (text, record) => renderStringEdit('contractPriceType',text, record)  },
  { title: '服务人员的名字', debugtype: 'string', dataIndex: 'serviceWorkerName', width: '7', render: (text, record) => renderStringEdit('serviceWorkerName',text, record)  },
  { title: '服务公司名称', debugtype: 'string', dataIndex: 'serviceCompanyName', width: '27', render: (text, record) => renderStringEdit('serviceCompanyName',text, record)  },
  { title: '主要订单Id', debugtype: 'string', dataIndex: 'mainOrderId', width: '28', render: (text, record) => renderStringEdit('mainOrderId',text, record)  },
