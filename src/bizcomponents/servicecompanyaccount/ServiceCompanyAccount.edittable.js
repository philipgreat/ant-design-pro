  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: '35',
        render: (text, record) =>
          renderStringEdit('serviceOrderCode', text, record),
      },
      {
        title: '服务单名称',
        debugtype: 'string',
        ...
        width: '8',
        render: (text, record) =>
          renderStringEdit('serviceOrderName', text, record),
      },
      {
        title: '服务完成时间',
      ...
      },
      {
        ...
        width: '13',
        render: (text, record) => renderStringEdit('contractId', text, record),
      },
      {
        title: '服务价格',
      ...
      },
      {
        ...
        width: '8',
        render: (text, record) =>
          renderStringEdit('contractPriceType', text, record),
      },
      {
        title: '服务人员',
        debugtype: 'string',
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('serviceWorkerName', text, record),
      },
      {
        title: '商户名称',
        debugtype: 'string',
        ...
        width: '27',
        render: (text, record) =>
          renderStringEdit('serviceCompanyName', text, record),
      },
      {
        title: '年检订单ID',
        debugtype: 'string',
