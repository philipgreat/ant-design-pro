...
import styles from './OutputInterface.viewdetail.less'
...
export default class OutputInterfaceViewDetail extends Component {
  ...
  render() {
    ...
    const outputInterface = this.props.outputInterface
    const { id,  } = outputInterface
