...
import styles from './District.dashboard.less'
...
class DistrictDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, district } = this.props;
  ...
  render() {
    ...
    const { id,displayName, storeCount } = this.props.district
    const cardsData = {cardsName:"区",cardsFor: "district",cardsSource: this.props.district,
  		subItems: [
