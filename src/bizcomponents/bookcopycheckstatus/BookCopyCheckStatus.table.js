...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/bookCopyCheckStatus/${text}/dashboard`}>{text}</Link>) },
...
class BookCopyCheckStatusTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopyCheckStatusTable
