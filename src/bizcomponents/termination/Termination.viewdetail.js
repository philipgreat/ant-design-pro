...
import styles from './Termination.viewdetail.less'
...
export default class TerminationViewDetail extends Component {
  ...
  render() {
    ...
    const { id, employeeCount } = termination
    const { employeeList } = termination
    ...
    return (
      ...
      <PageHeaderLayout
        title="雇佣终止总览"
        content={summaryOf(this.props.termination)}
