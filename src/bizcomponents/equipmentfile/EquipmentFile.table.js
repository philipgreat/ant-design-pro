...
const columns = [
  ...
  { title: '文件位置', dataIndex: 'fileLocation', render: (text, record) => <ImagePreview imageTitle="文件位置" imageLocation={record.fileLocation} /> },
...
class EquipmentFileTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default EquipmentFileTable
