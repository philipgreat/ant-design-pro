...
import styles from './EquipmentFile.viewdetail.less'
...
export default class EquipmentFileViewDetail extends Component {
  ...
  render() {
    ...
    const equipmentFile = this.props.equipmentFile
    const { id,  } = equipmentFile
    const {  } = equipmentFile
    
    const owner = { type: '_equipmentFile', id }
