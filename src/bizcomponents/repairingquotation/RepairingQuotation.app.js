...
class RepairingQuotationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/repairingQuotation/${objectId}/list/repairingQuotationItemList`}
          >
            维修报价项目
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/repairingQuotation/${objectId}/list/vehicleRepairingPaymentList`}
          >
            修理付款
          </Link>
        </Menu.Item>
  ...
  getRepairingQuotationItemSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._repairingQuotation.repairingQuotationItemCurrentPageNumber,
      searchFormParameters:
        state._repairingQuotation.repairingQuotationItemSearchFormParameters,
      loading: state._repairingQuotation.loading,
      owner: {
        type: '_repairingQuotation',
        id: state._repairingQuotation.id,
  ...
  getVehicleRepairingPaymentSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._repairingQuotation.vehicleRepairingPaymentCurrentPageNumber,
      searchFormParameters:
        state._repairingQuotation.vehicleRepairingPaymentSearchFormParameters,
      loading: state._repairingQuotation.loading,
      owner: {
        type: '_repairingQuotation',
        id: state._repairingQuotation.id,
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/repairingQuotation/${
                  this.props.repairingQuotation.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/repairingQuotation/:id/dashboard"
                component={RepairingQuotationDashboard}
              />
              <Route
                path="/repairingQuotation/:id/editDetail"
                component={RepairingQuotationEditDetail}
              />
              <Route
                path="/repairingQuotation/:id/viewDetail"
                component={RepairingQuotationViewDetail}
              />

              <Route
                path="/repairingQuotation/:id/list/repairingQuotationItemList"
                component={this.getRepairingQuotationItemSearch()}
              />
              <Route
                path="/repairingQuotation/:id/list/repairingQuotationItemCreateForm"
                component={this.getRepairingQuotationItemCreateForm()}
              />
              <Route
                path="/repairingQuotation/:id/list/repairingQuotationItemUpdateForm"
                component={this.getRepairingQuotationItemUpdateForm()}
              />

              <Route
                path="/repairingQuotation/:id/list/vehicleRepairingPaymentList"
                component={this.getVehicleRepairingPaymentSearch()}
              />
              <Route
                path="/repairingQuotation/:id/list/vehicleRepairingPaymentCreateForm"
                component={this.getVehicleRepairingPaymentCreateForm()}
              />
              <Route
                path="/repairingQuotation/:id/list/vehicleRepairingPaymentUpdateForm"
