...
class RepairingQuotationEditTable extends PureComponent {
  ...
  { title: '维修报价描述', debugtype: 'string', dataIndex: 'repairingQuotationDescription', width: '13', render: (text, record) => renderStringEdit('repairingQuotationDescription',text, record)  },
