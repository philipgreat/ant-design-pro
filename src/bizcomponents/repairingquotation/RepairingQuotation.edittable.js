...
class RepairingQuotationEditTable extends PureComponent {
  ...
  { title: '车辆维修报价单', debugtype: 'string', dataIndex: 'repairingQuotationDescription', width: '13', render: (text, record) => renderStringEdit('repairingQuotationDescription',text, record)  },
