...
class BannerBizApp extends React.PureComponent {
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {BannerEditDetail} = GlobalComponents
     //const {BannerViewDetail} = GlobalComponents
         ...
         >
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/banner/${this.props.banner.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>


             {this.getNavMenuItems(this.props.banner.id)}
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/banner/:id/dashboard" component={BannerDashboard} />
