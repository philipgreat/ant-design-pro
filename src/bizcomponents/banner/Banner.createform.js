...
import styles from './Banner.createform.less'
...
/*
const testValues = {
  linkUrl: 'http://www.pulupulu.com/product/info?id=54',
  altText: 'DC档案：古宅惊魂',
  storeId: 'S000001',
}
*/
...
class BannerCreateForm extends Component {
  state = {
  ...
  executeCandidateStoreSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = BannerService.requestCandidateStore("store", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addBanner`,
          payload: { id: owner.id, type: 'banner', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'banner',listName:'横幅列表' },
      })
    }
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.altText} {...formItemLayout}>
                  {getFieldDecorator('altText', {
                    rules: [{ required: true, message: '请输入Alt文本' }],
                  })(
                    <Input placeholder="请输入Alt文本" />
                  )}
                </Form.Item>
              </Col>
