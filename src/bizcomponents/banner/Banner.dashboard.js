...
const imageListOf = (banner) =>{

  const imageList = [
	   {"title":'图像',"imageLocation":banner.image},
]
...
const summaryOf = (banner) =>{

	return (
	<DescriptionList className={styles.headerList} size="small" col="4">
<Description term="ID">{banner.id}</Description> 
<Description term="链接网址">{banner.linkUrl}</Description> 
...
class BannerDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, banner } = this.props;
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.banner
    const cardsData = {cardsName:"横幅",cardsFor: "banner",cardsSource: this.props.banner,
  		subItems: [
