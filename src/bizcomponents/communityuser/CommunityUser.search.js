...
import CommunityUserTable from './CommunityUser.table';
import CommunityUserConfirmationTable from './CommunityUser.confirmmationtable';

import CommunityUserSearchForm from './CommunityUser.searchform';
...
@Form.create()
export default class CommunityUserSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
