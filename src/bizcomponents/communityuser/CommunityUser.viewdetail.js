...
export default class CommunityUserViewDetail extends Component {
  ...
  render() {
    ...
    const tabList = [
      ...
      {
        key: 'threadRegistrationList',
        tab: `活动注册(${threadRegistrationCount})`,
      },
      { key: 'threadLikeList', tab: `主贴点赞(${threadLikeCount})` },
      {
        key: 'threadReplyLikeList',
        tab: `跟帖回复点赞(${threadReplyLikeCount})`,
      },
    ...
    const contentList = {
      ...
      fanList: <FanViewTable data={fanList} owner={owner} {...this.props} />,
