...
class CommunityUserEditDetail extends Component {
  render() {
      ...
      >
		...
		<Card title="病人信息列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <PatientInfoEditTable data={patientInfoList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="用户技能列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <UserSkillEditTable data={userSkillList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="消息过滤列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <MessageFilterEditTable data={messageFilterList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="用户消息列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <UserMessageEditTable data={userMessageList} owner={owner} {...this.props} />
          </Form>
        </Card>
		...
		<Card title="任务回复点赞列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <TaskReplyLikeEditTable data={taskReplyLikeList} owner={owner} {...this.props} />
          </Form>
        </Card>
		...
		<Card title="跟帖回复列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <ThreadReplyEditTable data={threadReplyList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="活动注册列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <ThreadRegistrationEditTable data={threadRegistrationList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="主贴点赞列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <ThreadLikeEditTable data={threadLikeList} owner={owner} {...this.props} />
          </Form>
        </Card>
		...
		<Card title="积分列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <BonusPointEditTable data={bonusPointList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="成长值列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <ExperiencePointEditTable data={experiencePointList} owner={owner} {...this.props} />
          </Form>
        </Card>
