...
class CompanyEmployeeMessageEditTable extends PureComponent {
  ...
  { title: '标题', debugtype: 'string', dataIndex: 'title', width: '13', render: (text, record) => renderStringEdit('title',text, record)  },
  { title: '消息内容', debugtype: 'string', dataIndex: 'messageContent', width: '36', render: (text, record) => renderStringEdit('messageContent',text, record)  },
  ...
  { title: '状态', debugtype: 'string', dataIndex: 'status', width: '6', render: (text, record) => renderStringEdit('status',text, record)  },
{ title: '操作',
