...
import styles from './CarRepairWorking.updateform.less';
...
class CarRepairWorkingUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carRepairWorkingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carRepairWorkingId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarRepairWorking',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarRepairWorkingUpdateRow',
            payload: {
              id:owner.id,type:'carRepairWorking', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车修理工作"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车修理工作"
...
}))(Form.create()(CarRepairWorkingUpdateForm));
