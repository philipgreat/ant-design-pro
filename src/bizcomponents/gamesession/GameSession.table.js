...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/gameSession/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '场次开始后可售票时长', debugtype: 'int', dataIndex: 'sessionReservation',},
  { title: '余票', debugtype: 'int', dataIndex: 'inventory',},
...
class GameSessionTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
