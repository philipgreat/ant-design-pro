...
import styles from './GameSession.updateform.less'
...
class GameSessionUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const gameSessionId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, gameSessionId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateGameSession`,
          payload: {
            id: owner.id,
            type: 'gameSession',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextGameSessionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'gameSession',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新游戏场次"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新游戏场次"
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.endTime} {...formItemLayout}>
                  {getFieldDecorator('endTime', {
                    initialValue: selectedRow.endTime,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.sessionReservation} {...formItemLayout}>
                  {getFieldDecorator('sessionReservation', {
                    initialValue: selectedRow.sessionReservation,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.inventory} {...formItemLayout}>
                  {getFieldDecorator('inventory', {
                    initialValue: selectedRow.inventory,
...
}))(Form.create()(GameSessionUpdateForm))
