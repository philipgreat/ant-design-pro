...
class BookReviewBizApp extends React.PureComponent {
  ...
  getBookReviewLikeSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_bookReview', id: state._bookReview.id, referenceName: 'bookReview', listName: 'bookReviewLikeList', ref:state._bookReview, listDisplayName: '这样的书评列表' }, // this is for model namespace and
  ...
  getBookReviewLikeUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_bookReview', id: state._bookReview.id, listName: 'bookReviewLikeList', ref:state._bookReview, listDisplayName: '这样的书评列表' }, // this is for model namespace and
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/bookReview/:id/dashboard" component={BookReviewDashboard} />
               
               <Route path="/bookReview/:id/editDetail" component={BookReviewEditDetail} />
               <Route path="/bookReview/:id/viewDetail" component={BookReviewViewDetail} /> 
               

               <Route path="/bookReview/:id/list/bookReviewLikeList" component={this.getBookReviewLikeSearch()} />
               <Route path="/bookReview/:id/list/bookReviewLikeCreateForm" component={this.getBookReviewLikeCreateForm()} />
               <Route path="/bookReview/:id/list/bookReviewLikeUpdateForm" component={this.getBookReviewLikeUpdateForm()} />
