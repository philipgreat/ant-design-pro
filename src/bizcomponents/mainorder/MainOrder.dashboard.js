...
class MainOrderDashboard extends Component {
  ...
  render() {
    ...
    const { id,displayName, lineItemCount, mainOrderPaymentCount, platformAccountDetailsCount, fundationAccountDetailsCount, storeAccountDetailsCount, customerAccountDetailsCount } = this.props.mainOrder
