...
class MainOrderBizApp extends React.PureComponent {
  ...
  getMemberCustomerSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._mainOrder.memberCustomerList,
      count: state._mainOrder.memberCustomerCount,
      currentPage: state._mainOrder.memberCustomerCurrentPageNumber,
      searchFormParameters: state._mainOrder.memberCustomerSearchFormParameters,
      loading: state._mainOrder.loading,
      partialList: state._mainOrder.partialList,
      owner: { type: '_mainOrder', id: state._mainOrder.id, referenceName: 'mainOrder', listName: 'memberCustomerList', ref:state._mainOrder, listDisplayName: '会员的客户列表' }, // this is for model namespace and
  ...
  getMemberCustomerUpdateForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._mainOrder.selectedRows,
      currentUpdateIndex: state._mainOrder.currentUpdateIndex,
      owner: { type: '_mainOrder', id: state._mainOrder.id, listName: 'memberCustomerList', ref:state._mainOrder, listDisplayName: '会员的客户列表' }, // this is for model namespace and
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/mainOrder/:id/editDetail" component={MainOrderEditDetail} />
               <Route path="/mainOrder/:id/viewDetail" component={MainOrderViewDetail} /> 
               ...
               <Route path="/mainOrder/:id/list/memberCustomerList" component={this.getMemberCustomerSearch()} />
               <Route path="/mainOrder/:id/list/memberCustomerCreateForm" component={this.getMemberCustomerCreateForm()} />
               <Route path="/mainOrder/:id/list/memberCustomerUpdateForm" component={this.getMemberCustomerUpdateForm()} />
