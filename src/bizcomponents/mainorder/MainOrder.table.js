...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/mainOrder/${text}/dashboard`}>{text}</Link>) },
  { title: '主要订单状态', debugtype: 'string', dataIndex: 'mainOrderStatus',},
...
class MainOrderTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
