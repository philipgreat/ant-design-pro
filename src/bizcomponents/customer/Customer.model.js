...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        const dashboardmatch = pathToRegexp('/customer/:id/dashboard').exec(
          pathname
        )
        if (dashboardmatch) {
        ...
        const editDetailMatch = pathToRegexp('/customer/:id/editDetail').exec(
          pathname
        )
        if (editDetailMatch) {
        ...
        const viewDetailMatch = pathToRegexp('/customer/:id/viewDetail').exec(
          pathname
        )
        if (viewDetailMatch) {
        ...
        const match = pathToRegexp('/customer/:id/list/:listName').exec(
          pathname
        )
        if (!match) {
          return
  ...
  effects: {
    ...
    *gotoUpdateForm({ payload }, { put }) {
      ...
      const location = {
        pathname: `/customer/${id}/list/${type}UpdateForm`,
        state,
      }
    ...
    *addCompanyQrcodePromotionRecord({ payload }, { call, put }) {
      ...
      const data = yield call(
        CustomerService.addCompanyQrcodePromotionRecord,
        id,
        parameters
      )
      if (hasError(data)) {
      ...
      const location = {
        pathname: `/customer/${id}/list/${type}List`,
        state: data,
      }
      yield put(routerRedux.push(location))
    },
    *updateCompanyQrcodePromotionRecord({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.updateCompanyQrcodePromotionRecord,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeCompanyQrcodePromotionRecordList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.removeCompanyQrcodePromotionRecordList,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeVehicleInfoList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.removeVehicleInfoList,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *addVehicleInspectionOrder({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.addVehicleInspectionOrder,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateVehicleInspectionOrder({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.updateVehicleInspectionOrder,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeVehicleInspectionOrderList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.removeVehicleInspectionOrderList,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *addOrderDiscountCoupon({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.addOrderDiscountCoupon,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateOrderDiscountCoupon({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.updateOrderDiscountCoupon,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeOrderDiscountCouponList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.removeOrderDiscountCouponList,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *addVehicleInspectionOrderCoupon({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.addVehicleInspectionOrderCoupon,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateVehicleInspectionOrderCoupon({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.updateVehicleInspectionOrderCoupon,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeVehicleInspectionOrderCouponList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        CustomerService.removeVehicleInspectionOrderCouponList,
        id,
        parameters
      )
      if (hasError(data)) {
