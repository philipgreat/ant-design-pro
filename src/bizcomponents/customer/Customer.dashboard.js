          ...
          <Row gutter={24}>
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/customer/${id}/list/vehicleInfoList`}><Icon type="profile" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/customer/${id}/list/vehicleInfoCreateForm`}><Icon type="plus-circle-o" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
                <Link to={`/customer/${id}/list/vehicleInfoList`}><Icon type="line-chart" style={{ fontSize: 20, color: '#08c' }} /></Link>
              </ChartCard>
            </Col>
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/customer/${id}/list/vehicleInspectionOrderList`}><Icon type="profile" style={{ fontSize: 20, color: '#08c' }} /></Link>
                &nbsp;
