  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const params = {
        ...
        ...this.buildStringSearchParameters(fieldsValue, 'serviceAcountOpenid'),
        ...this.buildStringSearchParameters(fieldsValue, 'wechatUnionId'),
        ...this.buildStringSearchParameters(fieldsValue, 'mobileNumber'),
        ...this.buildStringSearchParameters(fieldsValue, 'memberLevelTitle'),
        ...this.buildStringSearchParameters(fieldsValue, 'memberLevelCode'),
