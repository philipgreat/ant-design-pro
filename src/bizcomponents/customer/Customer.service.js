...
const updateBorrowingHistory = (targetObjectId, parameters) => {
  const url = `${PREFIX}`
  const customerId = targetObjectId
  const requestParameters = { ...parameters, customerId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
...
const addWorkshopReview = (targetObjectId, parameters) => {
  const url = `${PREFIX}customerManager/addWorkshopReview/reviewerId/workshopId/reviewContent/tokensExpr/`
  const requestParameters = { ...parameters, tokensExpr: 'none' }
...
const addMemberCustomer = (targetObjectId, parameters) => {
  const url = `${PREFIX}`
  const requestParameters = { ...parameters, tokensExpr: 'none' }
...
const updateMemberCustomer = (targetObjectId, parameters) => {
  const url = `${PREFIX}`
  const customerId = targetObjectId
  const requestParameters = { ...parameters, customerId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
...
const removeMemberCustomerList = (targetObjectId, parameters) => {
  const url = `${PREFIX}customerManager/removeMemberCustomerList/customerId/memberCustomerIds/tokensExpr/`
  const requestParameters = { ...parameters, customerId: targetObjectId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
    url,
