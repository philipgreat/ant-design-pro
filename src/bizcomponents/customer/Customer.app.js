...
class CustomerBizApp extends React.PureComponent {
  ...
  getMemberCustomerSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._customer.memberCustomerList,
      count: state._customer.memberCustomerCount,
      currentPage: state._customer.memberCustomerCurrentPageNumber,
      searchFormParameters: state._customer.memberCustomerSearchFormParameters,
      loading: state._customer.loading,
      partialList: state._customer.partialList,
      owner: { type: '_customer', id: state._customer.id, referenceName: 'customer', listName: 'memberCustomerList', ref:state._customer, listDisplayName: '会员的客户列表' }, // this is for model namespace and
  ...
  getMemberCustomerUpdateForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._customer.selectedRows,
      currentUpdateIndex: state._customer.currentUpdateIndex,
      owner: { type: '_customer', id: state._customer.id, listName: 'memberCustomerList', ref:state._customer, listDisplayName: '会员的客户列表' }, // this is for model namespace and
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/customer/:id/list/memberCustomerList" component={this.getMemberCustomerSearch()} />
               <Route path="/customer/:id/list/memberCustomerCreateForm" component={this.getMemberCustomerCreateForm()} />
               <Route path="/customer/:id/list/memberCustomerUpdateForm" component={this.getMemberCustomerUpdateForm()} />
