  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/customer/${objectId}/list/vehicleInspectionOrderList`}>年检订单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/customer/${objectId}/list/orderDiscountCouponList`}>优惠券</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/customer/${objectId}/list/vehicleInspectionOrderCouponList`}>优惠券使用记录</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
