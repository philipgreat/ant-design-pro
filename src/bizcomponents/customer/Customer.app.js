...
class CustomerBizApp extends React.PureComponent {
  ...
  getCompanyQrcodePromotionRecordSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._customer.companyQrcodePromotionRecordCurrentPageNumber,
      searchFormParameters:
        state._customer.companyQrcodePromotionRecordSearchFormParameters,
          ...
          <Layout>
            <Content style={{ margin: '24px 24px 0', height: '100%' }}>
              <Switch>
                ...
                <Route
                  path="/customer/:id/list/companyQrcodePromotionRecordList"
                  component={this.getCompanyQrcodePromotionRecordSearch()}
                />
                <Route
                  path="/customer/:id/list/companyQrcodePromotionRecordCreateForm"
                  component={this.getCompanyQrcodePromotionRecordCreateForm()}
                />
                <Route
                  path="/customer/:id/list/companyQrcodePromotionRecordUpdateForm"
