...
@Form.create()
export default class ServiceFileMovementM2cSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      ...
      'serviceFileMovementM2cList.searchField': fieldName,
      'serviceFileMovementM2cList.searchVerb': 'startsWith',
      'serviceFileMovementM2cList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, serviceFileMovementM2cSearchFormParameters: fieldsValue },
      })
    })
  }
