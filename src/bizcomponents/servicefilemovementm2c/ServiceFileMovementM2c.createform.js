...
class ServiceFileMovementM2cCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = ServiceFileMovementM2cService.requestCandidateResponsibleWorker(
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceFileMovementM2cService.requestCandidateMainOrder(
  ...
  executeCandidateMerchantSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceFileMovementM2cService.requestCandidateMerchant(
