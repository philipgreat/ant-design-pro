...
const testValues = {
  ...
  startTime: '2996-06-25 00:08:32',
  longitude: '104.22015495001142',
  latitude: '32.184637049631135',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_M2C_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2998-08-02 17:09:43',
  notifyAddress: '',
  handoverResult: '',
...
class ServiceFileMovementM2cCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ServiceFileMovementM2cService.requestCandidateResponsibleWorker("vehicleServiceCompanyEmployee", id, filterKey, pageNo);
    console.log(future);
  ...
  executeCandidateMainOrderSearch = (filterKey) =>{
    ...
    const id = "";//not used for now
    const pageNo = 1;
    const future = ServiceFileMovementM2cService.requestCandidateMainOrder("vehicleInspectionOrder", id, filterKey, pageNo);
    console.log(future);
  ...
  executeCandidateMerchantSearch = (filterKey) =>{
    ...
    const id = "";//not used for now
    const pageNo = 1;
    const future = ServiceFileMovementM2cService.requestCandidateMerchant("vehicleServiceCompany", id, filterKey, pageNo);
    console.log(future);
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'serviceFileMovementM2c',listName:'还件服务列表' },
      })
    }
