...
const menuData = {
  menuName: '还件服务',
  menuFor: 'serviceFileMovementM2c',
  subItems: [
...
const displayColumns = [
  {
    ...
    width: '20',
    render: (text, record) => (
      <Link to={`/serviceFileMovementM2c/${text}/dashboard`}>{text}</Link>
    ),
  },
  {
    title: '服务状态',
...
const ServiceFileMovementM2cBase = { menuData, displayColumns, fieldLabels }
