...
import styles from './AvailableRatingItem.app.less'
...
class AvailableRatingItemBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {AvailableRatingItemDashboard} = GlobalComponents
     const {AvailableRatingItemEditDetail} = GlobalComponents
     const {AvailableRatingItemViewDetail} = GlobalComponents
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/availableRatingItem/${this.props.availableRatingItem.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/availableRatingItem/${this.props.availableRatingItem.id}/editDetail`}><Icon type="edit" /><span>详情编辑</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/availableRatingItem/${this.props.availableRatingItem.id}/viewDetail`}><Icon type="eye-o" /><span>详情查看</span></Link>
             </Menu.Item>
             

             {this.getNavMenuItems(this.props.availableRatingItem.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               <Route path="/availableRatingItem/:id/dashboard" component={AvailableRatingItemDashboard} />
