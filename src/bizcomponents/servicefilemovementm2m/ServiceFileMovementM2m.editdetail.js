...
export default class ServiceFileMovementM2mEditDetail extends Component {
  render() {
    const {ServiceFileMovementM2mChecklistResultEditTable} = GlobalComponents;
    ...
    return (
      ...
      >
		...
		<Card title="移件服务检查结果列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <ServiceFileMovementM2mChecklistResultEditTable data={serviceFileMovementM2mChecklistResultList} owner={owner} {...this.props} />
          </Form>
        </Card>
