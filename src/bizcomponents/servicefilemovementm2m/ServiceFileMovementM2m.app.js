...
class ServiceFileMovementM2mBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/serviceFileMovementM2m/${objectId}/list/handOverChecklistResultList`}>交接检查结果</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
  ...
  getHandOverChecklistResultSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_serviceFileMovementM2m', id: state._serviceFileMovementM2m.id, listName: 'handOverChecklistResultList' }, // this is for model namespace and
