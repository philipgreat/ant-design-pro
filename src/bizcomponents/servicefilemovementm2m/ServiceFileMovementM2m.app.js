...
class ServiceFileMovementM2mBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceFileMovementM2m/${objectId}/list/handOverChecklistResultList`}
          >
            移交清单结果
          </Link>
        </Menu.Item>
  ...
  getHandOverChecklistResultSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._serviceFileMovementM2m.handOverChecklistResultCurrentPageNumber,
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/serviceFileMovementM2m/:id/list/handOverChecklistResultList"
                component={this.getHandOverChecklistResultSearch()}
              />
              <Route
                path="/serviceFileMovementM2m/:id/list/handOverChecklistResultCreateForm"
                component={this.getHandOverChecklistResultCreateForm()}
              />
              <Route
                path="/serviceFileMovementM2m/:id/list/handOverChecklistResultUpdateForm"
