...
class ServiceFileMovementM2mBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceFileMovementM2m/${objectId}/list/serviceFileMovementM2mChecklistResultList`}
          >
            移件服务检查结果
          </Link>
        </Menu.Item>
  ...
  getServiceFileMovementM2mChecklistResultSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data:
        state._serviceFileMovementM2m.serviceFileMovementM2mChecklistResultList,
      count:
        state._serviceFileMovementM2m
          .serviceFileMovementM2mChecklistResultCount,
      currentPage:
        state._serviceFileMovementM2m
          .serviceFileMovementM2mChecklistResultCurrentPageNumber,
      searchFormParameters:
        state._serviceFileMovementM2m
          .serviceFileMovementM2mChecklistResultSearchFormParameters,
      loading: state._serviceFileMovementM2m.loading,
      owner: {
        type: '_serviceFileMovementM2m',
        id: state._serviceFileMovementM2m.id,
        listName: 'serviceFileMovementM2mChecklistResultList',
      ...
      <Layout>
            ...
            <Menu.Item>
              <Link
                to={`/serviceFileMovementM2m/${
                  this.props.serviceFileMovementM2m.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/serviceFileMovementM2m/:id/dashboard"
                component={ServiceFileMovementM2mDashboard}
              />
              <Route
                path="/serviceFileMovementM2m/:id/editDetail"
                component={ServiceFileMovementM2mEditDetail}
              />
              <Route
                path="/serviceFileMovementM2m/:id/viewDetail"
                component={ServiceFileMovementM2mViewDetail}
              />

              <Route
                path="/serviceFileMovementM2m/:id/list/serviceFileMovementM2mChecklistResultList"
                component={this.getServiceFileMovementM2mChecklistResultSearch()}
              />
              <Route
                path="/serviceFileMovementM2m/:id/list/serviceFileMovementM2mChecklistResultCreateForm"
                component={this.getServiceFileMovementM2mChecklistResultCreateForm()}
              />
              <Route
                path="/serviceFileMovementM2m/:id/list/serviceFileMovementM2mChecklistResultUpdateForm"
                component={this.getServiceFileMovementM2mChecklistResultUpdateForm()}
              />
            </Switch>
          </Content>
        </Layout>
