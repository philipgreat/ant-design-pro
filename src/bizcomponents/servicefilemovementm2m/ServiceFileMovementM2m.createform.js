...
const testValues = {
  ...
  startTime: '2998-11-02 12:22:17',
  longitude: '103.30615512305383',
  latitude: '32.266749244138815',
  transferVerifyCode: 'O12345',
  movementPurpose: 'FILE_M2M_PICK_IN_STORE',
  notifyDatetime: '2996-03-01 10:26:45',
  notifyAddress: '',
  handoverResult: '',
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'serviceFileMovementM2m',listName:'移件服务列表' },
      })
    }
