...
@Form.create()
export default class ServiceFileMovementM2mSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      serviceFileMovementM2mList: 1,
      'serviceFileMovementM2mList.searchField': fieldName,
      'serviceFileMovementM2mList.searchVerb': 'startsWith',
      'serviceFileMovementM2mList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, serviceFileMovementM2mSearchFormParameters: fieldsValue },
      })
    })
  }
