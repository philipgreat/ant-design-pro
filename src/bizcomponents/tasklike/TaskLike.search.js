...
import TaskLikeTable from './TaskLike.table';
import TaskLikeConfirmationTable from './TaskLike.confirmmationtable';

import TaskLikeSearchForm from './TaskLike.searchform';
...
@Form.create()
export default class TaskLikeSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskLikeList: 1,
      taskLikeListCurrentPage: pagination.current,
      taskLikeListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
