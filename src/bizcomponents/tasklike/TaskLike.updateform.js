...
import styles from './TaskLike.updateform.less';
...
class TaskLikeUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const taskLikeId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,taskLikeId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateTaskLike',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextTaskLikeUpdateRow',
            payload: {
              id:owner.id,type:'taskLike', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新任务点赞"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新任务点赞"
...
}))(Form.create()(TaskLikeUpdateForm));
