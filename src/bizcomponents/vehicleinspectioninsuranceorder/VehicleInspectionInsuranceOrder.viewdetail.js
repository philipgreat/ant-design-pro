...
export default class VehicleInspectionInsuranceOrderViewDetail extends Component {
  ...
  render() {
    ...
    const vehicleInspectionInsuranceOrder = this.props.vehicleInspectionInsuranceOrder
    const { id,  } = vehicleInspectionInsuranceOrder
    const {  } = vehicleInspectionInsuranceOrder
