  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'vehicleInspectionInsuranceOrder',listName:'车辆上线检测保险订单列表' },
      })
    }
          ...
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.insurance} {...formItemLayout}>
                  {getFieldDecorator('insuranceId', {
                  	initialValue: tryinit('insurance'),
                  ...
                  <AutoComplete
                    ...
                    disabled={!availableForEdit('insurance')}
                  >
