...
const imageListOf = (vehicleInspectionInsuranceOrder) =>{
...
const settingListOf = (vehicleInspectionInsuranceOrder) =>{
...
const largeTextOf = (vehicleInspectionInsuranceOrder) =>{
...
class VehicleInspectionInsuranceOrderDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"车辆上线检测保险订单",cardsFor: "vehicleInspectionInsuranceOrder",cardsSource: this.props.vehicleInspectionInsuranceOrder,
  		subItems: [
