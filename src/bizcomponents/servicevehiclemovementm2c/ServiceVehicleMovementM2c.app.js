  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceVehicleMovementM2c/${objectId}/list/handOverChecklistResultList`}
          >
            移交清单结果
          </Link>
        </Menu.Item>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultList"
                component={this.getHandOverChecklistResultSearch()}
              />
              <Route
                path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultCreateForm"
                component={this.getHandOverChecklistResultCreateForm()}
              />
              <Route
                path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultUpdateForm"
