...
class ServiceVehicleMovementM2cBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/serviceVehicleMovementM2c/${objectId}/list/reportHandoverList`}>交接报告</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
  ...
  getReportHandoverSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._serviceVehicleMovementM2c.reportHandoverList,
      count: state._serviceVehicleMovementM2c.reportHandoverCount,
      currentPage: state._serviceVehicleMovementM2c.reportHandoverCurrentPageNumber,
      searchFormParameters: state._serviceVehicleMovementM2c.reportHandoverSearchFormParameters,
      loading: state._serviceVehicleMovementM2c.loading,
      owner: { type: '_serviceVehicleMovementM2c', id: state._serviceVehicleMovementM2c.id, listName: 'reportHandoverList' }, // this is for model namespace and
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/serviceVehicleMovementM2c/${this.props.serviceVehicleMovementM2c.id}/viewDetail`}><Icon type="eye-o" /><span>详情查看</span></Link>
             </Menu.Item>
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/serviceVehicleMovementM2c/:id/viewDetail" component={ServiceVehicleMovementM2cViewDetail} />
               

               <Route path="/serviceVehicleMovementM2c/:id/list/reportHandoverList" component={this.getReportHandoverSearch()} />
               <Route path="/serviceVehicleMovementM2c/:id/list/reportHandoverCreateForm" component={this.getReportHandoverCreateForm()} />
               <Route path="/serviceVehicleMovementM2c/:id/list/reportHandoverUpdateForm" component={this.getReportHandoverUpdateForm()} />
