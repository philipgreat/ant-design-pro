...
class ServiceVehicleMovementM2cBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/serviceVehicleMovementM2c/${objectId}/list/handOverChecklistResultList`}>交接检查结果</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
  ...
  getHandOverChecklistResultSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_serviceVehicleMovementM2c', id: state._serviceVehicleMovementM2c.id, listName: 'handOverChecklistResultList' }, // this is for model namespace and
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultList" component={this.getHandOverChecklistResultSearch()} />
               <Route path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultCreateForm" component={this.getHandOverChecklistResultCreateForm()} />
               <Route path="/serviceVehicleMovementM2c/:id/list/handOverChecklistResultUpdateForm" component={this.getHandOverChecklistResultUpdateForm()} />
