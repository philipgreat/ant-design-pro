...
const testValues = {
  ...
  startTime: '2996-08-29 06:15:47',
  longitude: '104.04468310912203',
  latitude: '31.04482571076268',
  transferVerifyCode: 'O12345',
  movementPurpose: 'VEHICLE_M2C_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2997-08-04 13:00:55',
...
class ServiceVehicleMovementM2cCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = ServiceVehicleMovementM2cService.requestCandidateResponsibleWorker(
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleMovementM2cService.requestCandidateMainOrder(
  ...
  executeCandidateMerchantSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleMovementM2cService.requestCandidateMerchant(
