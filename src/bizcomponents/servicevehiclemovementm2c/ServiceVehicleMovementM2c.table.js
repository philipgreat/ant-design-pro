...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/serviceVehicleMovementM2c/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '移动目的', debugtype: 'string', dataIndex: 'movementPurpose', width: '9' },
