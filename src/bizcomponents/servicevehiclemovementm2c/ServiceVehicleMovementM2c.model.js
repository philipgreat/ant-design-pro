...
export default {
    ...
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        const match = pathToRegexp(
          '/serviceVehicleMovementM2c/:id/list/:listName'
        ).exec(pathname)
        if (!match) {
          return
  ...
  effects: {
    ...
    *addServiceVehicleMovementM2cChecklistResult({ payload }, { call, put }) {
      ...
      const data = yield call(
        ServiceVehicleMovementM2cService.addServiceVehicleMovementM2cChecklistResult,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateServiceVehicleMovementM2cChecklistResult(
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        ServiceVehicleMovementM2cService.updateServiceVehicleMovementM2cChecklistResult,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeServiceVehicleMovementM2cChecklistResultList(
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        ServiceVehicleMovementM2cService.removeServiceVehicleMovementM2cChecklistResultList,
        id,
        parameters
      )
      if (hasError(data)) {
