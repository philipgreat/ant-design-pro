...
const displayColumns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/serviceVehicleMovementM2c/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '服务类型', debugtype: 'string', dataIndex: 'movementPurpose', width: '35' },
...
const ServiceVehicleMovementM2cBase={menuData,displayColumns,fieldLabels}
export default ServiceVehicleMovementM2cBase
