  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="通知日期时间">
        {moment(serviceVehicleMovementM2c.notifyDatetime).format('YYYY-MM-DD')}
      </Description>
      <Description term="通知地址">
        {serviceVehicleMovementM2c.notifyAddress}
      </Description>
      <Description term="备注">
        {serviceVehicleMovementM2c.notifyComment}
      </Description>
      <Description term="交接检查结果">
        {serviceVehicleMovementM2c.handoverResult}
      </Description>
      <Description term="交接检查备注">
        {serviceVehicleMovementM2c.handoverResultComment}
      </Description>
    </DescriptionList>
  )
}
        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleMovementM2c/${id}/list/handOverChecklistResultList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleMovementM2c/${id}/list/handOverChecklistResultCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
