...
const columns = [
  ...
  { title: '检查过程的结果', debugtype: 'string', dataIndex: 'checkProcessResults',},
...
class BookCopyCheckRecordTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopyCheckRecordTable
