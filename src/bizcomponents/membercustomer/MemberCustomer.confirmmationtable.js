...
const columns = [
  ...
  { title: '开始日期Datetime', dataIndex: 'startDateDatetime', render: (text, record) => moment(record.startDateDatetime).format('YYYY-MM-DD') },
  { title: '过期日期Datetime', dataIndex: 'expiredDateDatetime', render: (text, record) => moment(record.expiredDateDatetime).format('YYYY-MM-DD') },
...
class MemberCustomerConfirmationTable extends PureComponent {
  render() {
...
export default MemberCustomerConfirmationTable
