          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/groupPage/${id}/list/groupFilterList`}>
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link to={`/groupPage/${id}/list/groupFilterCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/groupPage/${id}/list/threadList`}>
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
                ...
                &nbsp;
                <Link to={`/groupPage/${id}/list/threadCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
