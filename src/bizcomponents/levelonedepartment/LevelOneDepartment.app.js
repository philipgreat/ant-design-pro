  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/levelOneDepartment/${objectId}/list/levelTwoDepartmentList`}>二级部门</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.levelOneDepartment.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/levelOneDepartment/:id/dashboard" component={LevelOneDepartmentDashboard} />
               
               <Route path="/levelOneDepartment/:id/editDetail" component={LevelOneDepartmentEditDetail} />
               <Route path="/levelOneDepartment/:id/viewDetail" component={LevelOneDepartmentViewDetail} /> 
               

               <Route path="/levelOneDepartment/:id/list/levelTwoDepartmentList" component={this.getLevelTwoDepartmentSearch()} />
               <Route path="/levelOneDepartment/:id/list/levelTwoDepartmentCreateForm" component={this.getLevelTwoDepartmentCreateForm()} />
               <Route path="/levelOneDepartment/:id/list/levelTwoDepartmentUpdateForm" component={this.getLevelTwoDepartmentUpdateForm()} />
