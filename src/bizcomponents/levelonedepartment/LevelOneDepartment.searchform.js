...
@Form.create()
export default class LevelOneDepartmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const params = {
        ...
        ...this.buildStringSearchParameters(fieldsValue, 'manager'),

      }
      const { owner } = this.props
      dispatch({
        type: `${owner.type}/load`,
        payload: { id: owner.id, parameters: params, levelOneDepartmentSearchFormParameters: fieldsValue },
      })
    })
  }
