...
class FanSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCloseAlert = () => {
      ...
      dispatch({ type: `${owner.type}/view`, payload: { id: owner.id,pathname,displayName:'粉丝列表' } })
...
<Menu.Item key="user">关联用户</Menu.Item>
    ...
    return (
      <PageHeaderLayout title={`${displayName}: 粉丝列表`}>
        <Card bordered={false}>
...
export default Form.create()(FanSearch)
