...
import styles from './ThreadReply.updateform.less';
...
class ThreadReplyUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const threadReplyId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,threadReplyId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateThreadReply',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextThreadReplyUpdateRow',
            payload: {
              id:owner.id,type:'threadReply', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新跟帖回复"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新跟帖回复"
...
}))(Form.create()(ThreadReplyUpdateForm));
