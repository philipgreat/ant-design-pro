...
const columns = [
  ...
  { title: '评论发布日期时间', dataIndex: 'reviewPublishDatetime', render: (text, record) => moment(record.reviewPublishDatetime).format('YYYY-MM-DD') },
]

class WorkshopReviewConfirmationTable extends PureComponent {
  render() {
...
export default WorkshopReviewConfirmationTable
