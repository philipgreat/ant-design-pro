...
class AvailableVehicleUseCharacterSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCreate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'availableVehicleUseCharacter' },
    })
  }
...
export default Form.create()(AvailableVehicleUseCharacterSearch)
