...
const imageListOf = (availableVehicleUseCharacter) =>{
...
const settingListOf = (availableVehicleUseCharacter) =>{

	const optionList = [ 
	  {"title":'可6年免检',"value":availableVehicleUseCharacter.canDoExempt},
  {"title":'商用车辆',"value":availableVehicleUseCharacter.commercialVehicle},
]
...
const largeTextOf = (availableVehicleUseCharacter) =>{
...
class AvailableVehicleUseCharacterDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"车辆使用性质",cardsFor: "availableVehicleUseCharacter",cardsSource: this.props.availableVehicleUseCharacter,
  		subItems: [
