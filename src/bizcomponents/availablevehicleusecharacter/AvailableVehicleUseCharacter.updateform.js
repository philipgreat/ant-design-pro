...
import styles from './AvailableVehicleUseCharacter.updateform.less'
...
class AvailableVehicleUseCharacterUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const availableVehicleUseCharacterId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, availableVehicleUseCharacterId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAvailableVehicleUseCharacterUpdateRow`,
        payload: {
          id: owner.id,
          type: 'availableVehicleUseCharacter',
          selectedRows,
...
}))(Form.create()(AvailableVehicleUseCharacterUpdateForm))
