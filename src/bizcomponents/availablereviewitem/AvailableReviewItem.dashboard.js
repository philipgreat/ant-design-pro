...
const imageListOf = (availableReviewItem) =>{
...
const settingListOf = (availableReviewItem) =>{
...
const largeTextOf = (availableReviewItem) =>{
...
class AvailableReviewItemDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, availableReviewItem } = this.props;
    
    if(!availableReviewItem){
    	return;
    }
    const {displayName} = availableReviewItem;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.availableReviewItem
    const cardsData = {cardsName:"评论",cardsFor: "availableReviewItem",cardsSource: this.props.availableReviewItem,
  		subItems: [
