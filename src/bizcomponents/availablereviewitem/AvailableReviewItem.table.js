...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/availableReviewItem/${text}/dashboard`}>{text}</Link>) },
...
class AvailableReviewItemTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default AvailableReviewItemTable
