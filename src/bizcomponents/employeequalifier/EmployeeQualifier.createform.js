...
class EmployeeQualifierCreateForm extends Component {
  ...
  executeCandidateEmployeeSearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = EmployeeQualifierService.requestCandidateEmployee("employee", id, filterKey, pageNo);
    console.log(future);
          ...
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.qualifiedTime}>
                  {getFieldDecorator('qualifiedTime', {
                    rules: [{ required: true, message: '请输入合格的时间' }],
                  })(
                    <Input placeholder="请输入请输入合格的时间date" />
                  )}
                </Form.Item>
              </Col>
