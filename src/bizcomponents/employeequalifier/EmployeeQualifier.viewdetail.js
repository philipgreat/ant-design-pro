...
import styles from './EmployeeQualifier.viewdetail.less'
...
export default class EmployeeQualifierViewDetail extends Component {
  ...
  render() {
    ...
    const { id,  } = employeeQualifier
    const {  } = employeeQualifier
