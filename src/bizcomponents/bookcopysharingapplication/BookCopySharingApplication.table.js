...
const columns = [
  ...
  { title: '书副本数量', debugtype: 'string', dataIndex: 'bookCopyQuantity',},
  ...
  { title: '提供的方法', debugtype: 'string', dataIndex: 'deliverMethod',},
  { title: '目的地存储', dataIndex: 'destinationStore', render: (text, record) => (record.destinationStore ? record.destinationStore.displayName : '暂无') },
  { title: '联系地址', debugtype: 'string', dataIndex: 'contactAddress',},
  { title: '联系人姓名', debugtype: 'string', dataIndex: 'contactName',},
  { title: '联系手机', debugtype: 'string_china_mobile_phone', dataIndex: 'contactMobile',},
