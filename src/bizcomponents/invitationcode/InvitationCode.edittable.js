...
class InvitationCodeEditTable extends PureComponent {
  ...
  { title: '代码', debugtype: 'int', dataIndex: 'code', width: '10', render: (text, record) => renderStringEdit('code',text, record)  },
...
{ title: '操作',
   render: (text, record) => renderActions(text, record)}]
    ...
    const newRecord =()=>{
      const newInvitationCodeToAppend  = {
      	'id':`+1`, 
				'name':'',
				'code':'',
				'createTime':'',
      ...
      newData.push(newInvitationCodeToAppend);
