...
export default class InvitationCodeSearchForm extends PureComponent {
    ...
    buildStringSearchParameters=(formValues,fieldName)=>{
        ...
        return {invitationCodeList:1,
            "invitationCodeList.searchField":fieldName,
            "invitationCodeList.searchVerb":"startsWith",
   ...
   handleSearch = (e) => {
        ...
        form.validateFields((err, fieldsValue) => {
          ...
          if(fieldsValue.id){
            searchByIdParameters={invitationCodeList:1,
                "invitationCodeList.searchField":"id",
                "invitationCodeList.searchVerb":"startsWith",
                "invitationCodeList.searchValue":fieldsValue.id,};
