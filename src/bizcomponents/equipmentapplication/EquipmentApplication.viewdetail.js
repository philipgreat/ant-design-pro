...
import styles from './EquipmentApplication.viewdetail.less'
...
export default class EquipmentApplicationViewDetail extends Component {
  ...
  render() {
    ...
    const equipmentApplication = this.props.equipmentApplication
    const { id,  } = equipmentApplication
