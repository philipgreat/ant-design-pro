...
import styles from './CarReceiveWorking.table.less';
...
class CarReceiveWorkingConfirmationTable extends PureComponent {
  render() {
...
export default CarReceiveWorkingConfirmationTable;
