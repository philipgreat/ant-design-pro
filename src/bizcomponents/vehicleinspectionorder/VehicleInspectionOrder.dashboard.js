...
const summaryOf = vehicleInspectionOrder => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="车辆行驶证号码">
        {vehicleInspectionOrder.vehiclePermitNumber}
      </Description>
      <Description term="行驶证有效期">
        {moment(vehicleInspectionOrder.vehiclePermitExpirationDate).format(
          'YYYY-MM-DD'
        )}
      </Description>
      <Description term="图1">
