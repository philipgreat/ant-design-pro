...
<Description term="行驶证图1"><ImagePreview imageTitle="行驶证图1" imageLocation={vehicleInspectionOrder.vehiclePermitImage1}/></Description> 
<Description term="行驶证图2"><ImagePreview imageTitle="行驶证图2" imageLocation={vehicleInspectionOrder.vehiclePermitImage2}/></Description> 
<Description term="行驶证图3"><ImagePreview imageTitle="行驶证图3" imageLocation={vehicleInspectionOrder.vehiclePermitImage3}/></Description> 
<Description term="行驶证图4"><ImagePreview imageTitle="行驶证图4" imageLocation={vehicleInspectionOrder.vehiclePermitImage4}/></Description> 
<Description term="行驶证图5"><ImagePreview imageTitle="行驶证图5" imageLocation={vehicleInspectionOrder.vehiclePermitImage5}/></Description> 
