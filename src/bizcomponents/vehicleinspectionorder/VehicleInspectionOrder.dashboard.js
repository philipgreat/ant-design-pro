...
const summaryOf = vehicleInspectionOrder => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="图1">
        {vehicleInspectionOrder.vehiclePermitImage1}
      </Description>
      <Description term="图2">
        {vehicleInspectionOrder.vehiclePermitImage2}
      </Description>
      <Description term="图3">
        {vehicleInspectionOrder.vehiclePermitImage3}
      </Description>
      <Description term="图4">
        {vehicleInspectionOrder.vehiclePermitImage4}
      </Description>
      <Description term="图5">
        {vehicleInspectionOrder.vehiclePermitImage5}
      </Description>
          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                title="车辆检测保险服务订单"
                action={
                  <Tooltip title="车辆检测保险服务订单">
                    <Icon type="info-circle-o" />
                  </Tooltip>
                }
                total={numeral(vehicleInspectionInsuranceOrderCount).format(
                  '0,0'
                )}
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionInsuranceOrderList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionInsuranceOrderCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderServiceLogList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderServiceLogCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                title="订单支付管理"
                action={
                  <Tooltip title="订单支付管理">
                    <Icon type="info-circle-o" />
                  </Tooltip>
                }
                total={numeral(vehicleInspectionOrderPaymentCount).format(
                  '0,0'
                )}
                footer={<Field label="状态" value="良好" />}
                contentHeight={46}
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderPaymentList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderPaymentCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/handOverChecklistItemList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/handOverChecklistItemCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementC2mList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementC2mCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementM2mList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementM2mCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementM2cList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleMovementM2cCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementC2mList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementC2mCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementM2mList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementM2mCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementM2cList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileMovementM2cCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceInsuranceForInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceInsuranceForInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceFileInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                title="车辆检验报告"
                action={
                  <Tooltip title="车辆检验报告">
                    <Icon type="info-circle-o" />
                  </Tooltip>
                }
                total={numeral(reportVehicleInspectionReportCount).format(
                  '0,0'
                )}
                footer={<Field label="状态" value="良好" />}
                contentHeight={46}
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/reportVehicleInspectionReportList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/reportVehicleInspectionReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/reportFileInspectionReportList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/reportFileInspectionReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleRepairingList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/serviceVehicleRepairingCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleRepairingReportList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleRepairingReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderReviewResultList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderReviewResultCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderRatingResultList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderRatingResultCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderDiscountCouponList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/orderDiscountCouponCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderCouponList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderCouponCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
