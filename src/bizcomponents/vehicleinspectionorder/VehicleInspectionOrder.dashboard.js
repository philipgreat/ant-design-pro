...
<Description term="计划检查日期">{ moment(vehicleInspectionOrder.planInspectionDate).format('YYYY-MM-DD')}</Description> 
<Description term="交通事故公告">{vehicleInspectionOrder.trafficAccidentAnnouncement?'是':'否'}</Description> 
<Description term="家里收拾">{vehicleInspectionOrder.homePickUp?'是':'否'}</Description> 
