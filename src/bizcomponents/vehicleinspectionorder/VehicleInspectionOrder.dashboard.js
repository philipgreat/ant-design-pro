...
const summaryOf = vehicleInspectionOrder => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="免除代理费用">
        {vehicleInspectionOrder.exemptProxyFee ? '是' : '否'}
      </Description>
        ...
        <div>
          <Row gutter={24}>
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderChargeList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/vehicleInspectionOrder/${id}/list/vehicleInspectionOrderChargeCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
