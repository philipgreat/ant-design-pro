...
export default class VehicleInspectionOrderViewDetail extends Component {
  ...
  render() {
    ...
    const tabList = [
      {
        key: 'vehicleInspectionInsuranceOrderList',
        tab: `车辆检测保险服务订单(${vehicleInspectionInsuranceOrderCount})`,
      },
      {
      ...
      {
        key: 'vehicleInspectionOrderPaymentList',
        tab: `订单支付管理(${vehicleInspectionOrderPaymentCount})`,
      },
      {
      ...
      {
        key: 'reportFileInspectionReportList',
        tab: `报告文件检验报告(${reportFileInspectionReportCount})`,
      },
      {
      ...
      {
        key: 'vehicleRepairingReportList',
        tab: `车辆维修报告(${vehicleRepairingReportCount})`,
      },
      {
        key: 'orderReviewResultList',
        tab: `订单评论结果(${orderReviewResultCount})`,
      },
      {
        key: 'orderRatingResultList',
        tab: `订单评级结果(${orderRatingResultCount})`,
      },
      {
        key: 'orderDiscountCouponList',
        tab: `订单的折扣券(${orderDiscountCouponCount})`,
      },
      {
        key: 'vehicleInspectionOrderCouponList',
        tab: `优惠券(${vehicleInspectionOrderCouponCount})`,
      },
    ]
