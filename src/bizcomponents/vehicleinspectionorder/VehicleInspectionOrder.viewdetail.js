    ...
    const tabList = [
      {
        ...
        tab: `车辆上线检测保险订单(${vehicleInspectionInsuranceOrderCount})`,
      },
      {
        key: 'vehicleInspectionOrderChargeList',
        tab: `车辆检验订单费用(${vehicleInspectionOrderChargeCount})`,
      },
      {
      ...
      },
      {
        ...
        tab: `年检订单支付(${vehicleInspectionOrderPaymentCount})`,
      },
      {
        key: 'handOverChecklistItemList',
        tab: `交接检查项(${handOverChecklistItemCount})`,
      },
      {
      ...
      },
      {
        ...
        tab: `订单评分结果(${orderRatingResultCount})`,
      },
      {
        key: 'orderDiscountCouponList',
        tab: `优惠券(${orderDiscountCouponCount})`,
      },
      {
        key: 'vehicleInspectionOrderCouponList',
        tab: `优惠券使用记录(${vehicleInspectionOrderCouponCount})`,
      },
    ]
