...
class VehicleInspectionOrderEditTable extends PureComponent {
  ...
  { title: '核准座位数', debugtype: 'int', dataIndex: 'vehicleSeatsQuantity', width: '5', render: (text, record) => renderStringEdit('vehicleSeatsQuantity',text, record)  },
  ...
  { title: '车辆行驶证号码', debugtype: 'string', dataIndex: 'vehiclePermitNumber', width: '20', render: (text, record) => renderStringEdit('vehiclePermitNumber',text, record)  },
