  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: '8',
        render: (text, record) => renderStringEdit('productType', text, record),
      },
      {
        title: '6年免检',
      ...
      },
      {
        ...
        render: (text, record) =>
          record.hasSecondLevelMaintenance ? '是' : '否',
      },
      {
        title: '等级评定',
      ...
      },
      {
        ...
        width: '10',
        render: (text, record) =>
          renderStringEdit('serviceCompanyInfo', text, record),
      },
      {
        title: '地址',
        debugtype: 'string',
      ...
      },
      {
        ...
        render: (text, record) =>
          record.engagementLetterProvided ? '是' : '否',
      },
      {
        title: '上门取车',
