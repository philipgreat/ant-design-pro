...
class VehicleInspectionOrderEditTable extends PureComponent {
  ...
  render() {
    ...
    const remapReference = record => {
      ...
      return { customerId, contactAddressCityId, platformId }
    }
    ...
    const columns = [
      { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        width: '7',
        render: (text, record) => renderStringEdit('orderStatus', text, record),
      },
      {
        title: '客户',
        dataIndex: 'customer',
      ...
      },
      {
        ...
        width: '19',
        render: (text, record) =>
          renderStringEdit('contactAddressDetail', text, record),
      },
      {
        title: '车牌号码',
        debugtype: 'string',
      ...
      },
      {
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('vehicleUseCharacter', text, record),
      },
      {
        title: '核准座位数',
        debugtype: 'int',
        ...
        width: '5',
        render: (text, record) =>
          renderStringEdit('vehicleSeatsQuantity', text, record),
      },
      {
        title: '注册日期',
      ...
      },
      {
        ...
        width: '11',
        render: (text, record) =>
          renderStringEdit('engineNumber', text, record),
      },
      {
        title: '车架号',
        debugtype: 'string',
        ...
        width: '21',
        render: (text, record) =>
          renderStringEdit('vehicleIdentificationNumber', text, record),
      },
      {
        title: '发证日期',
      ...
      },
      {
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('vehiclePermitHolderName', text, record),
      },
      {
        title: '车辆行驶证号码',
        debugtype: 'string',
        dataIndex: 'vehiclePermitNumber',
        width: '20',
        render: (text, record) =>
          renderStringEdit('vehiclePermitNumber', text, record),
      },
      {
        title: '行驶证有效期',
        dataIndex: 'vehiclePermitExpirationDate',
        render: (text, record) =>
          moment(record.vehiclePermitExpirationDate).format('YYYY-MM-DD'),
      },
      {
        title: '图1',
