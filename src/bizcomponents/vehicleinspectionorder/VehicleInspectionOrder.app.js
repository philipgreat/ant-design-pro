  ...
  getVehicleInspectionInsuranceOrderSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._vehicleInspectionOrder,
        listDisplayName: '车辆上线检测保险订单列表',
