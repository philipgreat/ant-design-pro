...
class VehicleInspectionOrderBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderChargeList`}
          >
            车辆检验订单费用
          </Link>
        </Menu.Item>
  ...
  getVehicleInspectionOrderChargeSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderChargeCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderChargeSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'vehicleInspectionOrderChargeList',
      }, // this is for model namespace and
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderChargeList"
                component={this.getVehicleInspectionOrderChargeSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderChargeCreateForm"
                component={this.getVehicleInspectionOrderChargeCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderChargeUpdateForm"
                component={this.getVehicleInspectionOrderChargeUpdateForm()}
              />
