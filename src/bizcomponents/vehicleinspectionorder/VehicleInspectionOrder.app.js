...
class VehicleInspectionOrderBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionInsuranceOrderList`}
          >
            车辆检测保险服务订单
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderServiceLogList`}
          >
            车辆检测服务订单日志
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderPaymentList`}
          >
            订单支付管理
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/handOverChecklistItemList`}
          >
            移交清单项目
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleMovementC2mList`}
          >
            收车服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleMovementM2mList`}
          >
            移车服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleMovementM2cList`}
          >
            还车服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceFileMovementC2mList`}
          >
            收件服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceFileMovementM2mList`}
          >
            移件服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceFileMovementM2cList`}
          >
            还件服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceInsuranceForInspectionList`}
          >
            保险增值服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleInspectionList`}
          >
            车辆上线检测
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceFileInspectionList`}
          >
            6年免检服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/reportVehicleInspectionReportList`}
          >
            车辆检验报告
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/reportFileInspectionReportList`}
          >
            报告文件检验报告
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleRepairingList`}
          >
            修车服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleRepairingReportList`}
          >
            车辆维修报告
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/orderReviewResultList`}
          >
            订单评论结果
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/orderRatingResultList`}
          >
            订单评级结果
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/orderDiscountCouponList`}
          >
            订单的折扣券
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderCouponList`}
          >
            优惠券
          </Link>
        </Menu.Item>
  ...
  getVehicleInspectionInsuranceOrderSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
  ...
  getVehicleInspectionOrderServiceLogSearch = () => {
    ...
    return connect(state => ({
      ...
      count:
        state._vehicleInspectionOrder.vehicleInspectionOrderServiceLogCount,
      currentPage:
        state._vehicleInspectionOrder
  ...
  getVehicleInspectionOrderPaymentSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderPaymentCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderPaymentSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'vehicleInspectionOrderPaymentList',
      }, // this is for model namespace and
  ...
  getHandOverChecklistItemSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.handOverChecklistItemCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder.handOverChecklistItemSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'handOverChecklistItemList',
      }, // this is for model namespace and
  ...
  getServiceVehicleMovementM2mSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder
          .serviceVehicleMovementM2mCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getServiceFileMovementC2mSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceFileMovementC2mCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getServiceFileMovementM2mSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceFileMovementM2mCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
          .serviceFileMovementM2mSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
  ...
  getServiceFileMovementM2cSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceFileMovementM2cCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getServiceVehicleInspectionSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceVehicleInspectionCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getServiceFileInspectionSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceFileInspectionCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder.serviceFileInspectionSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
  ...
  getReportFileInspectionReportSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder
          .reportFileInspectionReportCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
          .reportFileInspectionReportSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'reportFileInspectionReportList',
      }, // this is for model namespace and
  ...
  getServiceVehicleRepairingSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.serviceVehicleRepairingCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getVehicleRepairingReportSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.vehicleRepairingReportCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
  ...
  getOrderReviewResultSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.orderReviewResultCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder.orderReviewResultSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'orderReviewResultList',
      }, // this is for model namespace and
  ...
  getOrderRatingResultSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.orderRatingResultCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder.orderRatingResultSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
        listName: 'orderRatingResultList',
      }, // this is for model namespace and
  ...
  getOrderDiscountCouponSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder.orderDiscountCouponCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder.orderDiscountCouponSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
  ...
  getVehicleInspectionOrderCouponSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderCouponCurrentPageNumber,
      searchFormParameters:
        state._vehicleInspectionOrder
          .vehicleInspectionOrderCouponSearchFormParameters,
      loading: state._vehicleInspectionOrder.loading,
      owner: {
        type: '_vehicleInspectionOrder',
        id: state._vehicleInspectionOrder.id,
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/vehicleInspectionOrder/${
                  this.props.vehicleInspectionOrder.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/vehicleInspectionOrder/:id/dashboard"
                component={VehicleInspectionOrderDashboard}
              />
              <Route
                path="/vehicleInspectionOrder/:id/editDetail"
                component={VehicleInspectionOrderEditDetail}
              />
              <Route
                path="/vehicleInspectionOrder/:id/viewDetail"
                component={VehicleInspectionOrderViewDetail}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionInsuranceOrderList"
                component={this.getVehicleInspectionInsuranceOrderSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionInsuranceOrderCreateForm"
                component={this.getVehicleInspectionInsuranceOrderCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionInsuranceOrderUpdateForm"
                component={this.getVehicleInspectionInsuranceOrderUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderServiceLogList"
                component={this.getVehicleInspectionOrderServiceLogSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderServiceLogCreateForm"
                component={this.getVehicleInspectionOrderServiceLogCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderServiceLogUpdateForm"
                component={this.getVehicleInspectionOrderServiceLogUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderPaymentList"
                component={this.getVehicleInspectionOrderPaymentSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderPaymentCreateForm"
                component={this.getVehicleInspectionOrderPaymentCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderPaymentUpdateForm"
                component={this.getVehicleInspectionOrderPaymentUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/handOverChecklistItemList"
                component={this.getHandOverChecklistItemSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/handOverChecklistItemCreateForm"
                component={this.getHandOverChecklistItemCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/handOverChecklistItemUpdateForm"
                component={this.getHandOverChecklistItemUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementC2mList"
                component={this.getServiceVehicleMovementC2mSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementC2mCreateForm"
                component={this.getServiceVehicleMovementC2mCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementC2mUpdateForm"
                component={this.getServiceVehicleMovementC2mUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2mList"
                component={this.getServiceVehicleMovementM2mSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2mCreateForm"
                component={this.getServiceVehicleMovementM2mCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2mUpdateForm"
                component={this.getServiceVehicleMovementM2mUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2cList"
                component={this.getServiceVehicleMovementM2cSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2cCreateForm"
                component={this.getServiceVehicleMovementM2cCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleMovementM2cUpdateForm"
                component={this.getServiceVehicleMovementM2cUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementC2mList"
                component={this.getServiceFileMovementC2mSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementC2mCreateForm"
                component={this.getServiceFileMovementC2mCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementC2mUpdateForm"
                component={this.getServiceFileMovementC2mUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2mList"
                component={this.getServiceFileMovementM2mSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2mCreateForm"
                component={this.getServiceFileMovementM2mCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2mUpdateForm"
                component={this.getServiceFileMovementM2mUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2cList"
                component={this.getServiceFileMovementM2cSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2cCreateForm"
                component={this.getServiceFileMovementM2cCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileMovementM2cUpdateForm"
                component={this.getServiceFileMovementM2cUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceInsuranceForInspectionList"
                component={this.getServiceInsuranceForInspectionSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceInsuranceForInspectionCreateForm"
                component={this.getServiceInsuranceForInspectionCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceInsuranceForInspectionUpdateForm"
                component={this.getServiceInsuranceForInspectionUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleInspectionList"
                component={this.getServiceVehicleInspectionSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleInspectionCreateForm"
                component={this.getServiceVehicleInspectionCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleInspectionUpdateForm"
                component={this.getServiceVehicleInspectionUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileInspectionList"
                component={this.getServiceFileInspectionSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileInspectionCreateForm"
                component={this.getServiceFileInspectionCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceFileInspectionUpdateForm"
                component={this.getServiceFileInspectionUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/reportVehicleInspectionReportList"
                component={this.getReportVehicleInspectionReportSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/reportVehicleInspectionReportCreateForm"
                component={this.getReportVehicleInspectionReportCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/reportVehicleInspectionReportUpdateForm"
                component={this.getReportVehicleInspectionReportUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/reportFileInspectionReportList"
                component={this.getReportFileInspectionReportSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/reportFileInspectionReportCreateForm"
                component={this.getReportFileInspectionReportCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/reportFileInspectionReportUpdateForm"
                component={this.getReportFileInspectionReportUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleRepairingList"
                component={this.getServiceVehicleRepairingSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleRepairingCreateForm"
                component={this.getServiceVehicleRepairingCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/serviceVehicleRepairingUpdateForm"
                component={this.getServiceVehicleRepairingUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleRepairingReportList"
                component={this.getVehicleRepairingReportSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleRepairingReportCreateForm"
                component={this.getVehicleRepairingReportCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleRepairingReportUpdateForm"
                component={this.getVehicleRepairingReportUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/orderReviewResultList"
                component={this.getOrderReviewResultSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderReviewResultCreateForm"
                component={this.getOrderReviewResultCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderReviewResultUpdateForm"
                component={this.getOrderReviewResultUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/orderRatingResultList"
                component={this.getOrderRatingResultSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderRatingResultCreateForm"
                component={this.getOrderRatingResultCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderRatingResultUpdateForm"
                component={this.getOrderRatingResultUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/orderDiscountCouponList"
                component={this.getOrderDiscountCouponSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderDiscountCouponCreateForm"
                component={this.getOrderDiscountCouponCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/orderDiscountCouponUpdateForm"
                component={this.getOrderDiscountCouponUpdateForm()}
              />

              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderCouponList"
                component={this.getVehicleInspectionOrderCouponSearch()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderCouponCreateForm"
                component={this.getVehicleInspectionOrderCouponCreateForm()}
              />
              <Route
                path="/vehicleInspectionOrder/:id/list/vehicleInspectionOrderCouponUpdateForm"
