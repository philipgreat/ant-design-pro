...
class VehicleInspectionOrderBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionInsuranceOrderList`}>车辆上线检测保险订单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderChargeList`}>车辆检验订单费用</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderServiceLogList`}>年检订单执行日志</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderPaymentList`}>年检订单支付</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/handOverChecklistItemList`}>交接检查项</Link>
        </Menu.Item>
        <Menu.Item>
        ...
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/serviceInsuranceForInspectionList`}>保险服务</Link>
        </Menu.Item>
        <Menu.Item>
        ...
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/serviceVehicleRepairingList`}>维修服务</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/orderReviewResultList`}>订单评论结果</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/orderRatingResultList`}>订单评分结果</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/orderDiscountCouponList`}>优惠券</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleInspectionOrder/${objectId}/list/vehicleInspectionOrderCouponList`}>优惠券使用记录</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
  ...
  getVehicleInspectionOrderChargeSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._vehicleInspectionOrder.loading,
      owner: { type: '_vehicleInspectionOrder', id: state._vehicleInspectionOrder.id, listName: 'vehicleInspectionOrderChargeList' }, // this is for model namespace and
