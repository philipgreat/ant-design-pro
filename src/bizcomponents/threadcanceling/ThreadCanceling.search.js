...
class ThreadCancelingSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleCloseAlert = () => {
      ...
      dispatch({ type: `${owner.type}/view`, payload: { id: owner.id,pathname,displayName:'线程取消列表' } })
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title={`${displayName}: 线程取消列表`}>
        <Card bordered={false}>
...
export default Form.create()(ThreadCancelingSearch)
