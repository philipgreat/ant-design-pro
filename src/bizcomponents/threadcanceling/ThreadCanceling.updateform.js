...
import styles from './ThreadCanceling.updateform.less';
...
class ThreadCancelingUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const threadCancelingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,threadCancelingId, ...imagesValues };
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextThreadCancelingUpdateRow',
            payload: {
              id:owner.id,type:'threadCanceling', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新线程取消"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新线程取消"
...
}))(Form.create()(ThreadCancelingUpdateForm));
