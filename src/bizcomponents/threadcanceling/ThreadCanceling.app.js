...
class ThreadCancelingBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._threadCanceling.partialList,
      owner: { type: '_threadCanceling', id: state._threadCanceling.id, referenceName: 'canceling', listName: 'threadList', ref:state._threadCanceling, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
  ...
  getThreadUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_threadCanceling', id: state._threadCanceling.id, listName: 'threadList', ref:state._threadCanceling, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadUpdateForm)
  }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {ThreadCancelingDashboard} = GlobalComponents
     const {ThreadCancelingEditDetail} = GlobalComponents
     const {ThreadCancelingViewDetail} = GlobalComponents
         ...
         >
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/threadCanceling/${this.props.threadCanceling.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/threadCanceling/:id/editDetail" component={ThreadCancelingEditDetail} />
               <Route path="/threadCanceling/:id/viewDetail" component={ThreadCancelingViewDetail} /> 
