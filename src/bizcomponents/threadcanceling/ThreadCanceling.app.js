...
class ThreadCancelingBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_threadCanceling',
        id: state._threadCanceling.id,
        listName: 'threadList',
      ...
      <Layout>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/threadCanceling/:id/dashboard"
                component={ThreadCancelingDashboard}
              />

              <Route
                path="/threadCanceling/:id/editDetail"
                component={ThreadCancelingEditDetail}
              />
              <Route
                path="/threadCanceling/:id/viewDetail"
                component={ThreadCancelingViewDetail}
              />

              <Route
                path="/threadCanceling/:id/list/threadList"
                component={this.getThreadSearch()}
              />
              <Route
                path="/threadCanceling/:id/list/threadCreateForm"
                component={this.getThreadCreateForm()}
              />
              <Route
                path="/threadCanceling/:id/list/threadUpdateForm"
