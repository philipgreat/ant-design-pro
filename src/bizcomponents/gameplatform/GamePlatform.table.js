...
import styles from './GamePlatform.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/gamePlatform/${text}/dashboard`}>{text}</Link>) },
...
class GamePlatformTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
