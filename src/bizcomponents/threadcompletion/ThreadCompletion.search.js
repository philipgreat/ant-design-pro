...
import {ThreadCompletionTable} from '../../custcomponents';
import {ThreadCompletionConfirmationTable} from '../../custcomponents';

import {ThreadCompletionSearchForm} from '../../custcomponents';
...
export default class ThreadCompletionSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      ...
      threadCompletionListCurrentPage: pagination.current,
