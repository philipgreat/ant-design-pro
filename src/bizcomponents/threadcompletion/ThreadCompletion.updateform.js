...
import styles from './ThreadCompletion.updateform.less';
...
class ThreadCompletionUpdateForm extends PureComponent {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const threadCompletionId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,threadCompletionId, ...imagesValues };
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextThreadCompletionUpdateRow',
            payload: {
              id:owner.id,type:'threadCompletion', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新线程完成"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新线程完成"
...
}))(Form.create()(ThreadCompletionUpdateForm));
