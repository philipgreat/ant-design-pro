...
import styles from './ThreadCompletion.viewdetail.less'
...
export default class ThreadCompletionViewDetail extends Component {
  ...
  render() {
    ...
    const threadCompletion = this.props.threadCompletion
    const { id, threadCount } = threadCompletion
    const { threadList } = threadCompletion
