...
const menuData = {menuName:"线程完成", menuFor: "threadCompletion",
  		subItems: [
...
class ThreadCompletionBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._threadCompletion.partialList,
      owner: { type: '_threadCompletion', id: state._threadCompletion.id, referenceName: 'completion', listName: 'threadList', ref:state._threadCompletion, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
  ...
  getThreadUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_threadCompletion', id: state._threadCompletion.id, listName: 'threadList', ref:state._threadCompletion, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadUpdateForm)
  }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {ThreadCompletionDashboard} = GlobalComponents
     const {ThreadCompletionEditDetail} = GlobalComponents
     const {ThreadCompletionViewDetail} = GlobalComponents
         ...
         >
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/threadCompletion/${this.props.threadCompletion.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/threadCompletion/:id/editDetail" component={ThreadCompletionEditDetail} />
               <Route path="/threadCompletion/:id/viewDetail" component={ThreadCompletionViewDetail} /> 
               ...
               <Route path="/threadCompletion/:id/list/threadUpdateForm" component={this.getThreadUpdateForm()} />
