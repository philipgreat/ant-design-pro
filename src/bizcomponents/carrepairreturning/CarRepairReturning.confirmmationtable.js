...
import styles from './CarRepairReturning.table.less';
...
class CarRepairReturningConfirmationTable extends PureComponent {
  render() {
...
export default CarRepairReturningConfirmationTable;
