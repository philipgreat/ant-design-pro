...
import styles from './CarRepairReturning.updateform.less';
...
class CarRepairReturningUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carRepairReturningId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carRepairReturningId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarRepairReturning',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarRepairReturningUpdateRow',
            payload: {
              id:owner.id,type:'carRepairReturning', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车维修返回"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车维修返回"
...
}))(Form.create()(CarRepairReturningUpdateForm));
