...
<Description term="原始金额">{vehicleInspectionOrderPayment.originalAmount}</Description> 
<Description term="实际的数量">{vehicleInspectionOrderPayment.actualAmount}</Description> 
...
<Description term="微信提前支付Id">{vehicleInspectionOrderPayment.wechatPrepayId}</Description> 
...
export default class VehicleInspectionOrderPaymentViewDetail extends Component {
  ...
  render() {
    ...
    const vehicleInspectionOrderPayment = this.props.vehicleInspectionOrderPayment
