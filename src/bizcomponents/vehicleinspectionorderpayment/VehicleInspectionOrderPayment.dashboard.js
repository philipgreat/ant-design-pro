...
const imageListOf = (vehicleInspectionOrderPayment) =>{
...
const settingListOf = (vehicleInspectionOrderPayment) =>{
...
const largeTextOf = (vehicleInspectionOrderPayment) =>{
...
class VehicleInspectionOrderPaymentDashboard extends Component {
