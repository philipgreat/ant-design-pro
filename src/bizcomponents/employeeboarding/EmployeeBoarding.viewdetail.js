...
import styles from './EmployeeBoarding.viewdetail.less'
...
export default class EmployeeBoardingViewDetail extends Component {
  ...
  render() {
    ...
    const { id, employeeCount } = employeeBoarding
    const { employeeList } = employeeBoarding
