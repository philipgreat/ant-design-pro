...
import styles from './EquipmentSupplier.search.less'
...
@Form.create()
export default class EquipmentSupplierSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleDelete = () => {
    ...
    const equipmentSupplierIds = selectedRows.map((item) => { return item.id })
    console.log('equipmentSupplierIds', equipmentSupplierIds)
  ...
  handleCreate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'equipmentSupplier' },
    })
  }
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'equipmentSupplier', selectedRows, currentUpdateIndex },
    })
  }
  ...
  render() {
    ...
    const {EquipmentSupplierTable} = GlobalComponents;
    const {EquipmentSupplierConfirmationTable} = GlobalComponents;
    const {EquipmentSupplierSearchForm} = GlobalComponents;
    ...
    const modalContent = (data, owner) => {
      ...
      return (
        <Modal
          ...
          style={{ top: 40 }}
        >
          <EquipmentSupplierConfirmationTable data={selectedRows} owner={owner} />
        </Modal>)
    }
    
    return (
      <PageHeaderLayout title="设备供应商列表">
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <EquipmentSupplierSearchForm {...this.props} />
            </div>
