...
const addProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}availableProductManager/addProductPrice/productId/cityId/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/discountAgentServicePrice/description/tokensExpr/`
  const requestParameters = { ...parameters, tokensExpr: 'none' }
...
const updateProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}availableProductManager/updateProductPriceProperties/availableProductId/id/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/discountAgentServicePrice/description/tokensExpr/`
  const availableProductId = targetObjectId
  const requestParameters = {
    ...parameters,
    availableProductId,
