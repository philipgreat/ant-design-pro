...
export default class AvailableProductEditDetail extends Component {
  render() {
    ...
    const { servicePriceList, availableServiceList, productPriceList, availableInsuranceList, availableHandOverItemList, preorderPromotionList } = this.props.availableProduct
