...
class ServiceFileMovementC2mChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceFileMovementC2mChecklistResultConfirmationTable
