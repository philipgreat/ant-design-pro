...
import styles from './ServiceFileMovementC2mChecklistResult.createform.less'
...
const testValues = {
  ...
  createTime: '2995-03-04',
  serviceId: 'SFMC000001',
}
...
class ServiceFileMovementC2mChecklistResultCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addServiceFileMovementC2mChecklistResult`,
          payload: { id: owner.id, type: 'serviceFileMovementC2mChecklistResult', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ServiceFileMovementC2mChecklistResultCreateForm))
