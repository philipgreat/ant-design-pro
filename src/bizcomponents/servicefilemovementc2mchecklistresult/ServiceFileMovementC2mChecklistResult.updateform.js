...
import styles from './ServiceFileMovementC2mChecklistResult.updateform.less'
...
class ServiceFileMovementC2mChecklistResultUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const serviceFileMovementC2mChecklistResultId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, serviceFileMovementC2mChecklistResultId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextServiceFileMovementC2mChecklistResultUpdateRow`,
        payload: {
          id: owner.id,
          type: 'serviceFileMovementC2mChecklistResult',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新收件服务检查结果"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新收件服务检查结果"
...
}))(Form.create()(ServiceFileMovementC2mChecklistResultUpdateForm))
