...
const columns = [
  ...
  { title: '服务', dataIndex: 'service', render: (text, record) => (record.service ? (<Link to={`/serviceFileMovementC2m/${record.service.id}/dashboard`}>{record.service.id}</Link>) : '暂无') },
...
class ServiceFileMovementC2mChecklistResultTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default ServiceFileMovementC2mChecklistResultTable
