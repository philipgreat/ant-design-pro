...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/bookManagement/${text}/dashboard`}>{text}</Link>) },
  { title: '书管理的名字', debugtype: 'string', dataIndex: 'bookManagementName',},
...
class BookManagementTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
