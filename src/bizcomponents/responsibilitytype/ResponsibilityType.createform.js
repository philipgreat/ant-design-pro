...
class ResponsibilityTypeCreateForm extends Component {
  ...
  executeCandidateCompanySearch = (filterKey) =>{
    ...
    const pageNo = 1;
    const future = ResponsibilityTypeService.requestCandidateCompany("decorationCountryCenter", id, filterKey, pageNo);
    console.log(future);
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.baseDescription}>
                  {getFieldDecorator('baseDescription', {
                    rules: [{ required: true, message: '请输入基本描述' }],
                  })(
                    <Input placeholder="请输入请输入基本描述string" />
                  )}
                </Form.Item>
              </Col>

              <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.detailDescription}>
                  {getFieldDecorator('detailDescription', {
                    rules: [{ required: true, message: '请输入详细描述' }],
                  })(
                    <Input placeholder="请输入请输入详细描述string" />
                  )}
                </Form.Item>
              </Col>
