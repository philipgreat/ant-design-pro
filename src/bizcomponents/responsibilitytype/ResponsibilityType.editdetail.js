...
import styles from './ResponsibilityType.editdetail.less'
...
export default class ResponsibilityTypeEditDetail extends Component {
  render() {
    const {EmployeeEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, employeeCount } = this.props.responsibilityType
    const { employeeList } = this.props.responsibilityType
