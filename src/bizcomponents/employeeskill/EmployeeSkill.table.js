...
const columns = [
  ...
  { title: '技能类型', dataIndex: 'skillType', render: (text, record) => (record.skillType ? (<Link to={`/skillType/${record.skillType.id}/dashboard`}>{record.skillType.displayName}</Link>) : '暂无') },
