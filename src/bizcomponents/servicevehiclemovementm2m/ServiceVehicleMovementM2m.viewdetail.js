...
<Description term="通知的评论">{serviceVehicleMovementM2m.notifyComment}</Description> 
<Description term="交接检查结果">{serviceVehicleMovementM2m.handoverResult}</Description> 
<Description term="交接检查备注">{serviceVehicleMovementM2m.handoverResultComment}</Description> 
