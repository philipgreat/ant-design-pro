...
class ServiceVehicleMovementM2mEditTable extends PureComponent {
  ...
  { title: '拒收原因', debugtype: 'string', dataIndex: 'rejectComments', width: '37', render: (text, record) => renderStringEdit('rejectComments',text, record)  },
  ...
  { title: '移动目的', debugtype: 'string', dataIndex: 'movementPurpose', width: '6', render: (text, record) => renderStringEdit('movementPurpose',text, record)  },
