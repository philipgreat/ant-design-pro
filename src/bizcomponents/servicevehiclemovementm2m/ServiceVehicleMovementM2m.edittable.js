...
class ServiceVehicleMovementM2mEditTable extends PureComponent {
  ...
  render() {
    ...
    const remapReference = record => {
      ...
      return { responsibleWorkerId, mainOrderId, driverId, receiverId }
    }
    ...
    const columns = [
      ...
      },
      {
        ...
        width: '37',
        render: (text, record) =>
          renderStringEdit('rejectComments', text, record),
      },
      {
        title: '拒收凭证1',
        dataIndex: 'rejectEvidence1',
        render: (text, record) => (
          <ImagePreview imageLocation={record.拒收凭证1} />
        ),
      },
      {
        title: '拒收凭证2',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.拒收凭证2} />
        ),
      },
      {
        title: '拒收凭证3',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.拒收凭证3} />
        ),
      },
      {
        title: '拒收凭证4',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.拒收凭证4} />
        ),
      },
      {
        title: '拒收凭证5',
        ...
        render: (text, record) => (
          <ImagePreview imageLocation={record.拒收凭证5} />
        ),
      },
      {
        title: '开始时间',
      ...
      },
      {
        ...
        width: '17',
        render: (text, record) =>
          renderStringEdit('lastLocation', text, record),
      },
      {
        title: '最后更新时间',
      ...
      },
      {
        title: '司机',
        dataIndex: 'driver',
        render: (text, record) => (record.driver ? record.driver.id : '暂无'),
      },
      {
        title: '接收方',
        dataIndex: 'receiver',
