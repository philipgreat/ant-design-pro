...
class ServiceVehicleMovementM2mBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/serviceVehicleMovementM2m/${objectId}/list/serviceVehicleMovementM2mChecklistResultList`}
          >
            移车服务检查结果
          </Link>
        </Menu.Item>
  ...
  getServiceVehicleMovementM2mChecklistResultSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._serviceVehicleMovementM2m
          .serviceVehicleMovementM2mChecklistResultCurrentPageNumber,
      searchFormParameters:
        state._serviceVehicleMovementM2m
          .serviceVehicleMovementM2mChecklistResultSearchFormParameters,
      loading: state._serviceVehicleMovementM2m.loading,
      owner: {
        type: '_serviceVehicleMovementM2m',
        id: state._serviceVehicleMovementM2m.id,
        listName: 'serviceVehicleMovementM2mChecklistResultList',
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/serviceVehicleMovementM2m/:id/list/serviceVehicleMovementM2mChecklistResultList"
                component={this.getServiceVehicleMovementM2mChecklistResultSearch()}
              />
              <Route
                path="/serviceVehicleMovementM2m/:id/list/serviceVehicleMovementM2mChecklistResultCreateForm"
                component={this.getServiceVehicleMovementM2mChecklistResultCreateForm()}
              />
              <Route
                path="/serviceVehicleMovementM2m/:id/list/serviceVehicleMovementM2mChecklistResultUpdateForm"
                component={this.getServiceVehicleMovementM2mChecklistResultUpdateForm()}
              />
            </Switch>
          </Content>
        </Layout>
