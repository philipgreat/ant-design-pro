...
const columns = [
  ...
  { title: '发送方', dataIndex: 'driver', render: (text, record) => (record.driver ? (<Link to={`/vehicleServiceCompanyEmployee/${record.driver.id}/dashboard`}>{record.driver.displayName}</Link>) : '暂无') },
