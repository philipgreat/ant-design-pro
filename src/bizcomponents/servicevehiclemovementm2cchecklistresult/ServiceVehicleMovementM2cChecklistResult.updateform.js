...
import styles from './ServiceVehicleMovementM2cChecklistResult.updateform.less'
...
class ServiceVehicleMovementM2cChecklistResultUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const serviceVehicleMovementM2cChecklistResultId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, serviceVehicleMovementM2cChecklistResultId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextServiceVehicleMovementM2cChecklistResultUpdateRow`,
        payload: {
          id: owner.id,
          type: 'serviceVehicleMovementM2cChecklistResult',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新还车服务检查结果"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新还车服务检查结果"
...
}))(Form.create()(ServiceVehicleMovementM2cChecklistResultUpdateForm))
