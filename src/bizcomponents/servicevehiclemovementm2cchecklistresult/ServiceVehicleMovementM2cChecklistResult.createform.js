...
import styles from './ServiceVehicleMovementM2cChecklistResult.createform.less'
...
const testValues = {
  ...
  createTime: '2997-04-26',
  serviceId: 'SVMM000001',
}
...
class ServiceVehicleMovementM2cChecklistResultCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addServiceVehicleMovementM2cChecklistResult`,
          payload: { id: owner.id, type: 'serviceVehicleMovementM2cChecklistResult', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ServiceVehicleMovementM2cChecklistResultCreateForm))
