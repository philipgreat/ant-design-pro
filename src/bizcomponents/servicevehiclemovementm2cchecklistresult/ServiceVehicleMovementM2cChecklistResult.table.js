...
import styles from './ServiceVehicleMovementM2cChecklistResult.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20' },
  { title: '服务', dataIndex: 'service', render: (text, record) => (record.service ? (<Link to={`/serviceVehicleMovementM2c/${record.service.id}/dashboard`}>{record.service.id}</Link>) : '暂无') },
...
class ServiceVehicleMovementM2cChecklistResultTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default ServiceVehicleMovementM2cChecklistResultTable
