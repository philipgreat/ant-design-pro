...
class ServiceVehicleMovementM2cChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceVehicleMovementM2cChecklistResultConfirmationTable
