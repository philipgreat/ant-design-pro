...
class ServiceVehicleMovementM2cChecklistResultBizApp extends React.PureComponent {
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {ServiceVehicleMovementM2cChecklistResultDashboard} = GlobalComponents
     const {ServiceVehicleMovementM2cChecklistResultEditDetail} = GlobalComponents
     const {ServiceVehicleMovementM2cChecklistResultViewDetail} = GlobalComponents
       ...
       <Layout>
         ...
         >
           <div className={styles.logo}>
             ...
             <Link to="/home"> <h1>还车服务检查结果</h1></Link>
           </div>
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/serviceVehicleMovementM2cChecklistResult/${this.props.serviceVehicleMovementM2cChecklistResult.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
             <Menu.Item >
