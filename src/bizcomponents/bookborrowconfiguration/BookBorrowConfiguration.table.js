...
const columns = [
  ...
  { title: '最大允许数', debugtype: 'int', dataIndex: 'maximumAllowedNumber',},
  ...
  { title: '贷款计算频率', debugtype: 'int', dataIndex: 'lendingComputeFrequency',},
  { title: '图书管理', dataIndex: 'bookManagement', render: (text, record) => (record.bookManagement ? record.bookManagement.displayName : '暂无') },


]

class BookBorrowConfigurationTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookBorrowConfigurationTable
