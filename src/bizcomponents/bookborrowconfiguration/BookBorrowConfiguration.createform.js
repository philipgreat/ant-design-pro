          ...
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.maxBorrowQuantity} {...formItemLayout}>
                  {getFieldDecorator('maxBorrowQuantity', {
                    rules: [{ required: true, message: '请输入马克斯借数量' }],
                  })(
                    <Input placeholder="请输入马克斯借数量" />
                  )}
                </Form.Item>
              </Col>
