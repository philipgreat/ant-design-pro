...
const settingListOf = (taskReward) =>{
...
class TaskRewardDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, taskReward } = this.props;
    
    if(!taskReward){
    	return;
    }
    const {displayName} = taskReward;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName, taskCount } = this.props.taskReward
    const cardsData = {cardsName:"任务悬赏",cardsFor: "taskReward",cardsSource: this.props.taskReward,
  		subItems: [
