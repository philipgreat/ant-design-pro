 ...
 constructor(props) {
  ...
  getCarInspectionServiceOrderUpdateForm() {
    ...
    return connect(state => ({
      ...
      selectedRows: state._carInspectWorking.selectedRows,
      currentUpdateIndex: state._carInspectWorking.currentUpdateIndex,
      owner: {type:'_carInspectWorking',id:state._carInspectWorking.id}//this is for model namespace and 
    ...
    const layout = (
      <Layout>
        ...
        <Layout>
          ...
          <Route path="/carInspectWorking/:id/list/carInspectionServiceOrderUpdateForm" component={this.getCarInspectionServiceOrderUpdateForm()} />
