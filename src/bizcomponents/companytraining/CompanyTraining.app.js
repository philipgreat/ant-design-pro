  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/companyTraining/${objectId}/list/employeeCompanyTrainingList`}>员工参与的公司培训</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             {this.getNavMenuItems(this.props.companyTraining.id)}
             <Menu.Item >
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/companyTraining/:id/dashboard" component={CompanyTrainingDashboard} />
               
               <Route path="/companyTraining/:id/editDetail" component={CompanyTrainingEditDetail} />
               <Route path="/companyTraining/:id/viewDetail" component={CompanyTrainingViewDetail} /> 
               

               <Route path="/companyTraining/:id/list/employeeCompanyTrainingList" component={this.getEmployeeCompanyTrainingSearch()} />
               <Route path="/companyTraining/:id/list/employeeCompanyTrainingCreateForm" component={this.getEmployeeCompanyTrainingCreateForm()} />
               <Route path="/companyTraining/:id/list/employeeCompanyTrainingUpdateForm" component={this.getEmployeeCompanyTrainingUpdateForm()} />
