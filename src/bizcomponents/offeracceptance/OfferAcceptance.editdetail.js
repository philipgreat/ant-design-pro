...
import styles from './OfferAcceptance.editdetail.less'
...
export default class OfferAcceptanceEditDetail extends Component {
  render() {
    const {EmployeeEditTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    const { id, employeeCount } = this.props.offerAcceptance
    const { employeeList } = this.props.offerAcceptance
