...
import styles from './CarInspectionServiceCompany.updateform.less';
...
class CarInspectionServiceCompanyUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carInspectionServiceCompanyId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carInspectionServiceCompanyId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarInspectionServiceCompany',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarInspectionServiceCompanyUpdateRow',
            payload: {
              id:owner.id,type:'carInspectionServiceCompany', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车代检服务公司"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车代检服务公司"
...
}))(Form.create()(CarInspectionServiceCompanyUpdateForm));
