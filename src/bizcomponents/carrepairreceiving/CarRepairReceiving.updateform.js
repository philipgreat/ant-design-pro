...
import styles from './CarRepairReceiving.updateform.less';
...
class CarRepairReceivingUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carRepairReceivingId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carRepairReceivingId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarRepairReceiving',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarRepairReceivingUpdateRow',
            payload: {
              id:owner.id,type:'carRepairReceiving', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车维修接待"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车维修接待"
...
}))(Form.create()(CarRepairReceivingUpdateForm));
