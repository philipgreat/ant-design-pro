...
import styles from './TicketPrinting.updateform.less'
...
class TicketPrintingUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const ticketPrintingId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, ticketPrintingId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateTicketPrinting`,
          payload: {
            id: owner.id,
            type: 'ticketPrinting',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTicketPrintingUpdateRow`,
        payload: {
          id: owner.id,
          type: 'ticketPrinting',
          selectedRows,
...
}))(Form.create()(TicketPrintingUpdateForm))
