...
import styles from './TicketPrinting.search.less'
...
class TicketPrintingSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleDelete = () => {
    ...
    const ticketPrintingIds = selectedRows.map((item) => { return item.id })
    console.log('ticketPrintingIds', ticketPrintingIds)
    const parameters = { ticketPrintingIds }
    dispatch({
      type: `${owner.type}/removeTicketPrintingList`,
  ...
  handleCreate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'ticketPrinting' },
    })
  }
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'ticketPrinting', selectedRows, currentUpdateIndex },
    })
  }
  ...
  render() {
    ...
    const {TicketPrintingTable} = GlobalComponents;
    const {TicketPrintingConfirmationTable} = GlobalComponents;
    const {TicketPrintingSearchForm} = GlobalComponents;
    ...
    const modalContent = (data, owner) => {
      ...
      return (
        <Modal
          ...
          style={{ top: 40 }}
        >
          <TicketPrintingConfirmationTable data={selectedRows} owner={owner} />
        </Modal>)
    }
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TicketPrintingSearchForm {...this.props} />
            </div>
...
export default Form.create()(TicketPrintingSearch)
