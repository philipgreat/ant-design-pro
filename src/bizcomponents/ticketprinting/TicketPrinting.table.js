...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/ticketPrinting/${text}/dashboard`}>{text}</Link>) },
...
class TicketPrintingTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default TicketPrintingTable
