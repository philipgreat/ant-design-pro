...
const imageListOf = (companyEmployeeTermination) =>{
...
const settingListOf = (companyEmployeeTermination) =>{
...
const largeTextOf = (companyEmployeeTermination) =>{
...
class CompanyEmployeeTerminationDashboard extends Component {
