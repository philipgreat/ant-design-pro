...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/companyEmployeeTermination/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '批注', debugtype: 'string', dataIndex: 'comment',},


]

class CompanyEmployeeTerminationTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default CompanyEmployeeTerminationTable
