...
class CompanyEmployeeTerminationBizApp extends React.PureComponent {
    ...
    return (
      <SubMenu
        title={
          <span>
            <Icon type="profile" />
            <span>商户员工合同结束状态变更</span>
          </span>
        }
      >
        <Menu.Item>
          <Link
            to={`/companyEmployeeTermination/${objectId}/list/vehicleServiceCompanyEmployeeList`}
          >
            商户员工
          </Link>
        </Menu.Item>
  ...
  getVehicleServiceCompanyEmployeeSearch = () => {
    ...
    return connect(state => ({
      ...
      count:
        state._companyEmployeeTermination.vehicleServiceCompanyEmployeeCount,
      currentPage:
        state._companyEmployeeTermination
      ...
      owner: {
        type: '_companyEmployeeTermination',
        id: state._companyEmployeeTermination.id,
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/companyEmployeeTermination/${
                  this.props.companyEmployeeTermination.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/companyEmployeeTermination/:id/dashboard"
                component={CompanyEmployeeTerminationDashboard}
              />

              <Route
                path="/companyEmployeeTermination/:id/editDetail"
                component={CompanyEmployeeTerminationEditDetail}
              />
              <Route
                path="/companyEmployeeTermination/:id/viewDetail"
                component={CompanyEmployeeTerminationViewDetail}
              />

              <Route
                path="/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeList"
                component={this.getVehicleServiceCompanyEmployeeSearch()}
              />
              <Route
                path="/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeCreateForm"
                component={this.getVehicleServiceCompanyEmployeeCreateForm()}
              />
              <Route
                path="/companyEmployeeTermination/:id/list/vehicleServiceCompanyEmployeeUpdateForm"
