...
import styles from './VipLevel.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/vipLevel/${text}/dashboard`}>{text}</Link>) },
  { title: '名称', debugtype: 'string', dataIndex: 'name',},
  { title: '描述', debugtype: 'string', dataIndex: 'description',},
  { title: '等级经验值要求', debugtype: 'int', dataIndex: 'requiredExperience',},


]

class VipLevelTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
