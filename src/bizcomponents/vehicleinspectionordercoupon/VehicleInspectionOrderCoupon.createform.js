...
const testValues = {
  ...
  endDate: '2996-02-03 22:58:57',
  appliedDate: '2996-12-18 07:30:12',
  couponStatus: '未使用',
  customerId: 'C000001',
...
class VehicleInspectionOrderCouponCreateForm extends Component {
  ...
  executeCandidateCustomerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = VehicleInspectionOrderCouponService.requestCandidateCustomer(
      'customer',
      id,
      filterKey,
      pageNo
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = VehicleInspectionOrderCouponService.requestCandidateMainOrder(
