...
const summaryOf = vehicleInspectionOrderCoupon => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="标题">
        {vehicleInspectionOrderCoupon.title}
      </Description>
      <Description term="生效日期">
        {moment(vehicleInspectionOrderCoupon.startDate).format('YYYY-MM-DD')}
      </Description>
      <Description term="失效日期">
        {moment(vehicleInspectionOrderCoupon.expirationDate).format(
          'YYYY-MM-DD'
        )}
      </Description>
      <Description term="金额">
        {vehicleInspectionOrderCoupon.amount}
      </Description>
      <Description term="优惠码">
        {vehicleInspectionOrderCoupon.code}
      </Description>
      <Description term="使用日期">
        {moment(vehicleInspectionOrderCoupon.usedDate).format('YYYY-MM-DD')}
      </Description>
    </DescriptionList>
  )
}
