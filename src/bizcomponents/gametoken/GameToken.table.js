...
const columns = [
  ...
  { title: 'Token的内容', debugtype: 'string_url', dataIndex: 'tokenContent',},
  { title: 'NFC ID', debugtype: 'string', dataIndex: 'nFCID',},
...
class GameTokenTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
