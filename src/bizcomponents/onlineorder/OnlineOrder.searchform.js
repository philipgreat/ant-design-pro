...
class OnlineOrderSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      onlineOrderList: 1,
      'onlineOrderList.searchField': fieldName,
      'onlineOrderList.searchVerb': 'startsWith',
      'onlineOrderList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, onlineOrderSearchFormParameters: fieldsValue },
      })
    })
  }
...
export default Form.create()(OnlineOrderSearchForm)
