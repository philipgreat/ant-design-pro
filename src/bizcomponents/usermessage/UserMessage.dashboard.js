...
class UserMessageDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, userMessage } = this.props;
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.userMessage
    const cardsData = {cardsName:"用户消息",cardsFor: "userMessage",cardsSource: this.props.userMessage,
  		subItems: [
