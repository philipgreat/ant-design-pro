...
class UserMessageEditTable extends PureComponent {
  ...
  { title: '信息的关键', debugtype: 'string', dataIndex: 'messageKey', width: '18', render: (text, record) => renderStringEdit('messageKey',text, record)  },
  { title: '接收者', dataIndex: 'receiver', render: (text, record) => (record.receiver ? record.receiver.displayName : '暂无') },
  { title: '内容', debugtype: 'string', dataIndex: 'content', width: '14', render: (text, record) => renderStringEdit('content',text, record)  },
  { title: '链接网址', debugtype: 'string', dataIndex: 'linkUrl', width: '31', render: (text, record) => renderStringEdit('linkUrl',text, record)  },
