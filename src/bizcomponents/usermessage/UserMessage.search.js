...
import UserMessageTable from './UserMessage.table';
import UserMessageConfirmationTable from './UserMessage.confirmmationtable';

import UserMessageSearchForm from './UserMessage.searchform';
...
@Form.create()
export default class UserMessageSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      userMessageList: 1,
      userMessageListCurrentPage: pagination.current,
      userMessageListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
