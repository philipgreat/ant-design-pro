...
class UserMessageSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userMessageList: 1,
      'userMessageList.searchField': fieldName,
      'userMessageList.searchVerb': 'startsWith',
      'userMessageList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, userMessageSearchFormParameters: fieldsValue },
      })
    })
  }
...
export default Form.create()(UserMessageSearchForm)
