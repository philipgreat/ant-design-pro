...
const columns = [
  ...
  { title: '车牌号类别', debugtype: 'string', dataIndex: 'plateNumberPattern',},
  { title: '商户', dataIndex: 'company', render: (text, record) => (record.company ? record.company.displayName : '暂无') },


]

class VehicleInspectionPlateNumberPatternTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default VehicleInspectionPlateNumberPatternTable
