...
const imageListOf = (vehicleInspectionPlateNumberPattern) =>{
...
const settingListOf = (vehicleInspectionPlateNumberPattern) =>{
...
const largeTextOf = (vehicleInspectionPlateNumberPattern) =>{
...
class VehicleInspectionPlateNumberPatternDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, vehicleInspectionPlateNumberPattern } = this.props;
    
    if(!vehicleInspectionPlateNumberPattern){
    	return;
    }
    const {displayName} = vehicleInspectionPlateNumberPattern;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.vehicleInspectionPlateNumberPattern
    const cardsData = {cardsName:"上线检测支持的车牌号码类别",cardsFor: "vehicleInspectionPlateNumberPattern",cardsSource: this.props.vehicleInspectionPlateNumberPattern,
  		subItems: [
