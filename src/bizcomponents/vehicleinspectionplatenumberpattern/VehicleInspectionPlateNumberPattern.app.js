       ...
       <Layout>
         ...
         >
           <div className={styles.logo}>
             ...
             <Link to="/home"> <h1>车辆检验牌照号码模式</h1></Link>
           </div>
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/vehicleInspectionPlateNumberPattern/${this.props.vehicleInspectionPlateNumberPattern.id}/editDetail`}><Icon type="edit" /><span>详情编辑</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/vehicleInspectionPlateNumberPattern/${this.props.vehicleInspectionPlateNumberPattern.id}/viewDetail`}><Icon type="eye-o" /><span>详情查看</span></Link>
             </Menu.Item>
