...
const menuData = {
  menuName: '上线检测支持的车牌号码类别',
  menuFor: 'vehicleInspectionPlateNumberPattern',
  subItems: [],
}
        ...
        <Layout>
          ...
          >
            ...
            >
              <Menu.Item key="dashboard">
                <Link
                  to={`/vehicleInspectionPlateNumberPattern/${
                    this.props.vehicleInspectionPlateNumberPattern.id
                  }/dashboard`}
                >
                  <Icon type="dashboard" />
                  <span>仪表板</span>
          ...
          <Layout>
            <Content style={{ margin: '24px 24px 0', height: '100%' }}>
              <Switch>
                <Route
                  path="/vehicleInspectionPlateNumberPattern/:id/dashboard"
                  component={VehicleInspectionPlateNumberPatternDashboard}
                />

                <Route
                  path="/vehicleInspectionPlateNumberPattern/:id/editDetail"
                  component={VehicleInspectionPlateNumberPatternEditDetail}
                />
                <Route
                  path="/vehicleInspectionPlateNumberPattern/:id/viewDetail"
                  component={VehicleInspectionPlateNumberPatternViewDetail}
                />
              </Switch>
            </Content>
          </Layout>
