...
import styles from './EmployeeWorkExperience.viewdetail.less'
...
export default class EmployeeWorkExperienceViewDetail extends Component {
  ...
  render() {
    ...
    const { id,  } = employeeWorkExperience
