...
import styles from './AvailableToken.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/availableToken/${text}/dashboard`}>{text}</Link>) },
...
class AvailableTokenTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default AvailableTokenTable
