...
class AvailableTokenBizApp extends React.PureComponent {
  ...
  getTokenInMemberServiceProductSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_availableToken', id: state._availableToken.id, referenceName: 'availableToken', listName: 'tokenInMemberServiceProductList', ref:state._availableToken, listDisplayName: '成员服务产品中的令牌。列表' }, // this is for model namespace and
  ...
  getTokenInMemberServiceProductUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_availableToken', id: state._availableToken.id, listName: 'tokenInMemberServiceProductList', ref:state._availableToken, listDisplayName: '成员服务产品中的令牌。列表' }, // this is for model namespace and
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/availableToken/:id/dashboard" component={AvailableTokenDashboard} />
               
               

               <Route path="/availableToken/:id/list/tokenInMemberServiceProductList" component={this.getTokenInMemberServiceProductSearch()} />
               <Route path="/availableToken/:id/list/tokenInMemberServiceProductCreateForm" component={this.getTokenInMemberServiceProductCreateForm()} />
               <Route path="/availableToken/:id/list/tokenInMemberServiceProductUpdateForm" component={this.getTokenInMemberServiceProductUpdateForm()} />
