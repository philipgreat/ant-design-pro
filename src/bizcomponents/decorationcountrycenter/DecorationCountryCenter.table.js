...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/decorationCountryCenter/${text}/dashboard`}>{text}</Link>) },
...
class DecorationCountryCenterTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default DecorationCountryCenterTable
