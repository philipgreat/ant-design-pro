...
const imageListOf = (repairingAllowanceItem) =>{
...
const settingListOf = (repairingAllowanceItem) =>{
...
const largeTextOf = (repairingAllowanceItem) =>{
...
class RepairingAllowanceItemDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, repairingAllowanceItem } = this.props;
    
    if(!repairingAllowanceItem){
    	return;
    }
    const {displayName} = repairingAllowanceItem;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.repairingAllowanceItem
    const cardsData = {cardsName:"车辆维修补贴项",cardsFor: "repairingAllowanceItem",cardsSource: this.props.repairingAllowanceItem,
  		subItems: [
