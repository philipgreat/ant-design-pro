...
import styles from './CarReceivingServiceCompany.updateform.less';
...
class CarReceivingServiceCompanyUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carReceivingServiceCompanyId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carReceivingServiceCompanyId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarReceivingServiceCompany',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarReceivingServiceCompanyUpdateRow',
            payload: {
              id:owner.id,type:'carReceivingServiceCompany', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车接收服务公司"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车接收服务公司"
...
}))(Form.create()(CarReceivingServiceCompanyUpdateForm));
