...
import styles from './NewsContent.updateform.less'
...
class NewsContentUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const newsContentId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, newsContentId, ...imagesValues }

        // const newIndex= currentUpdateIndex + 1
        dispatch({
          type: `${owner.type}/updateNewsContent`,
          payload: {
            id: owner.id,
            type: 'newsContent',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextNewsContentUpdateRow`,
        payload: {
          id: owner.id,
          type: 'newsContent',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新新闻内容"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新新闻内容"
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.newsContentOrder} {...formItemLayout}>
                  {getFieldDecorator('newsContentOrder', {
                    initialValue: selectedRow.newsContentOrder,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
                  {getFieldDecorator('newsText', {
                  	initialValue: selectedRow.newsText,
...
}))(Form.create()(NewsContentUpdateForm))
