...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/memberAccountRechargeProduct/${text}/dashboard`}>{text}</Link>) },
...
class MemberAccountRechargeProductTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default MemberAccountRechargeProductTable
