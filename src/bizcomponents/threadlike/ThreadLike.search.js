...
import {ThreadLikeTable} from '../../custcomponents';
import {ThreadLikeConfirmationTable} from '../../custcomponents';

import {ThreadLikeSearchForm} from '../../custcomponents';
...
@Form.create()
export default class ThreadLikeSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      threadLikeList: 1,
      threadLikeListCurrentPage: pagination.current,
      threadLikeListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
