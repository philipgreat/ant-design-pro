...
import styles from './CarInspectionServiceOrder.updateform.less';
...
class CarInspectionServiceOrderUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carInspectionServiceOrderId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carInspectionServiceOrderId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarInspectionServiceOrder',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarInspectionServiceOrderUpdateRow',
            payload: {
              id:owner.id,type:'carInspectionServiceOrder', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车检查服务单"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车检查服务单"
...
}))(Form.create()(CarInspectionServiceOrderUpdateForm));
