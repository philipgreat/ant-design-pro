...
const view=(targetObjectId)=>{
    return get({
        url: PREFIX+`carInspectionServiceOrderManager/view/${targetObjectId}/`
...
const load=(targetObjectId,parameters)=>{
    ...
    return get({
        url: PREFIX+`carInspectionServiceOrderManager/loadCarInspectionServiceOrder/${targetObjectId}/${parametersExpr}/`
