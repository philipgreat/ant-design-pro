...
const imageListOf = (availableHandOverItem) =>{
...
const settingListOf = (availableHandOverItem) =>{
...
const largeTextOf = (availableHandOverItem) =>{

	return(<div> 
   <Card title={`检查项目描述`} ><pre>{availableHandOverItem.checkItemDescription}</pre></Card>
</div>)
...
class AvailableHandOverItemDashboard extends Component {
