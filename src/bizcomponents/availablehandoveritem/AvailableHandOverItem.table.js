...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/availableHandOverItem/${text}/dashboard`}>{text}</Link>) },
  { title: '检查项目名称', debugtype: 'string', dataIndex: 'checkItemName',},
