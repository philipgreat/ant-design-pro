...
import styles from './AvailableHandOverItem.updateform.less'
...
class AvailableHandOverItemUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const availableHandOverItemId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, availableHandOverItemId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAvailableHandOverItemUpdateRow`,
        payload: {
          id: owner.id,
          type: 'availableHandOverItem',
          selectedRows,
...
}))(Form.create()(AvailableHandOverItemUpdateForm))
