...
import styles from './IdentityCard.updateform.less'
...
class IdentityCardUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const identityCardId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, identityCardId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextIdentityCardUpdateRow`,
        payload: {
          id: owner.id,
          type: 'identityCard',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新身份证"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新身份证"
            ...
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <PictureEdit
                  ...
                  fileList={convertedImagesValues.frontImage}
                />
              </Col>
...
}))(Form.create()(IdentityCardUpdateForm))
