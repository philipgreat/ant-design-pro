...
class ContractDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, contract } = this.props;
  ...
  render() {
    ...
    const { id,displayName, servicePriceCount } = this.props.contract
    const cardsData = {cardsName:"合同",cardsFor: "contract",cardsSource: this.props.contract,
  		subItems: [
