...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/fundationAccount/${text}/dashboard`}>{text}</Link>) },
...
class FundationAccountTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default FundationAccountTable
