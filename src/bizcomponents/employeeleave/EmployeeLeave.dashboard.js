...
export default class EmployeeLeaveDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, employeeLeave } = this.props;
    
    if(!employeeLeave){
    	return;
    }
    const {displayName} = employeeLeave;
    if(!displayName){
    	return;
    }
