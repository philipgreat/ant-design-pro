...
import styles from './EmployeeLeave.viewdetail.less'
...
export default class EmployeeLeaveViewDetail extends Component {
  ...
  render() {
    ...
    return (
      ...
      <PageHeaderLayout
        title="请假记录总览"
        content={summaryOf(this.props.employeeLeave)}
