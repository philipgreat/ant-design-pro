...
class CityViewDetail extends Component {
  ...
  render() {
    const {DistrictViewTable} = GlobalComponents;
  
    // eslint-disable-next-line max-len
    
    const city = this.props.city
    const { id, districtCount } = city
    ...
    const tabList = [
      ...
      {key: 'districtList',tab: `区(${districtCount})`}, 
    ...
    const contentList = {
       districtList:  
        <DistrictViewTable data={districtList} owner={owner} {...this.props} />,
