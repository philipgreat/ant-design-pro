...
const addProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}cityManager/addProductPrice/cityId/productId/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/toStoreServicePrice/discountAgentServicePrice/description/tokensExpr/`
...
const updateProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}cityManager/updateProductPriceProperties/cityId/id/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/toStoreServicePrice/discountAgentServicePrice/description/tokensExpr/`
