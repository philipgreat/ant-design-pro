...
const addProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}cityManager/addProductPrice/cityId/productId/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/discountAgentServicePrice/description/tokensExpr/`
...
const updateProductPrice = (targetObjectId, parameters) => {
  const url = `${PREFIX}cityManager/updateProductPriceProperties/cityId/id/vehicleType/greenVehicle/inspectionPrice/secondLevelMaintenancePrice/gradeEstimationPrice/agentServicePrice/discountAgentServicePrice/description/tokensExpr/`
...
const updateVehicleServiceCompany = (targetObjectId, parameters) => {
  const url = `${PREFIX}`
  const cityId = targetObjectId
  const requestParameters = { ...parameters, cityId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
