...
import styles from './PublicHoliday.viewdetail.less'
...
export default class PublicHolidayViewDetail extends Component {
  ...
  render() {
    ...
    const { id,  } = publicHoliday
    const {  } = publicHoliday
    
    const owner = { type: '_publicHoliday', id }
    ...
    return (
      ...
      <PageHeaderLayout
        title="公共假日总览"
        content={summaryOf(this.props.publicHoliday)}
