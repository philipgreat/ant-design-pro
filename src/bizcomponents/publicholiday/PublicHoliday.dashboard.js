...
export default class PublicHolidayDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, publicHoliday } = this.props;
    
    if(!publicHoliday){
    	return;
    }
    const {displayName} = publicHoliday;
    if(!displayName){
    	return;
    }
