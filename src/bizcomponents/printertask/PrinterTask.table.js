...
const columns = [
  ...
  { title: '提交者', debugtype: 'string', dataIndex: 'submitter',},
  { title: '打印机', dataIndex: 'printer', render: (text, record) => (record.printer ? record.printer.displayName : '暂无') },
  { title: '内容1', debugtype: 'string', dataIndex: 'content1',},
  { title: '内容2', debugtype: 'string', dataIndex: 'content2',},
  { title: '内容3', debugtype: 'string', dataIndex: 'content3',},
  { title: '内容4', debugtype: 'string', dataIndex: 'content4',},
  { title: '内容5', debugtype: 'string', dataIndex: 'content5',},
  { title: '打印任务状态', debugtype: 'string', dataIndex: 'printTaskStatus',},
...
class PrinterTaskTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default PrinterTaskTable
