...
const columns = [
  ...
  { title: '书副本操作类型', debugtype: 'string', dataIndex: 'bookCopyOperateType',},
...
class BookCopyOperationRecordTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopyOperationRecordTable
