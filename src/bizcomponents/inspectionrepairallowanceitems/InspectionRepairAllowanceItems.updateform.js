...
import styles from './InspectionRepairAllowanceItems.updateform.less'
...
class InspectionRepairAllowanceItemsUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const inspectionRepairAllowanceItemsId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, inspectionRepairAllowanceItemsId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextInspectionRepairAllowanceItemsUpdateRow`,
        payload: {
          id: owner.id,
          type: 'inspectionRepairAllowanceItems',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新检测修理建议项"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新检测修理建议项"
...
}))(Form.create()(InspectionRepairAllowanceItemsUpdateForm))
