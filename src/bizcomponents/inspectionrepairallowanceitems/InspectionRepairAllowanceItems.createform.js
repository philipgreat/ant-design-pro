...
import styles from './InspectionRepairAllowanceItems.createform.less'
...
class InspectionRepairAllowanceItemsCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addInspectionRepairAllowanceItems`,
          payload: { id: owner.id, type: 'inspectionRepairAllowanceItems', parameters, continueNext: true },
        })
      })
    }
              ...
              <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.serviceVehicleInspection}>
                  {getFieldDecorator('serviceVehicleInspectionId', {
                    ...
                    <Input placeholder="请输入请输入车辆上线检测" />
                  )}
                </Form.Item>
              </Col>
...
}))(Form.create()(InspectionRepairAllowanceItemsCreateForm))
