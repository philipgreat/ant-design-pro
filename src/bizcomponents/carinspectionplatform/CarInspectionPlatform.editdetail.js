...
export default class CarInspectionPlatformEditDetail extends Component {
  render() {
    ...
    const {AvailableVehicleUseCharacterEditTable} = GlobalComponents;
    ...
    const { provinceList, availableProductList, availableVehicleTypeList, availableVehicleUseCharacterList, contractList, customerList, vehicleServiceCompanyList, vehicleInfoList, vehicleInspectionOrderList, availableReviewItemList, availableRatingItemList, preorderPromotionList, orderDiscountCouponList, accountList } = this.props.carInspectionPlatform
    ...
    return (
      ...
      >
		...
		<Card title="车辆使用性质列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <AvailableVehicleUseCharacterEditTable data={availableVehicleUseCharacterList} owner={owner} {...this.props} />
          </Form>
        </Card>
