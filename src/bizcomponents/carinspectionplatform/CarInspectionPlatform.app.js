...
class CarInspectionPlatformBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/provinceList`}>
            省
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/availableProductList`}
          >
            产品类型
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/availableVehicleTypeList`}
          >
            车辆类型
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/availableVehicleUseCharacterList`}
          >
            车辆使用性质
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/contractList`}>
            合同
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/customerList`}>
            客户
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/vehicleServiceCompanyList`}
          >
            商户
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/vehicleInfoList`}>
            车辆信息
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/vehicleInspectionOrderList`}
          >
            年检订单
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/availableReviewItemList`}
          >
            评论
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/availableRatingItemList`}
          >
            服务评分
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/preorderPromotionList`}
          >
            提前下单优惠
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/carInspectionPlatform/${objectId}/list/orderDiscountCouponList`}
          >
            优惠券
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/accountList`}>
            对账单
          </Link>
        </Menu.Item>
      </SubMenu>
  ...
  getProvinceSearch = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters:
        state._carInspectionPlatform.provinceSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getAvailableProductSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.availableProductCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.availableProductSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
        listName: 'availableProductList',
      }, // this is for model namespace and
  ...
  getAvailableVehicleTypeSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.availableVehicleTypeCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.availableVehicleTypeSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
        listName: 'availableVehicleTypeList',
      }, // this is for model namespace and
  ...
  getAvailableVehicleUseCharacterSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform
          .availableVehicleUseCharacterCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform
          .availableVehicleUseCharacterSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
        listName: 'availableVehicleUseCharacterList',
      }, // this is for model namespace and
  ...
  getContractSearch = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters:
        state._carInspectionPlatform.contractSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getCustomerSearch = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters:
        state._carInspectionPlatform.customerSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getVehicleServiceCompanySearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.vehicleServiceCompanyCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.vehicleServiceCompanySearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getVehicleInfoSearch = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters:
        state._carInspectionPlatform.vehicleInfoSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getVehicleInspectionOrderSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.vehicleInspectionOrderCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.vehicleInspectionOrderSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getAvailableReviewItemSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.availableReviewItemCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.availableReviewItemSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
        listName: 'availableReviewItemList',
      }, // this is for model namespace and
  ...
  getAvailableRatingItemSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.availableRatingItemCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.availableRatingItemSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
        listName: 'availableRatingItemList',
      }, // this is for model namespace and
  ...
  getPreorderPromotionSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.preorderPromotionCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.preorderPromotionSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getOrderDiscountCouponSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._carInspectionPlatform.orderDiscountCouponCurrentPageNumber,
      searchFormParameters:
        state._carInspectionPlatform.orderDiscountCouponSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
  ...
  getAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters:
        state._carInspectionPlatform.accountSearchFormParameters,
      loading: state._carInspectionPlatform.loading,
      owner: {
        type: '_carInspectionPlatform',
        id: state._carInspectionPlatform.id,
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/carInspectionPlatform/${
                  this.props.carInspectionPlatform.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/carInspectionPlatform/:id/dashboard"
                component={CarInspectionPlatformDashboard}
              />

              <Route
                path="/carInspectionPlatform/:id/editDetail"
                component={CarInspectionPlatformEditDetail}
              />
              <Route
                path="/carInspectionPlatform/:id/viewDetail"
                component={CarInspectionPlatformViewDetail}
              />

              <Route
                path="/carInspectionPlatform/:id/list/provinceList"
                component={this.getProvinceSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/provinceCreateForm"
                component={this.getProvinceCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/provinceUpdateForm"
                component={this.getProvinceUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/availableProductList"
                component={this.getAvailableProductSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableProductCreateForm"
                component={this.getAvailableProductCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableProductUpdateForm"
                component={this.getAvailableProductUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleTypeList"
                component={this.getAvailableVehicleTypeSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleTypeCreateForm"
                component={this.getAvailableVehicleTypeCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleTypeUpdateForm"
                component={this.getAvailableVehicleTypeUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleUseCharacterList"
                component={this.getAvailableVehicleUseCharacterSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleUseCharacterCreateForm"
                component={this.getAvailableVehicleUseCharacterCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableVehicleUseCharacterUpdateForm"
                component={this.getAvailableVehicleUseCharacterUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/contractList"
                component={this.getContractSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/contractCreateForm"
                component={this.getContractCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/contractUpdateForm"
                component={this.getContractUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/customerList"
                component={this.getCustomerSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/customerCreateForm"
                component={this.getCustomerCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/customerUpdateForm"
                component={this.getCustomerUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/vehicleServiceCompanyList"
                component={this.getVehicleServiceCompanySearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleServiceCompanyCreateForm"
                component={this.getVehicleServiceCompanyCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleServiceCompanyUpdateForm"
                component={this.getVehicleServiceCompanyUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/vehicleInfoList"
                component={this.getVehicleInfoSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleInfoCreateForm"
                component={this.getVehicleInfoCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleInfoUpdateForm"
                component={this.getVehicleInfoUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/vehicleInspectionOrderList"
                component={this.getVehicleInspectionOrderSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleInspectionOrderCreateForm"
                component={this.getVehicleInspectionOrderCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/vehicleInspectionOrderUpdateForm"
                component={this.getVehicleInspectionOrderUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/availableReviewItemList"
                component={this.getAvailableReviewItemSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableReviewItemCreateForm"
                component={this.getAvailableReviewItemCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableReviewItemUpdateForm"
                component={this.getAvailableReviewItemUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/availableRatingItemList"
                component={this.getAvailableRatingItemSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableRatingItemCreateForm"
                component={this.getAvailableRatingItemCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/availableRatingItemUpdateForm"
                component={this.getAvailableRatingItemUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/preorderPromotionList"
                component={this.getPreorderPromotionSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/preorderPromotionCreateForm"
                component={this.getPreorderPromotionCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/preorderPromotionUpdateForm"
                component={this.getPreorderPromotionUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/orderDiscountCouponList"
                component={this.getOrderDiscountCouponSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/orderDiscountCouponCreateForm"
                component={this.getOrderDiscountCouponCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/orderDiscountCouponUpdateForm"
                component={this.getOrderDiscountCouponUpdateForm()}
              />

              <Route
                path="/carInspectionPlatform/:id/list/accountList"
                component={this.getAccountSearch()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/accountCreateForm"
                component={this.getAccountCreateForm()}
              />
              <Route
                path="/carInspectionPlatform/:id/list/accountUpdateForm"
                component={this.getAccountUpdateForm()}
              />
            </Switch>
          </Content>
        </Layout>
