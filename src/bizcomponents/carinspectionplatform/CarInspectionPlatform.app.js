...
class CarInspectionPlatformBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/availableVehicleTypeList`}>车辆类型</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/availableVehicleUseCharacterList`}>车辆使用性质</Link>
        </Menu.Item>
        <Menu.Item>
        ...
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/vehicleInspectionOrderList`}>年检订单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/availableReviewItemList`}>评论</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/availableRatingItemList`}>服务评分</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/preorderPromotionList`}>提前下单优惠</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/carInspectionPlatform/${objectId}/list/orderDiscountCouponList`}>优惠券</Link>
        </Menu.Item>
        <Menu.Item>
  ...
  getAvailableVehicleUseCharacterSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._carInspectionPlatform.loading,
      owner: { type: '_carInspectionPlatform', id: state._carInspectionPlatform.id, listName: 'availableVehicleUseCharacterList' }, // this is for model namespace and
