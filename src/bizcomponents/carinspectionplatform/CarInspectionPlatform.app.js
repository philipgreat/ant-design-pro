...
const menuData = {
  menuName: '驾乐乐车辆代审服务平台',
  menuFor: 'carInspectionPlatform',
  subItems: [
  ...
  getProvinceSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._carInspectionPlatform,
        listDisplayName: '省列表',
