...
export default class CarInspectionPlatformDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '驾乐乐车辆代审服务平台',
      cardsFor: 'carInspectionPlatform',
      cardsSource: this.props.carInspectionPlatform,
      subItems: [
        {
          name: 'provinceList',
          displayName: '省',
        ...
        {
          name: 'availableVehicleTypeList',
          displayName: '车辆类型',
          type: 'availableVehicleType',
          count: availableVehicleTypeCount,
        },
        {
          name: 'availableVehicleUseCharacterList',
          displayName: '车辆使用性质',
          type: 'availableVehicleUseCharacter',
          count: availableVehicleUseCharacterCount,
        },
        {
          name: 'contractList',
          displayName: '合同',
        ...
        {
          name: 'vehicleServiceCompanyList',
          displayName: '商户',
          type: 'vehicleServiceCompany',
          count: vehicleServiceCompanyCount,
        },
        {
          name: 'vehicleInfoList',
          displayName: '车辆信息',
          type: 'vehicleInfo',
          count: vehicleInfoCount,
        },
        {
        ...
        {
          name: 'availableReviewItemList',
          displayName: '评论',
          type: 'availableReviewItem',
          count: availableReviewItemCount,
        },
        {
          name: 'availableRatingItemList',
          displayName: '服务评分',
          type: 'availableRatingItem',
          count: availableRatingItemCount,
        },
        {
