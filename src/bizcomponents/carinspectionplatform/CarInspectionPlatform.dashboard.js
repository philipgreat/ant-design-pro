        ...
        <div>
          <Row gutter={24}>
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/carInspectionPlatform/${id}/list/availableVehicleUseCharacterList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/carInspectionPlatform/${id}/list/availableVehicleUseCharacterCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
