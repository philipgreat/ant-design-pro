...
export default class CarInspectionPlatformViewDetail extends Component {
  ...
  render() {
    ...
    const { provinceList, availableProductList, availableVehicleTypeList, availableVehicleUseCharacterList, contractList, customerList, vehicleServiceCompanyList, vehicleInfoList, vehicleInspectionOrderList, availableReviewItemList, availableRatingItemList, preorderPromotionList, orderDiscountCouponList, accountList } = carInspectionPlatform
    ...
    const tabList = [
      ...
      {key: 'availableVehicleUseCharacterList',tab: `车辆使用性质(${availableVehicleUseCharacterCount})`}, 
    ...
    const contentList = {
      ...
      availableVehicleUseCharacterList:  
        <AvailableVehicleUseCharacterViewTable data={availableVehicleUseCharacterList} owner={owner} {...this.props} />,
