...
export default {
  ...
  effects: {
	...
	*updateCustomerInfo({ payload }, { call, put }) {
		...
		const data = yield call(CarInspectionPlatformService.updateCustomerInfo, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
	...
	*gotoNextCustomerInfoUpdateRow({ payload }, { call, put }) {
        const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
...
    },
	...
	*updateCarReceivingServiceCompany({ payload }, { call, put }) {
		const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
		
		console.log("get form parameters", parameters);

		const data = yield call(CarInspectionPlatformService.updateCarReceivingServiceCompany, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
	...
	*gotoNextCarReceivingServiceCompanyUpdateRow({ payload }, { call, put }) {
        const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
        const newPlayload = { ...payload, selectedRows,currentUpdateIndex };
        yield put({ type: "updateState", payload: newPlayload });
...
    },
	...
	*updateCarInspectionServiceCompany({ payload }, { call, put }) {
		const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
		
		console.log("get form parameters", parameters);

		const data = yield call(CarInspectionPlatformService.updateCarInspectionServiceCompany, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
	...
	*gotoNextCarInspectionServiceCompanyUpdateRow({ payload }, { call, put }) {
        const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
        const newPlayload = { ...payload, selectedRows,currentUpdateIndex };
        yield put({ type: "updateState", payload: newPlayload });
...
    },
	...
	*updateCarRepairingServiceCompany({ payload }, { call, put }) {
		const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
		
		console.log("get form parameters", parameters);

		const data = yield call(CarInspectionPlatformService.updateCarRepairingServiceCompany, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
	...
	*gotoNextCarRepairingServiceCompanyUpdateRow({ payload }, { call, put }) {
        const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
        const newPlayload = { ...payload, selectedRows,currentUpdateIndex };
        yield put({ type: "updateState", payload: newPlayload });
...
    },
	...
	*updateCarInfo({ payload }, { call, put }) {
		...
		const data = yield call(CarInspectionPlatformService.updateCarInfo, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
	...
	*gotoNextCarInfoUpdateRow({ payload }, { call, put }) {
        const { id, type, parameters, continueNext,selectedRows,currentUpdateIndex } = payload;
        const newPlayload = { ...payload, selectedRows,currentUpdateIndex };
        yield put({ type: "updateState", payload: newPlayload });
...
    },
	...
	*updateCarInspectionOrder({ payload }, { call, put }) {
		...
		const data = yield call(CarInspectionPlatformService.updateCarInspectionOrder, id, parameters);
		if(hasError(data)){
			handleServerError(data);
			return;
		}
