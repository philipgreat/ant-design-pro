...
class BookSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      bookList: 1,
      'bookList.searchField': fieldName,
      'bookList.searchVerb': 'startsWith',
      'bookList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const params = {
        ...
        ...this.buildStringSearchParameters(fieldsValue, 'bookIsbn10'),

      }
      const { owner } = this.props
      dispatch({
        type: `${owner.type}/load`,
        payload: { id: owner.id, parameters: params, bookSearchFormParameters: fieldsValue },
      })
    })
  }
...
export default Form.create()(BookSearchForm)
