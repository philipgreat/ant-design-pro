...
const imageListOf = (companyEmployeeQualification) =>{
...
const settingListOf = (companyEmployeeQualification) =>{
...
const largeTextOf = (companyEmployeeQualification) =>{
...
class CompanyEmployeeQualificationDashboard extends Component {
  ...
  render() {
    ...
    const { id,displayName, vehicleServiceCompanyEmployeeCount } = this.props.companyEmployeeQualification
    const cardsData = {cardsName:"商户员工资格审查",cardsFor: "companyEmployeeQualification",cardsSource: this.props.companyEmployeeQualification,
  		subItems: [
