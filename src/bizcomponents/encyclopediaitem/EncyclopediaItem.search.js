...
import EncyclopediaItemTable from './EncyclopediaItem.table';
import EncyclopediaItemConfirmationTable from './EncyclopediaItem.confirmmationtable';

import EncyclopediaItemSearchForm from './EncyclopediaItem.searchform';
...
@Form.create()
export default class EncyclopediaItemSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      ...
      encyclopediaItemListCurrentPage: pagination.current,
      encyclopediaItemListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
