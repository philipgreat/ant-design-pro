...
export default class EncyclopediaItemSearchForm extends PureComponent {
   ...
   handleSearch = (e) => {
        ...
        form.validateFields((err, fieldsValue) => {
          ...
          if(fieldsValue.id){
            searchByIdParameters={encyclopediaItemList:1,
                "encyclopediaItemList.searchField":"id",
                "encyclopediaItemList.searchVerb":"startsWith",
                "encyclopediaItemList.searchValue":fieldsValue.id,};
