...
<Description term="代理费全免">{companyDiscount.allFreeDiscount?'是':'否'}</Description> 
<Description term="优惠金额">{companyDiscount.directDiscountValue}</Description> 
<Description term="创建时间">{ moment(companyDiscount.createTime).format('YYYY-MM-DD')}</Description> 
...
export default class CompanyDiscountDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"公司折扣",cardsFor: "companyDiscount",cardsSource: this.props.companyDiscount,
  		subItems: [
