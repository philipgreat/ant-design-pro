...
const imageListOf = (companyDiscount) =>{
...
const settingListOf = (companyDiscount) =>{

	const optionList = [ 
	  {"title":'代理费全免',"value":companyDiscount.allFreeDiscount},
]
...
const largeTextOf = (companyDiscount) =>{
...
class CompanyDiscountDashboard extends Component {
