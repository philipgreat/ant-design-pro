...
import TaskPageTable from './TaskPage.table';
import TaskPageConfirmationTable from './TaskPage.confirmmationtable';

import TaskPageSearchForm from './TaskPage.searchform';
...
@Form.create()
export default class TaskPageSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskPageList: 1,
      taskPageListCurrentPage: pagination.current,
      taskPageListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
