...
class TaskPageBizApp extends React.PureComponent {
  ...
  getTaskFilterSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_taskPage', id: state._taskPage.id, listName: 'taskFilterList' }, // this is for model namespace and
    }))(TaskFilterSearch)
  }
  ...
  getTaskSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._taskPage.loading,
      owner: { type: '_taskPage', id: state._taskPage.id, listName: 'taskList' }, // this is for model namespace and
    }))(TaskSearch)
  }
  getTaskCreateForm = () => {
