...
class TaskPageBizApp extends React.PureComponent {
  ...
  getTaskFilterSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._taskPage.partialList,
      owner: { type: '_taskPage', id: state._taskPage.id, referenceName: 'taskPage', listName: 'taskFilterList', ref:state._taskPage, listDisplayName: '任务过滤器列表' }, // this is for model namespace and
    }))(TaskFilterSearch)
  }
  ...
  getTaskFilterUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_taskPage', id: state._taskPage.id, listName: 'taskFilterList', ref:state._taskPage, listDisplayName: '任务过滤器列表' }, // this is for model namespace and
  ...
  getTaskSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._taskPage.loading,
      partialList: state._taskPage.partialList,
      owner: { type: '_taskPage', id: state._taskPage.id, referenceName: 'taskPage', listName: 'taskList', ref:state._taskPage, listDisplayName: '任务列表' }, // this is for model namespace and
    }))(TaskSearch)
  }
  getTaskCreateForm = () => {
  ...
  getTaskUpdateForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._taskPage.selectedRows,
      currentUpdateIndex: state._taskPage.currentUpdateIndex,
      owner: { type: '_taskPage', id: state._taskPage.id, listName: 'taskList', ref:state._taskPage, listDisplayName: '任务列表' }, // this is for model namespace and
    }))(TaskUpdateForm)
  }
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/taskPage/:id/viewDetail" component={TaskPageViewDetail} /> 
