...
const columns = [
  ...
  { title: '兑换状态', debugtype: 'string', dataIndex: 'redeemStatus',},


]

class OnlineOrderRedeemHistoryTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default OnlineOrderRedeemHistoryTable
