...
const settingListOf = (taskFilter) =>{
...
class TaskFilterDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, taskFilter } = this.props;
    
    if(!taskFilter){
    	return;
    }
    const {displayName} = taskFilter;
    if(!displayName){
    	return;
    }
  ...
  render() {
    ...
    const { id,displayName,  } = this.props.taskFilter
    const cardsData = {cardsName:"任务过滤器",cardsFor: "taskFilter",cardsSource: this.props.taskFilter,
  		subItems: [
