...
import TaskFilterTable from './TaskFilter.table';
import TaskFilterConfirmationTable from './TaskFilter.confirmmationtable';

import TaskFilterSearchForm from './TaskFilter.searchform';
...
@Form.create()
export default class TaskFilterSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      taskFilterList: 1,
      taskFilterListCurrentPage: pagination.current,
      taskFilterListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="任务过滤器列表">
        <Card bordered={false}>
