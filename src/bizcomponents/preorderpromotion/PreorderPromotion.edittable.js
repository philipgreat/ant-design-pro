...
class PreorderPromotionEditTable extends PureComponent {
  ...
  { title: '优惠信息', debugtype: 'string', dataIndex: 'promotionMessage', width: '15', render: (text, record) => renderStringEdit('promotionMessage',text, record)  },
  { title: '提前天数', debugtype: 'int', dataIndex: 'preorderDays', width: '6', render: (text, record) => renderStringEdit('preorderDays',text, record)  },
