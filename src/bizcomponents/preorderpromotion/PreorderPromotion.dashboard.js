...
const imageListOf = (preorderPromotion) =>{
...
const settingListOf = (preorderPromotion) =>{
...
const largeTextOf = (preorderPromotion) =>{
...
class PreorderPromotionDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"提前下单优惠",cardsFor: "preorderPromotion",cardsSource: this.props.preorderPromotion,
  		subItems: [
