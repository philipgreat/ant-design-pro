...
<Description term="促销信息">{preorderPromotion.promotionMessage}</Description> 
<Description term="预订的日子">{preorderPromotion.preorderDays}</Description> 
<Description term="折扣金额">{preorderPromotion.discountAmount}</Description> 
<Description term="生效日期">{ moment(preorderPromotion.startDate).format('YYYY-MM-DD')}</Description> 
