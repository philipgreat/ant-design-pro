...
const summaryOf = mainOrderAccount => {
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="检查价格">
        {mainOrderAccount.inspectionPrice}
      </Description>
      <Description term="代理服务价格">
