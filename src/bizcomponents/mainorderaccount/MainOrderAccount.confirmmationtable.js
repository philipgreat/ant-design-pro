...
const columns = [
  ...
  { title: '优惠折扣', debugtype: 'money', dataIndex: 'orderPromotionDiscount', width: '10' },
  { title: '优惠券折扣', debugtype: 'money', dataIndex: 'orderCouponDiscount', width: '10' },
  { title: '保单费用', debugtype: 'money', dataIndex: 'orderInsuranceAmount', width: '9' },
  { title: '商户优惠', debugtype: 'string', dataIndex: 'orderMerchantDiscount', width: '9' },
  { title: '客户付款总金额', debugtype: 'money', dataIndex: 'orderCustomerPaymentAmount', width: '11' },
  { title: '商户服务费总金额', debugtype: 'money', dataIndex: 'orderServiceAmount', width: '10' },
  { title: '平台结余总金额', debugtype: 'money', dataIndex: 'orderPlatformBalance', width: '10' },
  { title: '下单时间', dataIndex: 'orderPlacedDatetime', render: (text, record) => moment(record.orderPlacedDatetime).format('YYYY-MM-DD') },
  { title: '付款时间', dataIndex: 'orderPaymentDatetime', render: (text, record) => moment(record.orderPaymentDatetime).format('YYYY-MM-DD') },
  { title: '订单完成时间', dataIndex: 'orderFinishedDatetime', render: (text, record) => moment(record.orderFinishedDatetime).format('YYYY-MM-DD') },
