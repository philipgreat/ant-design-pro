...
export default class MainOrderAccountSearchForm extends PureComponent {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      mainOrderAccountList: 1,
      'mainOrderAccountList.searchField': fieldName,
      'mainOrderAccountList.searchVerb': 'startsWith',
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const params = {
        ...
        ...this.buildStringSearchParameters(fieldsValue, 'orderMerchantDiscount'),
