...
class MainOrderAccountEditTable extends PureComponent {
  ...
  { title: '产品名称', debugtype: 'string', dataIndex: 'productName', width: '18', render: (text, record) => renderStringEdit('productName',text, record)  },
  ...
  { title: '商户优惠', debugtype: 'string', dataIndex: 'orderMerchantDiscount', width: '9', render: (text, record) => renderStringEdit('orderMerchantDiscount',text, record)  },
