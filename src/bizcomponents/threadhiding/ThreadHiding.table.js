...
import styles from './ThreadHiding.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/threadHiding/${text}/dashboard`}>{text}</Link>) },
...
class ThreadHidingTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default ThreadHidingTable
