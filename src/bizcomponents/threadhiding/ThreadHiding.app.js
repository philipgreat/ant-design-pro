...
class ThreadHidingBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._threadHiding.partialList,
      owner: { type: '_threadHiding', id: state._threadHiding.id, referenceName: 'hiding', listName: 'threadList', ref:state._threadHiding, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
  ...
  getThreadUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_threadHiding', id: state._threadHiding.id, listName: 'threadList', ref:state._threadHiding, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadUpdateForm)
  }
