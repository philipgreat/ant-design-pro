...
import ThreadHidingTable from './ThreadHiding.table';
import ThreadHidingConfirmationTable from './ThreadHiding.confirmmationtable';

import ThreadHidingSearchForm from './ThreadHiding.searchform';
...
@Form.create()
export default class ThreadHidingSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      threadHidingList: 1,
      threadHidingListCurrentPage: pagination.current,
      threadHidingListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
