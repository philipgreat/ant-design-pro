...
import styles from './ThreadHiding.dashboard.less'
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="行动时间">
        {moment(threadHiding.actionTime).format('YYYY-MM-DD')}
      </Description>
          ...
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                contentHeight={46}
              >
                <Link to={`/threadHiding/${id}/list/threadList`}>
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link to={`/threadHiding/${id}/list/threadCreateForm`}>
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
                  />
