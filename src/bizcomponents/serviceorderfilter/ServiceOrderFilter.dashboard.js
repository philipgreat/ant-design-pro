...
const imageListOf = (serviceOrderFilter) =>{
...
const settingListOf = (serviceOrderFilter) =>{

	const optionList = [ 
	  {"title":'选中',"value":serviceOrderFilter.selected},
]
...
const largeTextOf = (serviceOrderFilter) =>{
...
class ServiceOrderFilterDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"服务单状态类型",cardsFor: "serviceOrderFilter",cardsSource: this.props.serviceOrderFilter,
  		subItems: [
