...
import ThreadReplyLikeTable from './ThreadReplyLike.table';
import ThreadReplyLikeConfirmationTable from './ThreadReplyLike.confirmmationtable';

import ThreadReplyLikeSearchForm from './ThreadReplyLike.searchform';
...
@Form.create()
export default class ThreadReplyLikeSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      threadReplyLikeList: 1,
      threadReplyLikeListCurrentPage: pagination.current,
      threadReplyLikeListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
