...
const columns = [
  ...
  { title: '修理员', debugtype: 'string', dataIndex: 'repairingWorkerName',},
  { title: '修理厂', debugtype: 'string', dataIndex: 'repairingCompanyName',},
  { title: '车牌号码', debugtype: 'string', dataIndex: 'vehicleLicensePlateNumber',},
  { title: '车辆维修服务单号', debugtype: 'string', dataIndex: 'vehicleRepairingOrderNumber',},
