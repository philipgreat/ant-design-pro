  ...
  render() {
    ...
    const columns = [
      { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        width: '36',
        render: (text, record) =>
          renderStringEdit('repairingWorkerName', text, record),
      },
      {
        title: '修理厂',
        debugtype: 'string',
        ...
        width: '27',
        render: (text, record) =>
          renderStringEdit('repairingCompanyName', text, record),
      },
      {
        title: '车牌号码',
        debugtype: 'string',
      ...
      },
      {
        ...
        width: '14',
        render: (text, record) =>
          renderStringEdit('vehicleRepairingOrderNumber', text, record),
      },
      {
        title: '订单合计',
      ...
      },
      {
        ...
        render: (text, record) =>
          moment(record.paymentDatetime).format('YYYY-MM-DD HH:mm:ss'),
      },
      {
        title: '微信订单ID',
        debugtype: 'string',
