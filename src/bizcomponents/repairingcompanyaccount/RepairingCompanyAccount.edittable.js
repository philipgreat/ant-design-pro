...
class RepairingCompanyAccountEditTable extends PureComponent {
  ...
  { title: '修理工人的名字', debugtype: 'string', dataIndex: 'repairingWorkerName', width: '36', render: (text, record) => renderStringEdit('repairingWorkerName',text, record)  },
  { title: '修理公司名称', debugtype: 'string', dataIndex: 'repairingCompanyName', width: '27', render: (text, record) => renderStringEdit('repairingCompanyName',text, record)  },
  ...
  { title: '车辆维修订单号', debugtype: 'string', dataIndex: 'vehicleRepairingOrderNumber', width: '14', render: (text, record) => renderStringEdit('vehicleRepairingOrderNumber',text, record)  },
  ...
  { title: '主要订单Id', debugtype: 'string', dataIndex: 'mainOrderId', width: '15', render: (text, record) => renderStringEdit('mainOrderId',text, record)  },
