...
const imageListOf = (repairingCompanyAccount) =>{
...
const settingListOf = (repairingCompanyAccount) =>{
...
const largeTextOf = (repairingCompanyAccount) =>{
...
class RepairingCompanyAccountDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"修理厂对账单",cardsFor: "repairingCompanyAccount",cardsSource: this.props.repairingCompanyAccount,
  		subItems: [
