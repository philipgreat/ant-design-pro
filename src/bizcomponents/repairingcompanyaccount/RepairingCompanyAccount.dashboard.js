...
<Description term="修理工人的名字">{repairingCompanyAccount.repairingWorkerName}</Description> 
<Description term="修理公司名称">{repairingCompanyAccount.repairingCompanyName}</Description> 
<Description term="车牌号码">{repairingCompanyAccount.vehicleLicensePlateNumber}</Description> 
<Description term="车辆维修订单号">{repairingCompanyAccount.vehicleRepairingOrderNumber}</Description> 
<Description term="原始金额">{repairingCompanyAccount.originalAmount}</Description> 
<Description term="补贴费用">{repairingCompanyAccount.allowanceAmount}</Description> 
<Description term="实际的数量">{repairingCompanyAccount.actualAmount}</Description> 
<Description term="主要订单Id">{repairingCompanyAccount.mainOrderId}</Description> 
...
<Description term="微信提前支付Id">{repairingCompanyAccount.wechatPrepayId}</Description> 
