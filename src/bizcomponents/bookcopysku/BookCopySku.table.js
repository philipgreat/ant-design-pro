...
const columns = [
  ...
  { title: '书的作者', debugtype: 'string', dataIndex: 'bookAuthor',},
  { title: '图书出版者', debugtype: 'string', dataIndex: 'bookPublisher',},
  ...
  { title: '书Isbn13', debugtype: 'string', dataIndex: 'bookIsbn13',},
  { title: '书Isbn10', debugtype: 'int', dataIndex: 'bookIsbn10',},
  { title: '书的地位', debugtype: 'string', dataIndex: 'bookStatus',},
  { title: '图书管理', dataIndex: 'bookManagement', render: (text, record) => (record.bookManagement ? record.bookManagement.displayName : '暂无') },


]

class BookCopySkuTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookCopySkuTable
