...
export default class AccountEditDetail extends Component {
  render() {
    ...
    const { serviceCompanyAccountList, repairingCompanyAccountList, insuranceServiceAccountList, mainOrderAccountList, inspectionStationAccountList } = this.props.account
    ...
    return (
      ...
      >
		...
		<Card title="年检订单对账单列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <MainOrderAccountEditTable data={mainOrderAccountList} owner={owner} {...this.props} />
          </Form>
        </Card>
