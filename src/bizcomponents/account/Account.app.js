  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/account/${objectId}/list/serviceCompanyAccountList`}>服务公司对账单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/account/${objectId}/list/repairingCompanyAccountList`}>修理公司对账单</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/account/${objectId}/list/insuranceServiceAccountList`}>保险服务帐户</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/account/${objectId}/list/mainOrderAccountList`}>主要以账户</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/account/${objectId}/list/inspectionStationAccountList`}>检查站对账单</Link>
        </Menu.Item>
      </SubMenu>
    )
  }
       ...
       <Layout>
         ...
         >
           ...
           >
             ...
             <Menu.Item >
               <Link to={`/account/${this.props.account.id}/editDetail`}><Icon type="edit" /><span>详情编辑</span></Link>
             </Menu.Item>
             <Menu.Item >
               <Link to={`/account/${this.props.account.id}/viewDetail`}><Icon type="eye-o" /><span>详情查看</span></Link>
             </Menu.Item>
