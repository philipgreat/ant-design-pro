...
export default {
    ...
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        const match = pathToRegexp(
          '/vehicleServiceCompany/:id/list/:listName/:listDisplayName'
        ).exec(pathname)
        if (!match) {
          return
  ...
  effects: {
    ...
    *addCompanyDiscount({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        VehicleServiceCompanyService.addCompanyDiscount,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *updateCompanyDiscount({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        VehicleServiceCompanyService.updateCompanyDiscount,
        id,
        parameters
      )
      if (hasError(data)) {
    ...
    *removeCompanyDiscountList({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters)
      const data = yield call(
        VehicleServiceCompanyService.removeCompanyDiscountList,
        id,
        parameters
      )
      if (hasError(data)) {
