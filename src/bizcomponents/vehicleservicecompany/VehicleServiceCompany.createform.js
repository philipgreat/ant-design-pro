...
const testValues = {
  ...
  longitude: '104.16356532463585',
  latitude: '32.44531241777704',
...
class VehicleServiceCompanyCreateForm extends Component {
  ...
  executeCandidateAddressCitySearch = filterKey => {
    ...
    const pageNo = 1
    const future = VehicleServiceCompanyService.requestCandidateAddressCity(
      'city',
      id,
      filterKey,
      pageNo
  ...
  executeCandidatePlatformSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = VehicleServiceCompanyService.requestCandidatePlatform(
