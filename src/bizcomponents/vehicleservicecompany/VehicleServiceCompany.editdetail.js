  ...
  render() {
    ...
    return (
      ...
      >
		...
		<Card title="上线检测支持的车牌号码类别列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <VehicleInspectionPlateNumberPatternEditTable data={vehicleInspectionPlateNumberPatternList} owner={owner} {...this.props} />
          </Form>
        </Card>

		<Card title="6年免检检测支持的车牌号码类别列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <FileInspectionPlateNumberPatternEditTable data={fileInspectionPlateNumberPatternList} owner={owner} {...this.props} />
          </Form>
        </Card>
		...
		<Card title="公司折扣列表" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <CompanyDiscountEditTable data={companyDiscountList} owner={owner} {...this.props} />
          </Form>
        </Card>
