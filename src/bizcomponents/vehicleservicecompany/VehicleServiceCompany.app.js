...
const menuData = {
  menuName: '商户',
  menuFor: 'vehicleServiceCompany',
  subItems: [
    { name: 'contractList', displayName: '合同' },
    {
      name: 'serviceCompanyAuthenticationInfoList',
      displayName: '商户认证信息',
    },
    {
      name: 'vehicleInspectionPlateNumberPatternList',
      displayName: '上线检测支持的车牌号码类别',
    },
    {
      name: 'fileInspectionPlateNumberPatternList',
      displayName: '6年免检检测支持的车牌号码类别',
    },
    {
    ...
    {
      name: 'companyQrcodePromotionRecordList',
      displayName: '公司二维码推广记录',
    },
...
class VehicleServiceCompanyBizApp extends React.PureComponent {
  ...
  getContractSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._vehicleServiceCompany,
  ...
  getVehicleInspectionPlateNumberPatternSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._vehicleServiceCompany,
        listDisplayName: '上线检测支持的车牌号码类别列表',
      }, // this is for model namespace and
  ...
  getFileInspectionPlateNumberPatternSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        ref: state._vehicleServiceCompany,
        listDisplayName: '6年免检检测支持的车牌号码类别列表',
      }, // this is for model namespace and
  ...
  getCompanyDiscountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompany.companyDiscountCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompany.companyDiscountSearchFormParameters,
      loading: state._vehicleServiceCompany.loading,
      owner: {
        type: '_vehicleServiceCompany',
        id: state._vehicleServiceCompany.id,
        listName: 'companyDiscountList',
        ref: state._vehicleServiceCompany,
        listDisplayName: '公司折扣列表',
      }, // this is for model namespace and
          ...
          <Layout>
            <Content style={{ margin: '24px 24px 0', height: '100%' }}>
              <Switch>
                ...
                <Route
                  path="/vehicleServiceCompany/:id/list/companyDiscountList"
                  component={this.getCompanyDiscountSearch()}
                />
                <Route
                  path="/vehicleServiceCompany/:id/list/companyDiscountCreateForm"
                  component={this.getCompanyDiscountCreateForm()}
                />
                <Route
                  path="/vehicleServiceCompany/:id/list/companyDiscountUpdateForm"
                  component={this.getCompanyDiscountUpdateForm()}
                />
