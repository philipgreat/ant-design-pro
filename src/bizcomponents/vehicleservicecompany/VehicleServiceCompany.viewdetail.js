  ...
  render() {
    ...
    const tabList = [
      { key: 'contractList', tab: `合同(${contractCount})` },
      {
        ...
        tab: `服务公司认证信息(${serviceCompanyAuthenticationInfoCount})`,
      },
      {
        key: 'vehicleInspectionPlateNumberPatternList',
        tab: `车辆检验牌照号码模式(${vehicleInspectionPlateNumberPatternCount})`,
      },
      {
        key: 'fileInspectionPlateNumberPatternList',
        tab: `6年免检牌照号码模式(${fileInspectionPlateNumberPatternCount})`,
      },
      {
      ...
      },
      {
        ...
        tab: `派单管理(${vehicleServiceCompanyDispatcherCount})`,
      },
      {
