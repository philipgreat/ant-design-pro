...
export default class VehicleServiceCompanyViewDetail extends Component {
  ...
  render() {
    ...
    const tabList = [
      ...
      {key: 'serviceCompanyAuthenticationInfoList',tab: `商户认证信息(${serviceCompanyAuthenticationInfoCount})`}, 
    ...
    const contentList = {
      ...
      companyDiscountList:  
        <CompanyDiscountViewTable data={companyDiscountList} owner={owner} {...this.props} />,
