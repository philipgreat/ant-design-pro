...
class VehicleServiceCompanyEditTable extends PureComponent {
  ...
  { title: '公司名称', debugtype: 'string', dataIndex: 'companyName', width: '12', render: (text, record) => renderStringEdit('companyName',text, record)  },
  ...
  { title: '公司形象1', dataIndex: 'companyImage1', render: (text, record) => <ImagePreview imageLocation={record.companyImage1} /> },
  { title: '公司形象2', dataIndex: 'companyImage2', render: (text, record) => <ImagePreview imageLocation={record.companyImage2} /> },
  { title: '公司形象3', dataIndex: 'companyImage3', render: (text, record) => <ImagePreview imageLocation={record.companyImage3} /> },
  { title: '公司形象4', dataIndex: 'companyImage4', render: (text, record) => <ImagePreview imageLocation={record.companyImage4} /> },
  { title: '公司形象5', dataIndex: 'companyImage5', render: (text, record) => <ImagePreview imageLocation={record.companyImage5} /> },
