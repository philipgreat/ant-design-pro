  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="公司照片1">
        <ImagePreview
          imageTitle="公司照片1"
          imageLocation={vehicleServiceCompany.companyImage1}
        />
      </Description>
      <Description term="公司照片2">
        <ImagePreview
          imageTitle="公司照片2"
          imageLocation={vehicleServiceCompany.companyImage2}
        />
      </Description>
      <Description term="公司照片3">
        <ImagePreview
          imageTitle="公司照片3"
          imageLocation={vehicleServiceCompany.companyImage3}
        />
      </Description>
      <Description term="公司照片4">
        <ImagePreview
          imageTitle="公司照片4"
          imageLocation={vehicleServiceCompany.companyImage4}
        />
      </Description>
      <Description term="公司照片5">
        <ImagePreview
          imageTitle="公司照片5"
          imageLocation={vehicleServiceCompany.companyImage5}
        />
      </Description>
      <Description term="推广二维码">
        <ImagePreview
          imageTitle="推广二维码"
          imageLocation={vehicleServiceCompany.promoteQrcodeImage}
        />
      </Description>
...
export default class VehicleServiceCompanyDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '商户',
      cardsFor: 'vehicleServiceCompany',
      cardsSource: this.props.vehicleServiceCompany,
      subItems: [
        {
          name: 'contractList',
          displayName: '合同',
        ...
        },
        {
          ...
          count: serviceCompanyAuthenticationInfoCount,
        },
        {
          name: 'vehicleInspectionPlateNumberPatternList',
          displayName: '上线检测支持的车牌号码类别',
          type: 'vehicleInspectionPlateNumberPattern',
          count: vehicleInspectionPlateNumberPatternCount,
        },
        {
          name: 'fileInspectionPlateNumberPatternList',
          displayName: '6年免检检测支持的车牌号码类别',
          type: 'fileInspectionPlateNumberPattern',
          count: fileInspectionPlateNumberPatternCount,
        },
        {
        ...
        },
        {
          ...
          count: companyQrcodePromotionRecordCount,
        },
        {
          name: 'vehicleServiceCompanyDispatcherList',
          displayName: '商户派单',
          type: 'vehicleServiceCompanyDispatcher',
          count: vehicleServiceCompanyDispatcherCount,
        },
        {
          name: 'companyDiscountList',
          displayName: '公司折扣',
          type: 'companyDiscount',
          count: companyDiscountCount,
        },
        {
        ...
        {
          name: 'vehicleInspectionOrderList',
          displayName: '年检订单',
          type: 'vehicleInspectionOrder',
          count: vehicleInspectionOrderCount,
        },
        {
