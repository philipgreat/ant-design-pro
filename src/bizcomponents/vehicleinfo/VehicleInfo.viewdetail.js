  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="行驶证图1">
        {vehicleInfo.vehiclePermitImage1}
      </Description>
      <Description term="行驶证图2">
        {vehicleInfo.vehiclePermitImage2}
      </Description>
      <Description term="行驶证图3">
        {vehicleInfo.vehiclePermitImage3}
      </Description>
      <Description term="行驶证图4">
        {vehicleInfo.vehiclePermitImage4}
      </Description>
      <Description term="行驶证图5">
        {vehicleInfo.vehiclePermitImage5}
      </Description>
