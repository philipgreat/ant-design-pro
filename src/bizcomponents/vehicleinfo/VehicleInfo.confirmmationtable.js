...
const columns = [
  ...
  { title: '检测有效期', debugtype: 'date', dataIndex: 'inspectionValidationDate', width: '14' },
  { title: '保险有效期', debugtype: 'date', dataIndex: 'insuranceValidationDate', width: '14' },
  ...
  { title: '行驶证有效期', debugtype: 'date', dataIndex: 'vehiclePermitExpirationDate', width: '14' },
