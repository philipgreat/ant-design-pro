  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="行驶证图1">
        <ImagePreview
          imageTitle="行驶证图1"
          imageLocation={vehicleInfo.vehiclePermitImage1}
        />
      </Description>
      <Description term="行驶证图2">
        <ImagePreview
          imageTitle="行驶证图2"
          imageLocation={vehicleInfo.vehiclePermitImage2}
        />
      </Description>
      <Description term="行驶证图3">
        <ImagePreview
          imageTitle="行驶证图3"
          imageLocation={vehicleInfo.vehiclePermitImage3}
        />
      </Description>
      <Description term="行驶证图4">
        <ImagePreview
          imageTitle="行驶证图4"
          imageLocation={vehicleInfo.vehiclePermitImage4}
        />
      </Description>
      <Description term="行驶证图5">
        <ImagePreview
          imageTitle="行驶证图5"
          imageLocation={vehicleInfo.vehiclePermitImage5}
        />
      </Description>
      <Description term="最后更新时间">
        {moment(vehicleInfo.lastUpdateTime).format('YYYY-MM-DD')}
      </Description>
    </DescriptionList>
  )
}
...
export default class VehicleInfoDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '车辆信息',
      cardsFor: 'vehicleInfo',
      cardsSource: this.props.vehicleInfo,
      subItems: [],
    }
