...
const imageListOf = (vehicleInspectionOrderCharge) =>{
...
const settingListOf = (vehicleInspectionOrderCharge) =>{
...
const largeTextOf = (vehicleInspectionOrderCharge) =>{
...
class VehicleInspectionOrderChargeDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"车辆检验订单费用",cardsFor: "vehicleInspectionOrderCharge",cardsSource: this.props.vehicleInspectionOrderCharge,
  		subItems: [
