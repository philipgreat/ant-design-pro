...
import styles from './VehicleInspectionOrderCharge.updateform.less'
...
class VehicleInspectionOrderChargeUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const vehicleInspectionOrderChargeId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, vehicleInspectionOrderChargeId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextVehicleInspectionOrderChargeUpdateRow`,
        payload: {
          id: owner.id,
          type: 'vehicleInspectionOrderCharge',
          selectedRows,
...
}))(Form.create()(VehicleInspectionOrderChargeUpdateForm))
