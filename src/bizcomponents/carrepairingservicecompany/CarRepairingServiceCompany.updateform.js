...
import styles from './CarRepairingServiceCompany.updateform.less';
...
class CarRepairingServiceCompanyUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carRepairingServiceCompanyId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carRepairingServiceCompanyId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarRepairingServiceCompany',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarRepairingServiceCompanyUpdateRow',
            payload: {
              id:owner.id,type:'carRepairingServiceCompany', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车维修服务公司"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车维修服务公司"
...
}))(Form.create()(CarRepairingServiceCompanyUpdateForm));
