...
class BookSharingPlatformBizApp extends React.PureComponent {
  ...
  getAvailableTokenSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_bookSharingPlatform', id: state._bookSharingPlatform.id, referenceName: 'bookSharingPlatform', listName: 'availableTokenList', ref:state._bookSharingPlatform, listDisplayName: '使用令牌列表' }, // this is for model namespace and
  ...
  getAvailableTokenUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_bookSharingPlatform', id: state._bookSharingPlatform.id, listName: 'availableTokenList', ref:state._bookSharingPlatform, listDisplayName: '使用令牌列表' }, // this is for model namespace and
  ...
  getPrinterSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._bookSharingPlatform.printerList,
      count: state._bookSharingPlatform.printerCount,
      currentPage: state._bookSharingPlatform.printerCurrentPageNumber,
      searchFormParameters: state._bookSharingPlatform.printerSearchFormParameters,
      loading: state._bookSharingPlatform.loading,
      partialList: state._bookSharingPlatform.partialList,
      owner: { type: '_bookSharingPlatform', id: state._bookSharingPlatform.id, referenceName: 'platform', listName: 'printerList', ref:state._bookSharingPlatform, listDisplayName: '打印机列表' }, // this is for model namespace and
    }))(PrinterSearch)
  }
  ...
  getPrinterUpdateForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._bookSharingPlatform.selectedRows,
      currentUpdateIndex: state._bookSharingPlatform.currentUpdateIndex,
      owner: { type: '_bookSharingPlatform', id: state._bookSharingPlatform.id, listName: 'printerList', ref:state._bookSharingPlatform, listDisplayName: '打印机列表' }, // this is for model namespace and
    }))(PrinterUpdateForm)
  }
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/bookSharingPlatform/:id/list/availableTokenList" component={this.getAvailableTokenSearch()} />
               <Route path="/bookSharingPlatform/:id/list/availableTokenCreateForm" component={this.getAvailableTokenCreateForm()} />
               <Route path="/bookSharingPlatform/:id/list/availableTokenUpdateForm" component={this.getAvailableTokenUpdateForm()} />
               ...
               <Route path="/bookSharingPlatform/:id/list/printerList" component={this.getPrinterSearch()} />
               <Route path="/bookSharingPlatform/:id/list/printerCreateForm" component={this.getPrinterCreateForm()} />
               <Route path="/bookSharingPlatform/:id/list/printerUpdateForm" component={this.getPrinterUpdateForm()} />
