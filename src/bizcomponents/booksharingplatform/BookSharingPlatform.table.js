...
import styles from './BookSharingPlatform.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/bookSharingPlatform/${text}/dashboard`}>{text}</Link>) },
...
class BookSharingPlatformTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default BookSharingPlatformTable
