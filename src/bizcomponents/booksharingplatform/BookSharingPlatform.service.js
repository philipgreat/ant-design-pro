...
const addPrinter = (targetObjectId, parameters) => {
  const url = `${PREFIX}bookSharingPlatformManager/addPrinter/platformId/name/location/tokensExpr/`
  const requestParameters = { ...parameters, tokensExpr: 'none' }
...
const updatePrinter = (targetObjectId, parameters) => {
  const url = `${PREFIX}bookSharingPlatformManager/updatePrinterProperties/bookSharingPlatformId/id/name/location/tokensExpr/`
  const bookSharingPlatformId = targetObjectId
  const requestParameters = { ...parameters, bookSharingPlatformId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
...
const removePrinterList = (targetObjectId, parameters) => {
  const url = `${PREFIX}bookSharingPlatformManager/removePrinterList/bookSharingPlatformId/printerIds/tokensExpr/`
  const requestParameters = { ...parameters, bookSharingPlatformId: targetObjectId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
    url,
...
const addCustomer = (targetObjectId, parameters) => {
  const url = `${PREFIX}bookSharingPlatformManager/addCustomer/platformId/nickName/logoImage/miniProgramOpenid/serviceAcountOpenid/wechatUnionId/longitude/latitude/mobileNumber/memberLevelTitle/memberLevelCode/memberLevelExpireDate/tokensExpr/`
  const requestParameters = { ...parameters, tokensExpr: 'none' }
...
const updateCustomer = (targetObjectId, parameters) => {
  const url = `${PREFIX}bookSharingPlatformManager/updateCustomerProperties/bookSharingPlatformId/id/nickName/logoImage/miniProgramOpenid/serviceAcountOpenid/wechatUnionId/longitude/latitude/mobileNumber/memberLevelTitle/memberLevelCode/memberLevelExpireDate/tokensExpr/`
  const bookSharingPlatformId = targetObjectId
  const requestParameters = { ...parameters, bookSharingPlatformId, tokensExpr: 'none' }
  const headers = { 'Content-Type': 'application/x-www-form-urlencoded' }
  return post({
