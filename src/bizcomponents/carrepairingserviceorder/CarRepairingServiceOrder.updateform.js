...
import styles from './CarRepairingServiceOrder.updateform.less';
...
carRepairReceiving: '汽车维修接待',
carRepairWorking: '汽车修理工作',
carRepairReturning: '汽车维修返回',
currentStatus: '当前状态',
...
class CarRepairingServiceOrderUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carRepairingServiceOrderId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carRepairingServiceOrderId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarRepairingServiceOrder',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarRepairingServiceOrderUpdateRow',
            payload: {
              id:owner.id,type:'carRepairingServiceOrder', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新汽车修理服务单"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新汽车修理服务单"
...
}))(Form.create()(CarRepairingServiceOrderUpdateForm));
