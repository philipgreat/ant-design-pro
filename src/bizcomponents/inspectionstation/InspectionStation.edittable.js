...
class InspectionStationEditTable extends PureComponent {
  ...
  { title: '联系人手机', debugtype: 'string_china_mobile_phone', dataIndex: 'contactMobile', width: '15', render: (text, record) => renderStringEdit('contactMobile',text, record)  },
  { title: '计量资格认证', dataIndex: 'metrologyAccreditationImage', render: (text, record) => <ImagePreview imageLocation={record.metrologyAccreditationImage} /> },
{ title: '操作',
