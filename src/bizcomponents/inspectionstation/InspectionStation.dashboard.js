  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="服务状态">
        {inspectionStation.operatingStatus}
      </Description>
      <Description term="所在地址">
        {inspectionStation.addressDetail}
      </Description>
      ...
      <Description term="联系人姓名">
        {inspectionStation.contactName}
      </Description>
      <Description term="联系人手机">
        {inspectionStation.contactMobile}
      </Description>
      <Description term="计量资格认证">
        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/inspectionStation/${id}/list/vehicleServiceCompanyEmployeeList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/inspectionStation/${id}/list/vehicleServiceCompanyEmployeeCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/inspectionStation/${id}/list/serviceVehicleInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/inspectionStation/${id}/list/serviceVehicleInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/inspectionStation/${id}/list/serviceFileInspectionList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/inspectionStation/${id}/list/serviceFileInspectionCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/inspectionStation/${id}/list/inspectionStationAccountList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/inspectionStation/${id}/list/inspectionStationAccountCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
