...
class InspectionStationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/inspectionStation/${objectId}/list/vehicleServiceCompanyEmployeeList`}
          >
            商户员工
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/inspectionStation/${objectId}/list/serviceVehicleInspectionList`}
          >
            车辆上线检测
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/inspectionStation/${objectId}/list/serviceFileInspectionList`}
          >
            6年免检服务
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/inspectionStation/${objectId}/list/inspectionStationAccountList`}
          >
            检测站对账单
          </Link>
        </Menu.Item>
  ...
  getVehicleServiceCompanyEmployeeSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._inspectionStation.vehicleServiceCompanyEmployeeCurrentPageNumber,
      searchFormParameters:
        state._inspectionStation
          .vehicleServiceCompanyEmployeeSearchFormParameters,
      loading: state._inspectionStation.loading,
      owner: {
        type: '_inspectionStation',
        id: state._inspectionStation.id,
  ...
  getServiceVehicleInspectionSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._inspectionStation.serviceVehicleInspectionCurrentPageNumber,
      searchFormParameters:
        state._inspectionStation.serviceVehicleInspectionSearchFormParameters,
      loading: state._inspectionStation.loading,
      owner: {
        type: '_inspectionStation',
        id: state._inspectionStation.id,
  ...
  getServiceFileInspectionSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._inspectionStation.serviceFileInspectionCurrentPageNumber,
      searchFormParameters:
        state._inspectionStation.serviceFileInspectionSearchFormParameters,
      loading: state._inspectionStation.loading,
      owner: {
        type: '_inspectionStation',
        id: state._inspectionStation.id,
  ...
  getInspectionStationAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._inspectionStation.inspectionStationAccountCurrentPageNumber,
      searchFormParameters:
        state._inspectionStation.inspectionStationAccountSearchFormParameters,
      loading: state._inspectionStation.loading,
      owner: {
        type: '_inspectionStation',
        id: state._inspectionStation.id,
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/inspectionStation/${
                  this.props.inspectionStation.id
                }/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/inspectionStation/:id/dashboard"
                component={InspectionStationDashboard}
              />

              <Route
                path="/inspectionStation/:id/editDetail"
                component={InspectionStationEditDetail}
              />
              <Route
                path="/inspectionStation/:id/viewDetail"
                component={InspectionStationViewDetail}
              />

              <Route
                path="/inspectionStation/:id/list/vehicleServiceCompanyEmployeeList"
                component={this.getVehicleServiceCompanyEmployeeSearch()}
              />
              <Route
                path="/inspectionStation/:id/list/vehicleServiceCompanyEmployeeCreateForm"
                component={this.getVehicleServiceCompanyEmployeeCreateForm()}
              />
              <Route
                path="/inspectionStation/:id/list/vehicleServiceCompanyEmployeeUpdateForm"
                component={this.getVehicleServiceCompanyEmployeeUpdateForm()}
              />

              <Route
                path="/inspectionStation/:id/list/serviceVehicleInspectionList"
                component={this.getServiceVehicleInspectionSearch()}
              />
              <Route
                path="/inspectionStation/:id/list/serviceVehicleInspectionCreateForm"
                component={this.getServiceVehicleInspectionCreateForm()}
              />
              <Route
                path="/inspectionStation/:id/list/serviceVehicleInspectionUpdateForm"
                component={this.getServiceVehicleInspectionUpdateForm()}
              />

              <Route
                path="/inspectionStation/:id/list/serviceFileInspectionList"
                component={this.getServiceFileInspectionSearch()}
              />
              <Route
                path="/inspectionStation/:id/list/serviceFileInspectionCreateForm"
                component={this.getServiceFileInspectionCreateForm()}
              />
              <Route
                path="/inspectionStation/:id/list/serviceFileInspectionUpdateForm"
                component={this.getServiceFileInspectionUpdateForm()}
              />

              <Route
                path="/inspectionStation/:id/list/inspectionStationAccountList"
                component={this.getInspectionStationAccountSearch()}
              />
              <Route
                path="/inspectionStation/:id/list/inspectionStationAccountCreateForm"
                component={this.getInspectionStationAccountCreateForm()}
              />
              <Route
                path="/inspectionStation/:id/list/inspectionStationAccountUpdateForm"
