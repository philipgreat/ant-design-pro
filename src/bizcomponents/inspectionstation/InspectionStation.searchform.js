...
@Form.create()
export default class InspectionStationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      ...
      'inspectionStationList.searchField': fieldName,
      'inspectionStationList.searchVerb': 'startsWith',
      'inspectionStationList.searchValue': fieldValue,
    }
  }
  handleSearch = (e) => {
    e.preventDefault()
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, parameters: params, inspectionStationSearchFormParameters: fieldsValue },
      })
    })
  }
