  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="年检报告1">
        <ImagePreview
          imageTitle="年检报告1"
          imageLocation={serviceVehicleRepairing.inspectionReportImage1}
        />
      </Description>
      <Description term="年检报告2">
        <ImagePreview
          imageTitle="年检报告2"
          imageLocation={serviceVehicleRepairing.inspectionReportImage2}
        />
      </Description>
      <Description term="年检报告3">
        <ImagePreview
          imageTitle="年检报告3"
          imageLocation={serviceVehicleRepairing.inspectionReportImage3}
        />
      </Description>
      <Description term="年检报告4">
        <ImagePreview
          imageTitle="年检报告4"
          imageLocation={serviceVehicleRepairing.inspectionReportImage4}
        />
      </Description>
      <Description term="年检报告5">
        <ImagePreview
          imageTitle="年检报告5"
          imageLocation={serviceVehicleRepairing.inspectionReportImage5}
        />
      </Description>
      <Description term="车辆维修报价单1">
        <ImagePreview
          imageTitle="车辆维修报价单1"
          imageLocation={serviceVehicleRepairing.repairingQuotationImage1}
        />
      </Description>
      <Description term="车辆维修报价单2">
        <ImagePreview
          imageTitle="车辆维修报价单2"
          imageLocation={serviceVehicleRepairing.repairingQuotationImage2}
        />
      </Description>
      <Description term="车辆维修报价单3">
        <ImagePreview
          imageTitle="车辆维修报价单3"
          imageLocation={serviceVehicleRepairing.repairingQuotationImage3}
        />
      </Description>
      <Description term="车辆维修报价单4">
        <ImagePreview
          imageTitle="车辆维修报价单4"
          imageLocation={serviceVehicleRepairing.repairingQuotationImage4}
        />
      </Description>
      <Description term="车辆维修报价单5">
        <ImagePreview
          imageTitle="车辆维修报价单5"
          imageLocation={serviceVehicleRepairing.repairingQuotationImage5}
        />
      </Description>
      ...
      <Description term="车辆维修部分图片1">
        <ImagePreview
          imageTitle="车辆维修部分图片1"
          imageLocation={serviceVehicleRepairing.repairingPartImg1}
        />
      </Description>
      <Description term="车辆维修部分图片2">
        <ImagePreview
          imageTitle="车辆维修部分图片2"
          imageLocation={serviceVehicleRepairing.repairingPartImg2}
        />
      </Description>
      <Description term="车辆维修部分图片3">
        <ImagePreview
          imageTitle="车辆维修部分图片3"
          imageLocation={serviceVehicleRepairing.repairingPartImg3}
        />
      </Description>
      <Description term="车辆维修部分图片4">
        <ImagePreview
          imageTitle="车辆维修部分图片4"
          imageLocation={serviceVehicleRepairing.repairingPartImg4}
        />
      </Description>
      <Description term="车辆维修部分图片5">
        <ImagePreview
          imageTitle="车辆维修部分图片5"
          imageLocation={serviceVehicleRepairing.repairingPartImg5}
        />
      </Description>
...
export default class ServiceVehicleRepairingDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '维修服务',
      cardsFor: 'serviceVehicleRepairing',
      cardsSource: this.props.serviceVehicleRepairing,
      subItems: [
        {
          name: 'repairingAllowanceItemList',
          displayName: '车辆维修补贴项',
          type: 'repairingAllowanceItem',
          count: repairingAllowanceItemCount,
        },
        {
          name: 'vehicleRepairingPaymentList',
          displayName: '支付维修订单',
          type: 'vehicleRepairingPayment',
          count: vehicleRepairingPaymentCount,
        },
      ],
    }
