        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/reportVehicleInspectionReportList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/reportVehicleInspectionReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/repairingAllowanceItemList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/repairingAllowanceItemCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/vehicleRepairingPaymentList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/vehicleRepairingPaymentCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/vehicleRepairingReportList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleRepairing/${id}/list/vehicleRepairingReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
