...
export default class ServiceVehicleRepairingSearch extends PureComponent {
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      serviceVehicleRepairingList: 1,
      serviceVehicleRepairingListCurrentPage: pagination.current,
      serviceVehicleRepairingListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
