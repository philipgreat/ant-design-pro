...
class ServiceVehicleRepairingBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/serviceVehicleRepairing/${objectId}/list/reportVehicleInspectionReportList`}>车辆检验报告</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/serviceVehicleRepairing/${objectId}/list/repairingQuotationList`}>维修报价</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/serviceVehicleRepairing/${objectId}/list/repairingAllowanceItemList`}>修补贴项目</Link>
        </Menu.Item>
        <Menu.Item>
  ...
  getRepairingAllowanceItemSearch = () => {
    ...
    return connect(state => ({
      ...
      loading: state._serviceVehicleRepairing.loading,
      owner: { type: '_serviceVehicleRepairing', id: state._serviceVehicleRepairing.id, listName: 'repairingAllowanceItemList' }, // this is for model namespace and
