...
const menuData = {
  menuName: '维修服务',
  menuFor: 'serviceVehicleRepairing',
  subItems: [
...
const displayColumns = [
  {
    ...
    width: '20',
    render: (text, record) => (
      <Link to={`/serviceVehicleRepairing/${text}/dashboard`}>{text}</Link>
    ),
  },
  {
    title: '服务状态',
  ...
  },
  {
    ...
    render: (text, record) =>
      record.serviceVehicleInspection
        ? record.serviceVehicleInspection.displayName
        : '暂无',
  },
  {
    title: '商户',
...
const ServiceVehicleRepairingBase = { menuData, displayColumns, fieldLabels }
