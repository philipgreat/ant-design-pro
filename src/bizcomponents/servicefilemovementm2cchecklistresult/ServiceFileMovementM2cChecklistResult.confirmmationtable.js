...
class ServiceFileMovementM2cChecklistResultConfirmationTable extends PureComponent {
  render() {
...
export default ServiceFileMovementM2cChecklistResultConfirmationTable
