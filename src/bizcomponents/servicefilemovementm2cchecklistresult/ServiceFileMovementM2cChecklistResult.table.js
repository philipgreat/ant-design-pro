...
import styles from './ServiceFileMovementM2cChecklistResult.table.less'
import ImagePreview from '../../components/ImagePreview'


const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20' },
  { title: '服务', dataIndex: 'service', render: (text, record) => (record.service ? (<Link to={`/serviceFileMovementM2c/${record.service.id}/dashboard`}>{record.service.id}</Link>) : '暂无') },
...
class ServiceFileMovementM2cChecklistResultTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default ServiceFileMovementM2cChecklistResultTable
