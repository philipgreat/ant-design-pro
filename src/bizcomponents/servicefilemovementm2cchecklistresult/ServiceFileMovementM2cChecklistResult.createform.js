...
import styles from './ServiceFileMovementM2cChecklistResult.createform.less'
...
class ServiceFileMovementM2cChecklistResultCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/addServiceFileMovementM2cChecklistResult`,
          payload: { id: owner.id, type: 'serviceFileMovementM2cChecklistResult', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(ServiceFileMovementM2cChecklistResultCreateForm))
