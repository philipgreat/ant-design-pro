...
import styles from './ServiceFileMovementM2cChecklistResult.updateform.less'
...
class ServiceFileMovementM2cChecklistResultUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const serviceFileMovementM2cChecklistResultId = values.id
        const imagesValues = this.mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, serviceFileMovementM2cChecklistResultId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextServiceFileMovementM2cChecklistResultUpdateRow`,
        payload: {
          id: owner.id,
          type: 'serviceFileMovementM2cChecklistResult',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新还件服务检查结果"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新还件服务检查结果"
...
}))(Form.create()(ServiceFileMovementM2cChecklistResultUpdateForm))
