...
<Description term="图1"><ImagePreview imageTitle="图1" imageLocation={vehiclePermit.image1}/></Description> 
<Description term="图2"><ImagePreview imageTitle="图2" imageLocation={vehiclePermit.image2}/></Description> 
<Description term="图3"><ImagePreview imageTitle="图3" imageLocation={vehiclePermit.image3}/></Description> 
<Description term="图4"><ImagePreview imageTitle="图4" imageLocation={vehiclePermit.image4}/></Description> 
<Description term="图5"><ImagePreview imageTitle="图5" imageLocation={vehiclePermit.image5}/></Description> 
...
export default class VehiclePermitDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"行驶证",cardsFor: "vehiclePermit",cardsSource: this.props.vehiclePermit,
  		subItems: [
