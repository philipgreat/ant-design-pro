        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleMovementC2m/${id}/list/serviceVehicleMovementC2mChecklistResultList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleMovementC2m/${id}/list/serviceVehicleMovementC2mChecklistResultCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
