...
export default class ServiceVehicleMovementC2mViewDetail extends Component {
  ...
  render() {
    ...
    const tabList = [
      ...
      {key: 'serviceVehicleMovementC2mChecklistResultList',tab: `收车检车结果(${serviceVehicleMovementC2mChecklistResultCount})`}, 
    ...
    const contentList = {
       serviceVehicleMovementC2mChecklistResultList:  
        <ServiceVehicleMovementC2mChecklistResultViewTable data={serviceVehicleMovementC2mChecklistResultList} owner={owner} {...this.props} />,
