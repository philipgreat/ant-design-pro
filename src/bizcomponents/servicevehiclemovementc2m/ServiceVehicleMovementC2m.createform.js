...
const testValues = {
  ...
  startTime: '2996-01-15 09:13:31',
  longitude: '105.24733994395788',
  latitude: '32.06374011510353',
  transferVerifyCode: 'O12345',
  movementPurpose: 'VEHICLE_C2M_RECEIVE_IN_STORE',
  contactName: '张秋文',
  contactMobileNumber: '13812345678',
  notifyDatetime: '2995-11-08 18:18:32',
...
class ServiceVehicleMovementC2mCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = ServiceVehicleMovementC2mService.requestCandidateResponsibleWorker(
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleMovementC2mService.requestCandidateMainOrder(
  ...
  executeCandidateMerchantSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleMovementC2mService.requestCandidateMerchant(
