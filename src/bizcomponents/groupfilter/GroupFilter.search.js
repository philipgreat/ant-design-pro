...
import GroupFilterTable from './GroupFilter.table';
import GroupFilterConfirmationTable from './GroupFilter.confirmmationtable';

import GroupFilterSearchForm from './GroupFilter.searchform';
...
@Form.create()
export default class GroupFilterSearch extends PureComponent {
 state = {
    addInputValue: '',
    modalVisible: false,
    expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      groupFilterList:1,
      groupFilterListCurrentPage: pagination.current,
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: {id:owner.id,type:'groupFilter',selectedRows},
    });
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <GroupFilterSearchForm {...this.props}/>
            </div>
