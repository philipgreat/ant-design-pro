...
class VehicleServiceCompanyEmployeeBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (objectId) => {
    return (
      ...
      >
        ...
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/serviceOrderFilterList`}>服务订单过滤器</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/employeeDrivingLicenseList`}>员工驾驶证</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/companyEmployeeMessageListAsSender`}>消息管理</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/companyEmployeeMessageListAsReceiver`}>消息管理</Link>
        </Menu.Item>
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/vehicleInspectionOrderServiceLogList`}>车辆检测服务订单日志</Link>
        </Menu.Item>
        <Menu.Item>
        ...
        <Menu.Item>
          <Link to={`/vehicleServiceCompanyEmployee/${objectId}/list/serviceInsuranceForInspectionList`}>保险增值服务</Link>
        </Menu.Item>
        <Menu.Item>
  ...
  getCompanyEmployeeMessageAsSenderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._vehicleServiceCompanyEmployee.companyEmployeeMessageListAsSender,
      count: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsSenderCount,
      currentPage: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsSenderCurrentPageNumber,
      searchFormParameters: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsSenderSearchFormParameters,
      loading: state._vehicleServiceCompanyEmployee.loading,
      owner: { type: '_vehicleServiceCompanyEmployee', id: state._vehicleServiceCompanyEmployee.id, listName: 'companyEmployeeMessageListAsSender' }, // this is for model namespace and
  ...
  getCompanyEmployeeMessageAsReceiverSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      data: state._vehicleServiceCompanyEmployee.companyEmployeeMessageListAsReceiver,
      count: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsReceiverCount,
      currentPage: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsReceiverCurrentPageNumber,
      searchFormParameters: state._vehicleServiceCompanyEmployee.companyEmployeeMessageAsReceiverSearchFormParameters,
      loading: state._vehicleServiceCompanyEmployee.loading,
      owner: { type: '_vehicleServiceCompanyEmployee', id: state._vehicleServiceCompanyEmployee.id, listName: 'companyEmployeeMessageListAsReceiver' }, // this is for model namespace and
    }))(CompanyEmployeeMessageSearch)
  }
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageListAsSender" component={this.getCompanyEmployeeMessageAsSenderSearch()} />
               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageAsSenderCreateForm" component={this.getCompanyEmployeeMessageAsSenderCreateForm()} />
               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageAsSenderUpdateForm" component={this.getCompanyEmployeeMessageAsSenderUpdateForm()} />

               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageListAsReceiver" component={this.getCompanyEmployeeMessageAsReceiverSearch()} />
               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageAsReceiverCreateForm" component={this.getCompanyEmployeeMessageAsReceiverCreateForm()} />
               <Route path="/vehicleServiceCompanyEmployee/:id/list/companyEmployeeMessageAsReceiverUpdateForm" component={this.getCompanyEmployeeMessageAsReceiverUpdateForm()} />
