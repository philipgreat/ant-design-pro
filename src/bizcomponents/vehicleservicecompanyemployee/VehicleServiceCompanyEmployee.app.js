...
class VehicleServiceCompanyEmployeeBizApp extends React.PureComponent {
  ...
  getNavMenuItems = objectId => {
    return (
      ...
      >
        <Menu.Item>
          <Link
            to={`/vehicleServiceCompanyEmployee/${objectId}/list/serviceOrderFilterList`}
          >
            服务订单过滤器
          </Link>
        </Menu.Item>
        ...
        <Menu.Item>
          <Link
            to={`/vehicleServiceCompanyEmployee/${objectId}/list/serviceCompanyAccountList`}
          >
            服务公司对账单
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleServiceCompanyEmployee/${objectId}/list/repairingCompanyAccountList`}
          >
            修理公司对账单
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleServiceCompanyEmployee/${objectId}/list/insuranceServiceAccountList`}
          >
            保险服务帐户
          </Link>
        </Menu.Item>
        <Menu.Item>
          <Link
            to={`/vehicleServiceCompanyEmployee/${objectId}/list/inspectionStationAccountList`}
          >
            检查站对账单
          </Link>
        </Menu.Item>
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompanyEmployee
          .serviceOrderFilterCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompanyEmployee
          .serviceOrderFilterSearchFormParameters,
      ...
      owner: {
        ...
        listName: 'serviceOrderFilterList',
  ...
  getServiceCompanyAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompanyEmployee
          .serviceCompanyAccountCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompanyEmployee
          .serviceCompanyAccountSearchFormParameters,
      loading: state._vehicleServiceCompanyEmployee.loading,
      owner: {
        type: '_vehicleServiceCompanyEmployee',
        id: state._vehicleServiceCompanyEmployee.id,
  ...
  getRepairingCompanyAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompanyEmployee
          .repairingCompanyAccountCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompanyEmployee
  ...
  getInsuranceServiceAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompanyEmployee
          .insuranceServiceAccountCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompanyEmployee
  ...
  getInspectionStationAccountSearch = () => {
    ...
    return connect(state => ({
      ...
      currentPage:
        state._vehicleServiceCompanyEmployee
          .inspectionStationAccountCurrentPageNumber,
      searchFormParameters:
        state._vehicleServiceCompanyEmployee
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              ...
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceOrderFilterList"
                component={this.getServiceOrderFilterSearch()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceOrderFilterCreateForm"
                component={this.getServiceOrderFilterCreateForm()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceOrderFilterUpdateForm"
                component={this.getServiceOrderFilterUpdateForm()}
              />
              ...
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceCompanyAccountList"
                component={this.getServiceCompanyAccountSearch()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceCompanyAccountCreateForm"
                component={this.getServiceCompanyAccountCreateForm()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/serviceCompanyAccountUpdateForm"
                component={this.getServiceCompanyAccountUpdateForm()}
              />

              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/repairingCompanyAccountList"
                component={this.getRepairingCompanyAccountSearch()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/repairingCompanyAccountCreateForm"
                component={this.getRepairingCompanyAccountCreateForm()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/repairingCompanyAccountUpdateForm"
                component={this.getRepairingCompanyAccountUpdateForm()}
              />

              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/insuranceServiceAccountList"
                component={this.getInsuranceServiceAccountSearch()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/insuranceServiceAccountCreateForm"
                component={this.getInsuranceServiceAccountCreateForm()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/insuranceServiceAccountUpdateForm"
                component={this.getInsuranceServiceAccountUpdateForm()}
              />

              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/inspectionStationAccountList"
                component={this.getInspectionStationAccountSearch()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/inspectionStationAccountCreateForm"
                component={this.getInspectionStationAccountCreateForm()}
              />
              <Route
                path="/vehicleServiceCompanyEmployee/:id/list/inspectionStationAccountUpdateForm"
