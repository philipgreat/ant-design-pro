...
<Description term="证件照片"><ImagePreview imageTitle="证件照片" imageLocation={vehicleServiceCompanyEmployee.profileImage}/></Description> 
...
<Description term="无犯罪记录证明"><ImagePreview imageTitle="无犯罪记录证明" imageLocation={vehicleServiceCompanyEmployee.innocentEvidenceImage}/></Description> 
