...
const menuData = {menuName:"商户员工", menuFor: "vehicleServiceCompanyEmployee",
  ...
  {name: 'serviceVehicleMovementM2mListAsResponsibleWorker', displayName:'移车服务'},
  {name: 'serviceVehicleMovementM2mListAsDriver', displayName:'移车服务'},
  {name: 'serviceVehicleMovementM2mListAsReceiver', displayName:'移车服务'},
  {name: 'serviceVehicleMovementM2cList', displayName:'还车服务'},
  {name: 'serviceFileMovementC2mList', displayName:'收件服务'},
  {name: 'serviceFileMovementM2mListAsResponsibleWorker', displayName:'移件服务'},
...
const VehicleServiceCompanyEmployeeBase={menuData,displayColumns,fieldLabels}
