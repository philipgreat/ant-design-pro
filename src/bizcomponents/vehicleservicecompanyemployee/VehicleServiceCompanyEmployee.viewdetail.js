...
export default class VehicleServiceCompanyEmployeeViewDetail extends Component {
  ...
  render() {
    ...
    const vehicleServiceCompanyEmployee = this.props
    ...
    const tabList = [
      {
        key: 'serviceOrderFilterList',
        tab: `服务订单过滤器(${serviceOrderFilterCount})`,
      },
      {
        key: 'employeeDrivingLicenseList',
        tab: `员工驾驶证(${employeeDrivingLicenseCount})`,
      },
      {
        key: 'companyEmployeeMessageListAsSender',
        tab: `消息管理(${companyEmployeeMessageAsSenderCount})`,
      },
      {
        key: 'companyEmployeeMessageListAsReceiver',
        tab: `消息管理(${companyEmployeeMessageAsReceiverCount})`,
      },
      {
      ...
      {
        key: 'serviceVehicleMovementM2mListAsResponsibleWorker',
        tab: `移车服务(${serviceVehicleMovementM2mAsResponsibleWorkerCount})`,
      },
      {
        key: 'serviceVehicleMovementM2mListAsDriver',
        tab: `移车服务(${serviceVehicleMovementM2mAsDriverCount})`,
      },
      {
        key: 'serviceVehicleMovementM2mListAsReceiver',
        tab: `移车服务(${serviceVehicleMovementM2mAsReceiverCount})`,
      },
      {
      ...
      {
        key: 'serviceFileMovementM2mListAsResponsibleWorker',
        tab: `移件服务(${serviceFileMovementM2mAsResponsibleWorkerCount})`,
      },
      {
        key: 'serviceFileMovementM2mListAsSender',
        tab: `移件服务(${serviceFileMovementM2mAsSenderCount})`,
      },
      {
        key: 'serviceFileMovementM2mListAsReceiver',
        tab: `移件服务(${serviceFileMovementM2mAsReceiverCount})`,
      },
      {
      ...
      },
      {
        ...
        tab: `保险增值服务(${serviceInsuranceForInspectionCount})`,
      },
      {
      ...
      },
      {
        ...
        tab: `修车服务(${serviceVehicleRepairingCount})`,
      },
      {
        key: 'serviceCompanyAccountList',
        tab: `服务公司对账单(${serviceCompanyAccountCount})`,
      },
      {
        key: 'repairingCompanyAccountList',
        tab: `修理公司对账单(${repairingCompanyAccountCount})`,
      },
      {
        key: 'insuranceServiceAccountList',
        tab: `保险服务帐户(${insuranceServiceAccountCount})`,
      },
      {
        key: 'inspectionStationAccountList',
        tab: `检查站对账单(${inspectionStationAccountCount})`,
      },
    ]
    ...
    const contentList = {
      ...
      companyEmployeeMessageListAsReceiver: (
        <CompanyEmployeeMessageViewTable
          data={companyEmployeeMessageListAsReceiver}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceVehicleMovementM2mListAsResponsibleWorker: (
        <ServiceVehicleMovementM2mViewTable
          data={serviceVehicleMovementM2mListAsResponsibleWorker}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceVehicleMovementM2mListAsDriver: (
        <ServiceVehicleMovementM2mViewTable
          data={serviceVehicleMovementM2mListAsDriver}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceVehicleMovementM2mListAsReceiver: (
        <ServiceVehicleMovementM2mViewTable
          data={serviceVehicleMovementM2mListAsReceiver}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceFileMovementM2mListAsResponsibleWorker: (
        <ServiceFileMovementM2mViewTable
          data={serviceFileMovementM2mListAsResponsibleWorker}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceFileMovementM2mListAsSender: (
        <ServiceFileMovementM2mViewTable
          data={serviceFileMovementM2mListAsSender}
          owner={owner}
          {...this.props}
        />
      ),
      ...
      serviceFileMovementM2mListAsReceiver: (
        <ServiceFileMovementM2mViewTable
          data={serviceFileMovementM2mListAsReceiver}
          owner={owner}
          {...this.props}
        />
      ),
    ...
    const steps = (
      <Steps direction={'horizontal'} current={1}>
        <Step
          title="资格"
          description={actionDescForQualification(
            vehicleServiceCompanyEmployee
          )}
        />
        <Step
          title="服务"
          description={actionDescForServing(vehicleServiceCompanyEmployee)}
        />
        <Step
          title="终止"
          description={actionDescForTermination(vehicleServiceCompanyEmployee)}
        />
      </Steps>
    )
