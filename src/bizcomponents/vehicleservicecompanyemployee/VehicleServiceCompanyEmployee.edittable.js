...
class VehicleServiceCompanyEmployeeEditTable extends PureComponent {
  ...
  { title: '员工姓名', debugtype: 'string', dataIndex: 'employeeName', width: '7', render: (text, record) => renderStringEdit('employeeName',text, record)  },
  { title: '证件照片', dataIndex: 'profileImage', render: (text, record) => <ImagePreview imageLocation={record.profileImage} /> },
  { title: '商户名称', debugtype: 'string', dataIndex: 'companyName', width: '27', render: (text, record) => renderStringEdit('companyName',text, record)  },
  { title: '手机号码', debugtype: 'string_china_mobile_phone', dataIndex: 'mobileNumber', width: '15', render: (text, record) => renderStringEdit('mobileNumber',text, record)  },
