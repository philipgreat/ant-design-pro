...
class VehicleServiceCompanyEmployeeEditTable extends PureComponent {
  ...
  { title: '员工的名字', debugtype: 'string', dataIndex: 'employeeName', width: '7', render: (text, record) => renderStringEdit('employeeName',text, record)  },
  { title: '证件照片', dataIndex: 'profileImage', render: (text, record) => <ImagePreview imageLocation={record.证件照片} /> },
  ...
  { title: '无犯罪记录证明', dataIndex: 'innocentEvidenceImage', render: (text, record) => <ImagePreview imageLocation={record.无犯罪记录证明} /> },
