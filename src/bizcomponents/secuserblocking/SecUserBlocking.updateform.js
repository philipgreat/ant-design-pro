...
class SecUserBlockingUpdateForm extends PureComponent {
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form layout="vertical" hideRequiredMark>
            <Row gutter={16}>
             ...
             <Col lg={6} md={12} sm={24}>
                <Form.Item label={fieldLabels.blockTime}>
                  {getFieldDecorator('blockTime', {
                    rules: [{ required: true, message: '请输入屏蔽时间' }],
                  })(
                    <Input placeholder="请输入请输入屏蔽时间date_time_now" />
                  )}
                </Form.Item>
              </Col>			
