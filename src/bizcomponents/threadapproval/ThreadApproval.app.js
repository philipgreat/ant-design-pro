...
const menuData = {menuName:"线审批", menuFor: "threadApproval",
  		subItems: [
...
class ThreadApprovalBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      partialList: state._threadApproval.partialList,
      owner: { type: '_threadApproval', id: state._threadApproval.id, referenceName: 'approval', listName: 'threadList', ref:state._threadApproval, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadSearch)
  }
  getThreadCreateForm = () => {
  ...
  getThreadUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_threadApproval', id: state._threadApproval.id, listName: 'threadList', ref:state._threadApproval, listDisplayName: '主贴列表' }, // this is for model namespace and
    }))(ThreadUpdateForm)
  }
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     const {ThreadApprovalDashboard} = GlobalComponents
     const {ThreadApprovalEditDetail} = GlobalComponents
     const {ThreadApprovalViewDetail} = GlobalComponents
         ...
         >
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/threadApproval/${this.props.threadApproval.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
         ...
         <Layout>
           <Content style={{ margin: '24px 24px 0', height: '100%' }}>
             <Switch>
               ...
               <Route path="/threadApproval/:id/editDetail" component={ThreadApprovalEditDetail} />
               <Route path="/threadApproval/:id/viewDetail" component={ThreadApprovalViewDetail} /> 
