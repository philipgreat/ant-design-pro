...
class ThreadApprovalBizApp extends React.PureComponent {
  ...
  getThreadSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_threadApproval',
        id: state._threadApproval.id,
        listName: 'threadList',
      ...
      <Layout>
        ...
        >
          ...
          >
            <Menu.Item>
              <Link
                to={`/threadApproval/${this.props.threadApproval.id}/dashboard`}
              >
                <Icon type="dashboard" />
                <span>仪表板</span>
              </Link>
        ...
        <Layout>
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            <Switch>
              <Route
                path="/threadApproval/:id/dashboard"
                component={ThreadApprovalDashboard}
              />

              <Route
                path="/threadApproval/:id/editDetail"
                component={ThreadApprovalEditDetail}
              />
              <Route
                path="/threadApproval/:id/viewDetail"
                component={ThreadApprovalViewDetail}
              />

              <Route
                path="/threadApproval/:id/list/threadList"
                component={this.getThreadSearch()}
              />
              <Route
                path="/threadApproval/:id/list/threadCreateForm"
                component={this.getThreadCreateForm()}
              />
              <Route
                path="/threadApproval/:id/list/threadUpdateForm"
