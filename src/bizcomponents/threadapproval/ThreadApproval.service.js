...
const updateThread=(targetObjectId,parameters)=>{
    const url = PREFIX+"";
    const requestParameters={...parameters, tokensExpr:'none'};
...
const removeThreadList=(targetObjectId,parameters)=>{
    ...
    const requestParameters={...parameters, threadApprovalId:targetObjectId,tokensExpr:'none'};
...
const ThreadApprovalService={view,
load,
addThread,
updateThread,
removeThreadList};
