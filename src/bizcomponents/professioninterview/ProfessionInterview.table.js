...
const columns = [
  { title: '序号', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>(<Link to={`/professionInterview/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '评论', debugtype: 'string', dataIndex: 'comments', width: '19' },
