...
import {ObjectAccessTable} from '../../custcomponents';
import {ObjectAccessConfirmationTable} from '../../custcomponents';

import {ObjectAccessSearchForm} from '../../custcomponents';
...
export default class ObjectAccessSearch extends PureComponent {
  ...
  handleDelete = () => {
    ...
    const objectAccessIds = selectedRows.map((item) => { return item.id; });
  ...
  handleUpdate = () => {
    ...
    dispatch({
      ...
      payload: { id: owner.id, type: 'objectAccess', selectedRows, currentUpdateIndex },
    });
  }
