  ...
  render() {
    ...
    const columns = [
      { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        width: '11',
        render: (text, record) => renderStringEdit('displayName', text, record),
      },
      {
        title: '访问对象类型',
        debugtype: 'string',
        ...
        width: '32',
        render: (text, record) => renderStringEdit('objectType', text, record),
      },
      {
        title: '列表1',
        debugtype: 'string',
        dataIndex: 'list1',
        width: '24',
        render: (text, record) => renderStringEdit('list1', text, record),
      },
      {
        title: '列表2',
        debugtype: 'string',
        dataIndex: 'list2',
        width: '24',
        render: (text, record) => renderStringEdit('list2', text, record),
      },
      {
        title: '列表3',
        debugtype: 'string',
        dataIndex: 'list3',
        width: '24',
        render: (text, record) => renderStringEdit('list3', text, record),
      },
      {
        title: '列表4',
        debugtype: 'string',
        dataIndex: 'list4',
        width: '24',
        render: (text, record) => renderStringEdit('list4', text, record),
      },
      {
        title: '列表5',
        debugtype: 'string',
        dataIndex: 'list5',
        width: '24',
        render: (text, record) => renderStringEdit('list5', text, record),
      },
      {
        title: '列表6',
        debugtype: 'string',
        dataIndex: 'list6',
        width: '24',
        render: (text, record) => renderStringEdit('list6', text, record),
      },
      {
        title: '列表7',
        debugtype: 'string',
        dataIndex: 'list7',
        width: '24',
        render: (text, record) => renderStringEdit('list7', text, record),
      },
      {
        title: '列表8',
        debugtype: 'string',
        dataIndex: 'list8',
        width: '24',
        render: (text, record) => renderStringEdit('list8', text, record),
      },
      {
        title: '列表9',
        debugtype: 'string',
        dataIndex: 'list9',
        width: '24',
        render: (text, record) => renderStringEdit('list9', text, record),
      },
      {
        title: '应用程序',
        dataIndex: 'app',
        render: (text, record) =>
          record.app ? record.app.displayName : '暂无',
      },
      {
        title: '操作',
