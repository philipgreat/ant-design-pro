...
class LineItemUpdateForm extends Component {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout
        title={"更新行项目"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新行项目"
        ...
        <Card title="基础信息" className={styles.card} bordered={false}>
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.skuType} {...formItemLayout}>
                  {getFieldDecorator('skuType', {
                    ...
                    rules: [{ required: true, message: '请输入Sku类型' }],
                  })(
                    <Input placeholder="请输入Sku类型" />
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.itemAdjustment} {...formItemLayout}>
                  {getFieldDecorator('itemAdjustment', {
                    initialValue: selectedRow.itemAdjustment,
                    rules: [{ required: true, message: '请输入项目调整' }],
                  })(
                    <Input placeholder="请输入项目调整" />
