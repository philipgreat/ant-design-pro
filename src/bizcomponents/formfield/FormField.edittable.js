  ...
  render() {
    ...
    const columns = [
      { title: 'ID', debugtype: 'string', dataIndex: 'id', width: '20' },
      {
        ...
        dataIndex: 'label',
        width: '7',
        render: (text, record) => renderStringEdit('label', text, record),
      },
      {
        title: '消息键值',
        debugtype: 'string',
        dataIndex: 'localeKey',
        width: '15',
        render: (text, record) => renderStringEdit('localeKey', text, record),
      },
      {
        title: '参数名称',
        debugtype: 'string',
        ...
        width: '8',
        render: (text, record) =>
          renderStringEdit('parameterName', text, record),
      },
      {
        title: '类型',
        debugtype: 'string',
        dataIndex: 'type',
        width: '13',
        render: (text, record) => renderStringEdit('type', text, record),
      },
      {
        title: '形式',
        dataIndex: 'form',
        render: (text, record) =>
          record.form ? record.form.displayName : '暂无',
      },
      {
        title: '占位符',
        debugtype: 'string',
        ...
        width: '16',
        render: (text, record) => renderStringEdit('placeholder', text, record),
      },
      {
        title: '默认值',
        debugtype: 'string',
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('defaultValue', text, record),
      },
      {
        title: '描述',
        debugtype: 'string',
      ...
      },
      {
        ...
        width: '8',
        render: (text, record) => renderStringEdit('fieldGroup', text, record),
      },
      {
        title: '最小值',
        debugtype: 'string',
        dataIndex: 'minValue',
        width: '19',
        render: (text, record) => renderStringEdit('minValue', text, record),
      },
      {
        title: '最大的价值',
        debugtype: 'string',
        dataIndex: 'maxValue',
        width: '22',
        render: (text, record) => renderStringEdit('maxValue', text, record),
      },
      {
        title: '要求',
        dataIndex: 'required',
      ...
      },
      {
        title: '禁用',
        dataIndex: 'disabled',
        render: (text, record) => (record.disabled ? '是' : '否'),
      },
      {
        title: '自定义渲染',
        dataIndex: 'customRendering',
        render: (text, record) => (record.customRendering ? '是' : '否'),
      },
      {
        title: '候选人的价值观',
        debugtype: 'string',
        ...
        width: '7',
        render: (text, record) =>
          renderStringEdit('candidateValues', text, record),
      },
      {
        title: '建议值',
        debugtype: 'string',
        dataIndex: 'suggestValues',
        width: '7',
        render: (text, record) =>
          renderStringEdit('suggestValues', text, record),
      },
      {
        title: '操作',
