...
import styles from './PlatformAccount.dashboard.less'
...
const imageListOf = (platformAccount) =>{
...
const settingListOf = (platformAccount) =>{
...
const largeTextOf = (platformAccount) =>{
...
class PlatformAccountDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, platformAccount } = this.props;
    
    if(!platformAccount){
    	return;
    }
    const {displayName} = platformAccount;
    if(!displayName){
    	return;
    }
