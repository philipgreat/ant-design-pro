...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/platformAccount/${text}/dashboard`}>{text}</Link>) },
...
class PlatformAccountTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default PlatformAccountTable
