...
import styles from './MemberServicePeriod.updateform.less'
...
class MemberServicePeriodUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const memberServicePeriodId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, memberServicePeriodId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextMemberServicePeriodUpdateRow`,
        payload: {
          id: owner.id,
          type: 'memberServicePeriod',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新会员服务时间"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新会员服务时间"
...
}))(Form.create()(MemberServicePeriodUpdateForm))
