...
import styles from './CarReceivingServiceOrder.updateform.less';
...
class CarReceivingServiceOrderUpdateForm extends Component {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
     validateFieldsAndScroll((error, values) => {
        ...
        const carReceivingServiceOrderId = values.id;
        const imagesValues = this.mapBackToImageValues(convertedImagesValues);
        const parameters = { ...values,carReceivingServiceOrderId, ...imagesValues };

	    const newIndex= currentUpdateIndex+1;
        dispatch({
          type: owner.type+'/updateCarReceivingServiceOrder',
    ...
    const skipToNext = () => {
      ...
      const newIndex= currentUpdateIndex+1;
      dispatch({
          type: owner.type+'/gotoNextCarReceivingServiceOrderUpdateRow',
            payload: {
              id:owner.id,type:'carReceivingServiceOrder', 
    ...
    return (
      <PageHeaderLayout
        ...
        title={"更新接车服务订单"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新接车服务订单"
...
}))(Form.create()(CarReceivingServiceOrderUpdateForm));
