...
const view=(targetObjectId)=>{
    return get({
        url: PREFIX+`carReceivingServiceOrderManager/view/${targetObjectId}/`
...
const load=(targetObjectId,parameters)=>{
    ...
    return get({
        url: PREFIX+`carReceivingServiceOrderManager/loadCarReceivingServiceOrder/${targetObjectId}/${parametersExpr}/`
