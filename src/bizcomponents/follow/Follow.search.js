...
import {FollowTable} from '../../custcomponents';
import {FollowConfirmationTable} from '../../custcomponents';

import {FollowSearchForm} from '../../custcomponents';
...
@Form.create()
export default class FollowSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      followList: 1,
      followListCurrentPage: pagination.current,
      followListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    };
    if (sorter.field) {
