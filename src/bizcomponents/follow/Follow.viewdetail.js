...
import styles from './Follow.viewdetail.less'
...
<Description term="添加时间">{ moment(follow.addingTime).format('YYYY-MM-DD')}</Description> 
...
export default class FollowViewDetail extends Component {
