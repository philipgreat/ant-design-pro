...
const columns = [
  ...
  { title: '付款状态', debugtype: 'string', dataIndex: 'paymentStatus',},
  { title: '微信订单ID', debugtype: 'string', dataIndex: 'wechatMainOrderId',},
  { title: '微信Prepay订单ID', debugtype: 'string', dataIndex: 'wechatPrepayId',},
...
class OnlineOrderPaymentTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
...
export default OnlineOrderPaymentTable
