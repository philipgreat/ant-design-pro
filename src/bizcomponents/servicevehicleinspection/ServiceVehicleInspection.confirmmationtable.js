...
const columns = [
  ...
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview imageLocation={record.inspectionReportImage6} />
    ),
  },
  {
    title: '年检报告6',
    ...
    render: (text, record) => (
      <ImagePreview imageLocation={record.inspectionReportImage7} />
    ),
  },
  {
    title: '年检报告7',
    ...
    render: (text, record) => (
      <ImagePreview imageLocation={record.inspectionReportImage8} />
    ),
  },
  {
    title: '检测结果',
