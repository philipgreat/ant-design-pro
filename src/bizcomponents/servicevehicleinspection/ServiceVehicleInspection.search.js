...
@Form.create()
export default class ServiceVehicleInspectionSearch extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    // expandForm: false,
  ...
  handleStandardTableChange = (pagination, filtersArg, sorter) => {
    ...
    const params = {
      ...
      serviceVehicleInspectionListCurrentPage: pagination.current,
      serviceVehicleInspectionListRowsPerPage: pagination.pageSize,
      ...formValues,
      ...filters,
    }
    if (sorter.field) {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="车辆上线检测结果列表">
        <Card bordered={false}>
