...
const menuData = {
  menuName: '车辆上线检测',
  menuFor: 'serviceVehicleInspection',
  subItems: [{ name: 'serviceVehicleRepairingList', displayName: '维修服务' }],
}
...
const displayColumns = [
  {
    ...
    width: '20',
    render: (text, record) => (
      <Link to={`/serviceVehicleInspection/${text}/dashboard`}>{text}</Link>
    ),
  },
  {
    title: '服务状态',
  ...
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告1"
        imageLocation={record.inspectionReportImage1}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告2"
        imageLocation={record.inspectionReportImage2}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告3"
        imageLocation={record.inspectionReportImage3}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告4"
        imageLocation={record.inspectionReportImage4}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告5"
        imageLocation={record.inspectionReportImage5}
      />
    ),
  },
  {
    title: '年检报告5',
    dataIndex: 'inspectionReportImage6',
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告5"
        imageLocation={record.inspectionReportImage6}
      />
    ),
  },
  {
    title: '年检报告6',
    dataIndex: 'inspectionReportImage7',
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告6"
        imageLocation={record.inspectionReportImage7}
      />
    ),
  },
  {
    title: '年检报告7',
    dataIndex: 'inspectionReportImage8',
    render: (text, record) => (
      <ImagePreview
        imageTitle="年检报告7"
        imageLocation={record.inspectionReportImage8}
      />
    ),
  },
  {
  ...
  },
  {
    title: '是否要修理',
    debugtype: 'string',
    dataIndex: 'inspectionNeedRepair',
    width: '7',
  },
  {
    title: '商户',
...
const ServiceVehicleInspectionBase = { menuData, displayColumns, fieldLabels }
