  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="服务概述">
        {serviceVehicleInspection.serviceSummary}
      </Description>
      ...
      <Description term="年检报告1">
        <ImagePreview
          imageTitle="年检报告1"
          imageLocation={serviceVehicleInspection.inspectionReportImage1}
        />
      </Description>
      <Description term="年检报告2">
        <ImagePreview
          imageTitle="年检报告2"
          imageLocation={serviceVehicleInspection.inspectionReportImage2}
        />
      </Description>
      <Description term="年检报告3">
        <ImagePreview
          imageTitle="年检报告3"
          imageLocation={serviceVehicleInspection.inspectionReportImage3}
        />
      </Description>
      <Description term="年检报告4">
        <ImagePreview
          imageTitle="年检报告4"
          imageLocation={serviceVehicleInspection.inspectionReportImage4}
        />
      </Description>
      <Description term="年检报告5">
        <ImagePreview
          imageTitle="年检报告5"
          imageLocation={serviceVehicleInspection.inspectionReportImage5}
        />
      </Description>
      <Description term="年检报告5">
        <ImagePreview
          imageTitle="年检报告5"
          imageLocation={serviceVehicleInspection.inspectionReportImage6}
        />
      </Description>
      <Description term="年检报告6">
        <ImagePreview
          imageTitle="年检报告6"
          imageLocation={serviceVehicleInspection.inspectionReportImage7}
        />
      </Description>
      <Description term="年检报告7">
        <ImagePreview
          imageTitle="年检报告7"
          imageLocation={serviceVehicleInspection.inspectionReportImage8}
        />
      </Description>
...
export default class ServiceVehicleInspectionDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '车辆上线检测',
      cardsFor: 'serviceVehicleInspection',
      cardsSource: this.props.serviceVehicleInspection,
      subItems: [
        {
