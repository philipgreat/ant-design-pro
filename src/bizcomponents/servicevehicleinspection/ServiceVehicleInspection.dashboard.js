        ...
        <div>
          <Row gutter={24}>
            <Col {...topColResponsiveProps}>
              ...
              >
                <Link
                  to={`/serviceVehicleInspection/${id}/list/reportVehicleInspectionReportList`}
                >
                  <Icon
                    type="profile"
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleInspection/${id}/list/reportVehicleInspectionReportCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
            ...
            <Col {...topColResponsiveProps}>
              <ChartCard
                ...
                title="检测修理建议项"
                action={
                  <Tooltip title="检测修理建议项">
                    <Icon type="info-circle-o" />
                  </Tooltip>
                }
                total={numeral(inspectionRepairAllowanceItemsCount).format(
                  '0,0'
                )}
                footer={<Field label="状态" value="良好" />}
                contentHeight={46}
              >
                <Link
                  to={`/serviceVehicleInspection/${id}/list/inspectionRepairAllowanceItemsList`}
                >
                  <Icon
                    type="profile"
                    style={{ fontSize: 20, color: '#08c' }}
                ...
                &nbsp;
                <Link
                  to={`/serviceVehicleInspection/${id}/list/inspectionRepairAllowanceItemsCreateForm`}
                >
                  <Icon
                    type="plus-circle-o"
                    style={{ fontSize: 20, color: '#08c' }}
