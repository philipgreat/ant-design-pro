...
const testValues = {
  ...
  startTime: '2998-02-24 10:02:20',
  longitude: '105.41583489973316',
  latitude: '30.874735566618366',
  inspectionDatetime: '2995-05-31 19:44:17',
  inspectionResult: '通过',
...
class ServiceVehicleInspectionCreateForm extends Component {
  ...
  executeCandidateResponsibleWorkerSearch = filterKey => {
    ...
    const pageNo = 1
    const future = ServiceVehicleInspectionService.requestCandidateResponsibleWorker(
  ...
  executeCandidateInspectionStationSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleInspectionService.requestCandidateInspectionStation(
      'inspectionStation',
      id,
      filterKey,
      pageNo
  ...
  executeCandidateMerchantSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleInspectionService.requestCandidateMerchant(
  ...
  executeCandidateMainOrderSearch = filterKey => {
    ...
    const id = '' //not used for now
    const pageNo = 1
    const future = ServiceVehicleInspectionService.requestCandidateMainOrder(
            ...
            <Row gutter={16}>
              ...
              <Col lg={6} md={12} sm={24}>
                <ImageComponent
                  ...
                  handlePreview={this.handlePreview}
                  handleChange={event =>
                    this.handleChange(event, 'inspectionReportImage6')
                  }
              ...
              <Col lg={6} md={12} sm={24}>
                <ImageComponent
                  ...
                  handlePreview={this.handlePreview}
                  handleChange={event =>
                    this.handleChange(event, 'inspectionReportImage7')
                  }
              ...
              <Col lg={6} md={12} sm={24}>
                <ImageComponent
                  ...
                  handlePreview={this.handlePreview}
                  handleChange={event =>
                    this.handleChange(event, 'inspectionReportImage8')
                  }
