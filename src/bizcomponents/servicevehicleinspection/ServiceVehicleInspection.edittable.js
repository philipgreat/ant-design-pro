...
class ServiceVehicleInspectionEditTable extends PureComponent {
  ...
  render() {
    ...
    const remapReference = (record) => {
      ...
      return {responsibleWorkerId,inspectionStationId,merchantId,mainOrderId,};
    }
  ...
  { title: '服务概述', debugtype: 'string', dataIndex: 'serviceSummary', width: '23', render: (text, record) => renderStringEdit('serviceSummary',text, record)  },
  ...
  { title: '年检报告5', dataIndex: 'inspectionReportImage6', render: (text, record) => <ImagePreview imageLocation={record.inspectionReportImage6} /> },
  { title: '年检报告6', dataIndex: 'inspectionReportImage7', render: (text, record) => <ImagePreview imageLocation={record.inspectionReportImage7} /> },
  { title: '年检报告7', dataIndex: 'inspectionReportImage8', render: (text, record) => <ImagePreview imageLocation={record.inspectionReportImage8} /> },
  { title: '检测结果', debugtype: 'string', dataIndex: 'inspectionResult', width: '7', render: (text, record) => renderStringEdit('inspectionResult',text, record)  },
  { title: '是否要修理', debugtype: 'string', dataIndex: 'inspectionNeedRepair', width: '7', render: (text, record) => renderStringEdit('inspectionNeedRepair',text, record)  },
