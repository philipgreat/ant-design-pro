...
<Description term="年检报告5">{serviceVehicleInspection.inspectionReportImage6}</Description> 
<Description term="年检报告6">{serviceVehicleInspection.inspectionReportImage7}</Description> 
<Description term="年检报告7">{serviceVehicleInspection.inspectionReportImage8}</Description> 
...
export default class ServiceVehicleInspectionViewDetail extends Component {
  ...
  state = {
    tabKey: `serviceVehicleRepairingList`,
  ...
  render() {
    ...
    const { id, serviceVehicleRepairingCount } = serviceVehicleInspection
    const { serviceVehicleRepairingList } = serviceVehicleInspection
