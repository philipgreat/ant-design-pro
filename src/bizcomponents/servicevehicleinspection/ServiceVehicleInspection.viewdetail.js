...
<Description term="检测结果">{serviceVehicleInspection.inspectionResult?'是':'否'}</Description> 
...
<Description term="检测报告1">{serviceVehicleInspection.reportImage1}</Description> 
<Description term="检测报告2">{serviceVehicleInspection.reportImage2}</Description> 
<Description term="检测报告3">{serviceVehicleInspection.reportImage3}</Description> 
<Description term="检测报告4">{serviceVehicleInspection.reportImage4}</Description> 
<Description term="检测报告5">{serviceVehicleInspection.reportImage5}</Description> 
