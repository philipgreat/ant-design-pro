...
const columns = [
  ...
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="检测报告1"
        imageLocation={record.reportImage1}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="检测报告2"
        imageLocation={record.reportImage2}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="检测报告3"
        imageLocation={record.reportImage3}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="检测报告4"
        imageLocation={record.reportImage4}
      />
    ),
  },
  {
    ...
    render: (text, record) => (
      <ImagePreview
        imageTitle="检测报告5"
        imageLocation={record.reportImage5}
      />
    ),
  },
  {
