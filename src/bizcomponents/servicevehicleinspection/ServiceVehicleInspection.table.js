...
const columns = [
  { title: 'ID', debugtype: 'string', dataIndex: 'id',  render: (text, record)=>(<Link to={`/serviceVehicleInspection/${text}/dashboard`}>{text}</Link>) },
  ...
  { title: '检测结果', debugtype: 'string', dataIndex: 'inspectionResult',},
  { title: '是否要修理', debugtype: 'string', dataIndex: 'inspectionNeedRepair',},
