...
<Description term="年检报告1">{reportVehicleInspectionReport.inspectionReportImage1}</Description> 
<Description term="年检报告2">{reportVehicleInspectionReport.inspectionReportImage2}</Description> 
<Description term="年检报告3">{reportVehicleInspectionReport.inspectionReportImage3}</Description> 
<Description term="年检报告4">{reportVehicleInspectionReport.inspectionReportImage4}</Description> 
<Description term="年检报告5">{reportVehicleInspectionReport.inspectionReportImage5}</Description> 
