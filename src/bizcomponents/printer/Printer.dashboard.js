...
import styles from './Printer.dashboard.less'
...
class PrinterDashboard extends Component {
  ...
  /*
    ...
    const { dispatch, location, printer } = this.props;
  ...
  render() {
    ...
    const { id,displayName, printerTaskCount, storeCount } = this.props.printer
    const cardsData = {cardsName:"打印机",cardsFor: "printer",cardsSource: this.props.printer,
  		subItems: [
{name: 'printerTaskList', displayName:'打印机任务',type:'printerTask',count:printerTaskCount},
