...
import styles from './InputInterface.viewdetail.less'
...
export default class InputInterfaceViewDetail extends Component {
  ...
  render() {
    ...
    const inputInterface = this.props.inputInterface
    const { id,  } = inputInterface
    const {  } = inputInterface
    
    const owner = { type: '_inputInterface', id }
